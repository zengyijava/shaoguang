...
public class GenericMoMtSpgateVoDAO extends SuperDAO{
	 ...
	 * @throws Exception
	 */
	public List<SysMoMtSpgateVo> findSysMtSpVoVo(SysMoMtSpgateVo sysMoMtSpVo)throws Exception {
		//获取查询的字段
		String fieldSql = GenericMoMtSpgateVoSQL.getMtFieldSql(sysMoMtSpVo);
