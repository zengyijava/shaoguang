		...
		try{
			...
			{	
				...
				else if(RptStaticValue.RPT_JSSUCC_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					resultmap.put(RptStaticValue.RPT_JSSUCC_COLUMN_ID, jssucc+"");
				}else if(RptStaticValue.RPT_RNRET_COLUMN_ID.equals(rptConf.getColId()))
				{//未返数
				 //rnret
				 resultmap.put(RptStaticValue.RPT_RNRET_COLUMN_ID, rnret+"");
				}	
				else if(RptStaticValue.RPT_FSSUCC_ICOUNT_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					if(icount!=0){
						...
						resultmap.put(RptStaticValue.RPT_FSSUCC_ICOUNT_COLUMN_ID,propertion );
					}else{
						resultmap.put(RptStaticValue.RPT_FSSUCC_ICOUNT_COLUMN_ID,"0.00%" );
					}
				...
				}else if(RptStaticValue.RPT_RFAIL1_ICOUNT_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					if(icount!=0){
						...
						resultmap.put(RptStaticValue.RPT_RFAIL1_ICOUNT_COLUMN_ID,propertion );
					}else{
						resultmap.put(RptStaticValue.RPT_RFAIL1_ICOUNT_COLUMN_ID,"0.00%" );
					}
				}else if(RptStaticValue.RPT_JSSUCC_FSSUCC_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					if((icount-rfail1)!=0){
						...
						resultmap.put(RptStaticValue.RPT_JSSUCC_FSSUCC_COLUMN_ID,propertion );
					}else{
						resultmap.put(RptStaticValue.RPT_JSSUCC_FSSUCC_COLUMN_ID,"0.00%" );
					}
				}else if(RptStaticValue.RPT_RFAIL2_FSSUCC_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					if((icount-rfail1)!=0){
						...
						resultmap.put(RptStaticValue.RPT_RFAIL2_FSSUCC_COLUMN_ID,propertion );
					}else{
						resultmap.put(RptStaticValue.RPT_RFAIL2_FSSUCC_COLUMN_ID,"0.00%" );
					}
				}else if(RptStaticValue.RPT_RNRET_FSSUCC_COLUMN_ID.equals(rptConf.getColId()))
				{
					...
					if((icount-rfail1)!=0){
						...
						resultmap.put(RptStaticValue.RPT_RNRET_FSSUCC_COLUMN_ID,propertion);
					}else{
						resultmap.put(RptStaticValue.RPT_RNRET_FSSUCC_COLUMN_ID,"0.00%");
					}
				}
			}
		}catch (Exception e) {
