...
public class TableLfAppMoCache
{

	public static final String TABLE_NAME	= "LF_APP_MOCACHE";
	...
	public static final String OUTLINEMSG = "OUTLINEMSG";

	public static final String SEQUENCE	= "S_LF_APP_MOCACHE";
	protected static final Map<String , String> columns = new HashMap<String, String>();

	static
	{

		columns.put("LfAppMoCache", TABLE_NAME);
		...
		columns.put("outlinemsg", OUTLINEMSG);
	};
