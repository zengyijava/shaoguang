...
public class TableLfWcVerify {
     ...
     * 序列
     */
    public static final String SEQUENCE = "S_LF_WC_VERIFY";
    /**
     * 表名：用户微信基本信息表
     */
    public static final String TABLE_NAME = "LF_WC_VERIFY";
    ...
    static {
        columns.put("LfWcVerify", TABLE_NAME);
