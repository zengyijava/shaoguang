...
import com.montnets.emp.weix.biz.i.IDefaultrepBiz;
import com.montnets.emp.weix.dao.DefaultrepDao;
import com.montnets.emp.weix.dao.TempleDao;

public class DefaultrepBiz extends SuperBiz implements IDefaultrepBiz
{
	/**
	 * 默认回复列表及其查询
	 * 
