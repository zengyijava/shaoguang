 ...
 * 
 */
package com.montnets.emp.table.wxkeywords;
...
public class TableLfSysKeywords
{
	//表名_关键字
	public static final String TABLE_NAME = "LF_SYS_KEYWORDS";
	//主键
	...
	static
	{
		columns.put("LfSysKeywords", TABLE_NAME);
