 ...
 * @description
 */
public class TableLfOnlMsgHis
{
	// 表名
	public static final String				TABLE_NAME	= "LF_ONL_MSG_HIS";
	...
	// 序列
	public static final String			SEQUENCE	= "S_LF_ONL_MSG_HIS";
	...
	static
	{
		columns.put("LfOnlMsgHis", TABLE_NAME);
