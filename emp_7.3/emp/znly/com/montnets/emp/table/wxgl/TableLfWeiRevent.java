 ...
 * @description
 */
public class TableLfWeiRevent
{
	public static final String				TABLE_NAME	= "LF_WEI_REVENT";
	...
	public static final String			SEQUENCE	= "S_LF_WEI_REVENT";
	...
	static
	{
		...
		columns.put("LfWeiRevent", TABLE_NAME);
