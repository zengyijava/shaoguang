...
import com.montnets.emp.znly.message.MessageUtil;
import com.montnets.emp.znly.message.TextMessage;
...
public class LbsPiosBiz extends SuperBiz
{
     ...
     * 查询城市范围请求URL
     */
    private static final String                    LOCATION_SERVCH       = "http://api.map.baidu.com/place/v2/search?";

    /**
     * key openid+aid value LfLbsUserPios
     */
    private static final Map<String, LfLbsUserPios> userpiosMapcontactAid = new HashMap<String, LfLbsUserPios>();

    /**
     * 三分钟
     */
    public static final long                       timeInterval          = 3 * 60L * 1000L;
     ...
     *        上传地理位置时间
     * @param fromtype
     *        来源 location 我的位置 menu 菜单 push 服务器推送
     * @param account
     *        公众帐号对象
     * @return 返回对象或者null
     * @author yejiangmin <282905282@qq.com>
