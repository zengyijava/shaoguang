...
public class StaticValue {
    ...
    protected final static Properties systemProperty = System.getProperties();

    public final static String LINE_SEPARATOR = "line.separator";

    public final static String FILEDIRNAME = "file/smstxt/";
    //excel模板目录
    public final static String EXCEL_FILE = "file/excel/";
    public final static String MANUAL_SMSTXT = "file/smstxt/manualsmstxt/";

    public final static String JSPXML_FILE = "file/jspxmlfile/";
    //excel文件模板
    ...
    public final static String MANUALSMSTXT = "manualsmstxt/";

    public final static String SERVICESMSTXT = "servicesmstxt/";

    public final static String MOBILEBUSINESSTXT = "mobilebussinesstxt/";

    public static final String MMS_WEBSERVICE_URL = "mms.webservice.url";

    public final static String EMP_POOLNAME = "emp";

    public final static String SMSACC_POOLNAME = "ott";

    public final static String SMSSVR_POOLNAME = "ott";

    public final static String DB_CACHE_SWITCH_OPEN = "1";
    ...
    public final static String LIKE1 = "like1";

    public final static String LIKE2 = "like2";
    ...
    //要存放的大模块id
    public static final StringBuffer menu_num = new StringBuffer("");
     ...
     * 默认框架
     */
    public static final String DEFAULT_FRAME = SystemGlobals.getValue(StaticValue.WEB_FRAME);
