...
public class curp_custEvaluateSvt extends BaseServlet
{
    ...
    public void find(HttpServletRequest request, HttpServletResponse response) throws Exception
    {
        ...
        try {
            ...
            List<DynaBean> resultList = custBiz.getEvaluates(conditionMap, pageInfo); 
            ...
            EmpExecutionContext.error(e, "查询客户评价信息失败。");
        } finally {
            request.setAttribute("pageInfo", pageInfo);
            request.getRequestDispatcher(PATH + "/curp_custEvaluate.jsp").forward(
                    request, response);
        }
    }
