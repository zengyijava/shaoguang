 ...
 * @Package: com.montnets.emp.rms.meditor.tools$
 * @ClassName: SmilFile2FrontJsonTool$
 * @Description: java类作用描述
 * @Author: xuty
 * @CreateDate: 2018/11/10$ 9:19$
 * @UpdateUser: 更新者
 * @UpdateDate: 2018/11/10$ 9:19$
 * @UpdateRemark: 更新内容
 * @Version: 1.0
 */
public class SmilFile2FrontJsonTool {
     ...
     * @return
     */
    public  String parseV3Rms(String fileContent, String rootPath){
        String v3Content = null;
        try{
            //解析文本内容中的src
            Map<String,String> srcMap = getSmilSrc(fileContent);
            //根据src拼接json
            v3Content = parseV3Json(srcMap,rootPath);
        }catch(Exception e){
    ...
    public String parseV3Json(Map<String,String> srcMap,String rootPath){
...
//                        rmsV3Data.setSize("");
     ...
     * @param rmsV3Data
     */
    public void setRmsDataParamText(List<LfTempParam> paramList,RmsV3Data rmsV3Data){
     ...
     * @return
     */
    public RmsV3Data setRmsDataV3Attr(String pathSrc,RmsV3Data rmsV3Data){
        try {
     ...
     * @return
     */
    public RmsV3Element setRmsV3Attr(String pathSrc,RmsV3Element rmsV3Element){
        try {
            File imgFile =  new File(new TxtFileUtil().getWebRoot()+pathSrc);
            //读取图片对象
            BufferedImage img = ImageIO.read(imgFile);
     ...
     * @return
     */
    public Map<String,String> getSmilSrc(String fileContent){
