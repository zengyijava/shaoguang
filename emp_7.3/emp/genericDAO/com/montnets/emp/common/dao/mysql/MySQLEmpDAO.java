package com.montnets.emp.common.dao.mysql;
 ...
 * @description
 */
public class MySQLEmpDAO extends GenericEmpDAO
{
	@Override
	...
	{
		return this.saveObjectReturnIDMySql(conn,isOutConn,object);
	}
	...
	private Long saveObjectReturnIDMySql(Connection conn,boolean isOutConn,Object object) throws Exception
	{
	...
	{
			//mysql数据库
		return this.findPageListByConditionMySql(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}	
	...
	private <T> List<T> findPageListByConditionMySql(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	{
		//mysql数据库
		return this.findPageListBySymbolsConditionMySql(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	{
		//mysql数据库
		return this.findPageListBySymbolsConditionNoCountMySql(loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	{
		//mysql数据库
		return this.findPageListBySymbolsConditionNoCountMySql(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	private <T> List<T> findPageListBySymbolsConditionMySql(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionNoCountMySql(Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionNoCountMySql(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
