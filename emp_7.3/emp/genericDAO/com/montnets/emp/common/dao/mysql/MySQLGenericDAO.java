 ...
 *
 */
public class MySQLGenericDAO extends GenericGenericDAO
{
	...
	{
		//mysql数据库
		return this.findPageVoListBySQLMySqlNoCount(voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	}
	...
	{
		//mysql数据库
		return this.findPageVoListBySQLMySqlNoCount(conn,isOutConn,voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	}
	...
	{
		return this.findPageDynaBeanBySQLMySql(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	
	public List<DynaBean> findPageDynaBeanBySQLNoCount(String sql,
			String countSql ,PageInfo pageInfo, String POOLNAME, List<String> timeList)
	{
		return this.findPageDynaBeanBySQLNoCountMySql(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	
	public List<DynaBean> findDynaBeanBySql(String sql)
	{
		return this.findDynaBeanBySqlMySql(sql);
	}
	...
	private <T> List<T> findPageVoListBySQLMySqlNoCount(Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	...
	private <T> List<T> findPageVoListBySQLMySqlNoCount(Connection conn,boolean isOutConn,Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	...
	public List<DynaBean> findDynaBeanBySqlMySql(String sql)
	{
		Connection conn = null;
		PreparedStatement ps = null;
		ResultSet rs = null;
		...
		try
		{
			...
			ps = conn.prepareStatement(sql);
			rs = ps.executeQuery();
			//这里设置useColumnLabel为true，使用这种方式获取列名
	...
	private List<DynaBean> findPageDynaBeanBySQLMySql(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
	...
	private List<DynaBean> findPageDynaBeanBySQLNoCountMySql(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList)
	{
		List<DynaBean> returnList = null;
	...
	{
		//mysql数据库
		return this.findPageEntityListBySQLNoCountMySql(entityClass, sql, countSql, pageInfo, POOLNAME);
	}
	...
	private <T> List<T> findPageEntityListBySQLNoCountMySql(Class<T> entityClass,
			String sql, String countSql, PageInfo pageInfo, String POOLNAME)
			throws Exception
	{
		List<T> returnList = null;
