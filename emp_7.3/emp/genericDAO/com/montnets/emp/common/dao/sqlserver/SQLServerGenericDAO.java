 ...
 *
 */
public class SQLServerGenericDAO extends GenericGenericDAO
{
			...
			throws Exception
	{
	   	...
	   	return this.findPageVoListBySQLSqlServer(conn,isOutConn,voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	...
	{
	   	//sqlserver数据库
	   	return this.findPageVoListBySQLNoCountSqlServer(voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	}
	...
	{
		return this.findPageDynaBeanBySQLSqlServer(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	
	public List<DynaBean> findPageDynaBeanBySQLNoCount(String sql,
			String countSql ,PageInfo pageInfo, String POOLNAME, List<String> timeList)
	{
		return this.findPageDynaBeanBySQLNoCountSqlServer(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	 ...
	 * @throws Exception
	 */
	private <T> List<T> findPageVoListBySQLSqlServer(Connection conn,boolean isOutConn,Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	 ...
	 * @throws Exception
	 */
	private <T> List<T> findPageVoListBySQLNoCountSqlServer(Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	 ...
	 * @throws Exception
	 */
	private List<DynaBean> findPageDynaBeanBySQLSqlServer(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
	 ...
	 * @throws Exception
	 */
	private List<DynaBean> findPageDynaBeanBySQLNoCountSqlServer(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList)
	{
		List<DynaBean> returnList = null;
	...
	{
		//sqlserver数据库
		return this.findPageEntityListBySQLNoCountSqlServer(entityClass, sql, countSql, pageInfo, POOLNAME);
	}
	 ...
	 * @throws Exception
	 */
	private <T> List<T> findPageEntityListBySQLNoCountSqlServer(Class<T> entityClass,
			String sql, String countSql, PageInfo pageInfo, String POOLNAME)
			throws Exception
	{
		List<T> returnList = null;
