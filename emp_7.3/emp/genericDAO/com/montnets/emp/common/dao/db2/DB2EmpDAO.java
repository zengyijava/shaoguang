package com.montnets.emp.common.dao.db2;
 ...
 * @description
 */
public class DB2EmpDAO extends GenericEmpDAO
{
	@Override
	...
	{
		return this.saveObjectReturnIDDB2(conn,isOutConn,object);
	}
	...
	private Long saveObjectReturnIDDB2(Connection conn,boolean isOutConn,Object object) throws Exception
	{
	...
	{
		//db2数据库
		return this.findPageListByConditionDB2(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	private <T> List<T> findPageListByConditionDB2(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	{
		//db2数据库
		return this.findPageListBySymbolsConditionDB2(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	...
	{
		//db2数据库
		return this.findPageListBySymbolsConditionDB2NoCount(loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	{
		//db2数据库
		return this.findPageListBySymbolsConditionDB2NoCount(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	private <T> List<T> findPageListBySymbolsConditionDB2(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionDB2NoCount(Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionDB2NoCount(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
