 ...
 * @description
 */
public class OracleEmpDAO extends GenericEmpDAO
{
	@Override
	...
	{
			return this.saveObjectReturnIDOracle(conn,isOutConn,object);
	}
	...
	private Long saveObjectReturnIDOracle(Connection conn,boolean isOutConn,Object object) throws Exception
	{
	...
	{
			//oracle数据库
			return this.findPageListByConditionOracle(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	private <T> List<T> findPageListByConditionOracle(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
			...
			throws Exception
	{
		...
		//oracle数据库
		return this.findPageListBySymbolsConditionOracle(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	...
	{
		//oracle数据库
		return this.findPageListBySymbolsConditionNoCountOracle(loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	...
	{
		//oracle数据库
		return this.findPageListBySymbolsConditionNoCountOracle(conn,isOutConn,loginUserID, entityClass, conditionMap, orderbyMap, pageInfo);
	}
	
	private <T> List<T> findPageListBySymbolsConditionNoCountOracle(Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionNoCountOracle(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
	...
	private <T> List<T> findPageListBySymbolsConditionOracle(Connection conn,boolean isOutConn,Long loginUserID,
			Class<T> entityClass, LinkedHashMap<String, String> conditionMap,
			LinkedHashMap<String, String> orderbyMap, PageInfo pageInfo)
			throws Exception
	{
