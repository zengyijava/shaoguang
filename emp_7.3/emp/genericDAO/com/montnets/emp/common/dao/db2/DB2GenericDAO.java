 ...
 *
 */
public class DB2GenericDAO extends GenericGenericDAO
{
			...
			throws Exception
	{
		...
		//db2数据库
		return this.findPageVoListBySQLNoCountDB2(voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	}
			...
			throws Exception
	{
		...
		//db2数据库
		return this.findPageVoListBySQLNoCountDB2(conn,isOutConn,voClass, sql, countSql, pageInfo, POOLNAME, timeList, columns);
	}
	...
	{
		return this.findPageDynaBeanBySQLDB2(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	
	public List<DynaBean> findPageDynaBeanBySQLNoCount(String sql,
			String countSql ,PageInfo pageInfo, String POOLNAME, List<String> timeList)
	{
		return this.findPageDynaBeanBySQLNoCountDB2(sql, countSql, pageInfo, POOLNAME, timeList);
	}
	...
	private <T> List<T> findPageVoListBySQLNoCountDB2(Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	...
	private <T> List<T> findPageVoListBySQLNoCountDB2(Connection conn,boolean isOutConn,Class<T> voClass, String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList, Map<String, String> columns)
			throws Exception
	{
	...
	private List<DynaBean> findPageDynaBeanBySQLDB2(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
	...
	private List<DynaBean> findPageDynaBeanBySQLNoCountDB2(String sql,
			String countSql, PageInfo pageInfo, String POOLNAME,
			List<String> timeList)
	{
		List<DynaBean> returnList = null;
	...
	{
		//db2数据库
		return this.findPageEntityListBySQLNoCountDB2(entityClass, sql, countSql, pageInfo, POOLNAME);
	}
	 ...
	 * @throws Exception
	 */
	private <T> List<T> findPageEntityListBySQLNoCountDB2(Class<T> entityClass,
			String sql, String countSql, PageInfo pageInfo, String POOLNAME)
			throws Exception
	{
		List<T> returnList = null;
