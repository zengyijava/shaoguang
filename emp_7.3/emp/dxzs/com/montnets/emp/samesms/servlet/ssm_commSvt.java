...
import com.montnets.emp.samesms.biz.sms_commBiz;
...
public class ssm_commSvt extends BaseServlet {
		...
		try {
			...
			if (udgList != null && udgList.size() > 0) 
			{
				...
				for(LfUdgroup udg : udgList)
				{
					...
					buffer.append("<option mcount='").append(mcount).append("' value='").append(udg.getGroupid()).append("'>");
