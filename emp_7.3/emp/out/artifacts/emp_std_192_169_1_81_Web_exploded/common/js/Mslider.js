...
(function(){
	...
	Mslider.prototype = {
		...
		animate : function( t, b, c, d ){
			...
			if ( t < d ) {
				t++; _this.animateTime = setTimeout( function(){ _this.animate( t, b, c, d ); }, 20 );
				pageTimer.push(_this.animateTime);
			}
		},
		...
		init : function(){
			var _this = this;
			while(pageTimer&&pageTimer.length>0){
				clearInterval(pageTimer.pop());
			}
			/* common */
			_this.setCss();
