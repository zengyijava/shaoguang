...
<html>
  ...
  <body style="margin:0;padding:0;" class="rms_sameMmsEmpTree">
  		<label id="test"></label>
	...
	setting = {
			...
			asyncUrl: "<%=path%>/selectUserInfo.htm?method=getEmpSecondDepJson",  //获取节点数据的URL地址
			...
			callback:{
				...
				beforeAsync: function(treeId, treeNode) {
			    	zTree.setting.asyncUrl="<%=path%>/selectUserInfo.htm?method=getEmpSecondDepJson&depId="+treeNode.id;
				}
			}
		};
	...
	function zTreeOnClick(event, treeId, treeNode) {
		...
		$.post("<%=path %>/selectUserInfo.htm", {method:"getEmployeeByDepId", depId:depId,pageIndex:pageIndex}, function(result){
