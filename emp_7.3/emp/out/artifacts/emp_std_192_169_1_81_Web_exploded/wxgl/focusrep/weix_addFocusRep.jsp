...
<%
	...
	String skin = session.getAttribute("stlyeSkin")==null?"default":(String)session.getAttribute("stlyeSkin");
 	...
 	LfWeiRevent lfRevent =(LfWeiRevent) request.getAttribute("otWeiRevent");
...
<html>
	...
	<body>
      			...
      			<table width="" style="">
							...
							<tr>
								...
								<td>
									...
									<font color="red" title="回复标题不能为空，且不能超过32个字符" style="cursor:pointer;">&nbsp;&nbsp;&nbsp;*</font>
								</td>
							</tr>
							<tr><td height="20px;"></td></tr>
							<tr>
						    ...
						    <tr align="right">
	                         	<td></td>
	                         	<td id="btn">
	                         		<input id="btsend" class="btnClass5 mr10" type="button" onclick="save()" value="<emp:message key='wxgl_button_6' defVal='保存' fileName='wxgl'/>" />
	                         		<input id="btcancel" class="btnClass6 mr10" type="button" value="<emp:message key='wxgl_button_7' defVal='重置' fileName='wxgl'/>" onclick="javascript:resetTemp()"/>
		...
		<script type="text/javascript" src="<%=iPath%>/js/addFocusRep.js?V=<%=StaticValue.getJspImpVersion() %>"></script>
