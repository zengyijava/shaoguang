...
<%
	...
	LfLbsPios oblbsPios = (LfLbsPios)request.getAttribute("oblbsPios");
	if(oblbsPios == null){
	    return;
	}
	//采集点LNG 经度
	String pioslng = oblbsPios.getLng();
	//采集点lat 纬度
	String pioslat = oblbsPios.getLat();
	//标题
	String title = oblbsPios.getTitle();
	//地址
	String address = oblbsPios.getAddress();
	//联系电话
	String telephone = oblbsPios.getTelephone();
...
<html>
	...
	<div style="height: 0px;">
		<%-- 纬度   经度 --%>
		<input name="pioslat" id="pioslat" type="hidden" value="<%=pioslat %>" />
		<input name="pioslng" id="pioslng" type="hidden" value="<%=pioslng %>" />
		...
		<%-- 联系电话 --%>
		<input name="telephone" id="telephone" type="hidden" value="<%=telephone %>" />
		...
		<%-- 乘车方案开始  --%>
		<div class="all" id="busplandiv" style="display:none;">
		  <div class="route01">
		...
		<%-- 自驾方案开始 --%>
		<div class="all" id="carplandiv" style="display:none">
		  <div class="route01">
		    <div class="route01_titlr01">
		...
		<script type="text/javascript" src="<%=iPath %>/js/lbsMultiMap.js?v=<%=WXStaticValue.OTT_VERSION %>"></script>
