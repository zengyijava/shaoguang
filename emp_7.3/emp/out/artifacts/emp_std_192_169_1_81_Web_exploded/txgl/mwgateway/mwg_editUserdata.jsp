...
<html>
	...
	<%}%>
		...
		<link rel="stylesheet" type="text/css" href="<%=iPath%>/css/mwg_editUserdata.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/mwg_editUserdata.css?V=<%=StaticValue.getJspImpVersion() %>"/>
	
	</head>
	<body id="mwg_editUserdata">
		<div id="container">
			<div class="rContent">
				<div class="titletop">
						...
						<div class="tabContent">
									...
									<tr>
										...
										<td>
											...
											<input type="text" <%if("1".equals(wy)){ %> disabled="disabled" <%} %>  name="spPort<%=c %>" placeholder="<emp:message key='txgl_mwgateway_text_15' defVal='端口号' fileName='mwadmin'/>"
												maxlength="5" value="<%=port %>" class="input_bd prot_by"
												class="port_input"
												onkeyup="if(value != value.replace(/[^\d]/g,'')) value = value.replace(/[^\d]/g,'')"
												onblur="validatePort(this)" />
											&nbsp;
								...
								<table class="temp_yys">
									<tr>
										...
										<td>
											...
											<font color="red" class="verxing_font">*</font>
											 <%if(!"1".equals(wy)){ %>
											<span class="handle"> <a class="addbackup"
												onclick="addNextBackIp(this)" href="javascript:void(0)"><emp:message key='txgl_mwgateway_text_23' defVal='添加' fileName='mwadmin'/></a>
												| <a class="remove_handle" onclick="removeHandle(this)"
                         ...
                         --%>
								...
								<tr class="ch_ty">
									...
									<td>
										<input class="input_bd urlljdz_input"   type="text"
