...
<html>
	...
	<%@include file="/common/common.jsp" %>
		...
		<link rel="stylesheet" type="text/css" href="<%=iPath%>/css/wg_apiBase.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/wg_apiBase.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		
	</head>
	<body id="wg_apiBase">
			<div class="buttons toggleDiv_up_div"  >
			<div id="toggleDiv" class="toggleDiv"></div>
			 <input type="button" class="btnClass4 btnHover toggleDiv_down_div" value="<emp:message key='txgl_apimanage_text_1' defVal='新增方法类型' fileName='mwadmin'/>"  onclick="toAdd()">
			</div>
		<div id="container" class="container">
			...
			<div id="rContent" class="rContent">
				...
				<div class="ffmc_div">
					...
					<table>
					   <tr>
                      <td align="left" class="ffmc_td"><span><emp:message key='txgl_apimanage_text_3' defVal='方法名称：' fileName='mwadmin'/></span></td>
                        <td align="left">
                      ...
                      <tr class="ffmc_div_table_tr"><td colspan="2"></td></tr>
  					  <tr>
				...
				<div class="addtype_down_div">
					...
					<table class="qymcmh_table">
						<tr>
   						...
   						<input type="button" class="btnClass2 btnHover xzqy" value="<emp:message key='txgl_apimanage_text_24' defVal='选择企业' fileName='mwadmin'/>"  onclick="choice()">
   	   					 </td>
   	   					 </tr> 
   	   					 <tr>
			...
			<div id="custDiv" title="<emp:message key='txgl_apimanage_text_54' defVal='新增企业信息' fileName='mwadmin'/>" class="custDiv">
				<iframe id="custFrame" name="custFrame" class="<%="zh_HK".equals(empLangName)?"custFrame_1":"custFrame_2"%>"  marginwidth="0" scrolling="no" frameborder="no" src ="<%=commonPath%>/common/blank.jsp " ></iframe>
			</div>
