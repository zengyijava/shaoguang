...
<%@page import="com.montnets.emp.degree.vo.LfDegreeManageVo"%>
...
<%@ include file="/common/common.jsp"%>
	...
	<link href="<%=commonPath%>/frame/frame3.0/skin/default/frame.css" rel="stylesheet" type="text/css" />
	<link href="<%=commonPath%>/frame/frame3.0/skin/default/table.css" rel="stylesheet" type="text/css" />
	...
	<link rel="stylesheet" href="<%=commonPath%>/frame/frame3.0/skin/default/newjqueryui.css" type="text/css">
...
<body>
	...
	<div id="container" class="container">
		<div id="rContent" class="rContent">
			<form name="pageForm" action="tx_degreeManager.htm?method=find"
