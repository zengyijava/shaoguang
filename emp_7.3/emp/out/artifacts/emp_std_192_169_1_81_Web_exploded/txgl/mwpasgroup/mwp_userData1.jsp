...
<html>
	...
	<%@include file="/common/common.jsp" %>
		...
		<link rel="stylesheet" type="text/css" href="<%=iPath%>/css/mwp_userData1.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/txgl.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		
	</head>
	<body id="mwp_userData1">
		<div id="container" class="container">
			...
			<div id="rContent" class="rContent">
					...
					<table id="content" class="content_table">
						...
						%>
						<tr><Td colspan="8"><emp:message key='txgl_mwpasgroup_text_60' defVal='无记录' fileName='mwadmin'/></Td></tr><%
							}
						%>
						</tbody>
						<tfoot>
