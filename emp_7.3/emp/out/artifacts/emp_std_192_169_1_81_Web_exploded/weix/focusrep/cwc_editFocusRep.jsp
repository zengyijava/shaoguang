...
<%
	...
	//Jsp页面中获取session中的语言设置
 	...
 	String result=(String)request.getSession().getAttribute("Foc_result");
 	request.getSession().removeAttribute("Foc_result");
...
<html>
	...
	<body>
		<div id="container" class="container" >
			<%-- header开始 --%>
			<%=com.montnets.emp.common.constant.ViewParams.getPosition(langName,menuCode,"编辑关注时回复") %>
				...
				<div id="moreSelect">
      			<table width="" style="">
						    ...
						    <tr align="right">
	                         	<td></td>
	                         	<td id="btn">
	                         		<input id="btsend" class="btnClass5 mr23" type="button" onclick="save()" value="<emp:message key="common_btn_8" defVal="保存"
											fileName="common"></emp:message>" />
									<input id="btcancel"  class="btnClass6" type="reset" value="<emp:message key="common_btn_10" defVal="返回"
		...
		<div title="<emp:message key="wexi_qywx_mrhf_text_19" defVal="回复模板选择"
				    	...
				    	<iframe id="tempFrame" name="tempFrame" style="width:720px;height:450px;border: 0;overflow:hidden;" marginwidth="0" scrolling="no" frameborder="no" src ="" ></iframe>
							<div style="text-align: center">
								...
								<input class="btnClass6" onclick="javascript:doreturn()" value="<emp:message key="common_btn_10" defVal="返回"
											fileName="common"></emp:message>" type="button"/>
							</div>
				    </div>
		<%-- 默认回复浏览 --%>
		...
		<script type="text/javascript" src="<%=iPath%>/js/editFocusRep.js"></script>
	</body>
</html>