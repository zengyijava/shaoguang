 ...
 function isChinese(str)
   {
       ...
       {
         alert(getJsLocaleMessage("weix","weix_qywx_hfgl_text_34"));
         return false;
...
function save(o){
	 ...
	 var words = "";
       ...
       $.post(path+"/cwc_replymanger.htm?method=editTextReply",
				{
       			words:words,
       			accoutid:accoutid,
       			replyname:replyname,
				...
				function(r){
	            		 if(r!=null&&r=="success") {
	            		 	alert(getJsLocaleMessage("weix","weix_qywx_hfgl_text_40"));
		            		$("form[name='updateInfo']").submit();
	                     	}
	                     else{
	                         alert(getJsLocaleMessage("weix","weix_qywx_hfgl_text_41"));
