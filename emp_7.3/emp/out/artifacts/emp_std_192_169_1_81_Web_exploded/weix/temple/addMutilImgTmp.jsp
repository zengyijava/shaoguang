...
<html>
	...
	<body >
	<%=com.montnets.emp.common.constant.ViewParams.getPosition(langName,menuCode, "新增多图文") %>
	<div class="titletop">
					<table class="titletop_table" style="width: 760px;">
						<tr>
							<td class="titletop_td">
								<emp:message key="wexi_qywx_hfgl_text_39" defVal="新增多图文"
											fileName="weix"></emp:message>
							</td>
							<td align="right">
								<span class="titletop_font" onclick="javascript:back()">&larr;&nbsp;<emp:message key="wexi_qywx_hfgl_text_20" defVal="返回上一级"
	...
	<form  method="post" action="<%=path %>/cwc_replymanger.htm?method=saveOrUpdateImgReply&pageSize=<%=pageSize %>" >
		     ...
		     <div class="msg-editer">
			   ...
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wexi_qywx_hfgl_text_33" defVal="标题："
											fileName="weix"></emp:message></div>
	            <div class="inp">
	              <input type="text" onkeyup="showTitle(this);"  maxlength="32" id="item-title" name="item-title" class="w_input inputSpec reply_name" value="" ><i>*</i>
	            </div>
	           </div>
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wexi_qywx_hfgl_text_34" defVal="封面："
			   ...
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wexi_qywx_hfgl_text_36" defVal="正文："
											fileName="weix"></emp:message></div>
	            <div class="inp">
				  <textarea id="item-content" name="item-content" cols="30" rows="10"  maxlength="1000"  class="w_input inputSpec textarea"></textarea>
	            </div>
	           </div>
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wexi_qywx_hfgl_text_37" defVal="原文链接："
