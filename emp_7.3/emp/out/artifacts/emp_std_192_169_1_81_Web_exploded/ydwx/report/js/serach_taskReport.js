...
$(document).ready(function() {
			    ...
			    setting2.asyncUrl = "wx_taskreport.htm?method=createUserTree2&lguserid="+lguserid+"&lgcorpcode="+lgcorpcode;
			    setting3.asyncUrl = "wx_taskreport.htm?method=createDeptTree&lguserid="+lguserid;
...
function modify(t)
	...
	setting3 = {									
			async : true,				
			asyncUrl : "wx_taskreport.htm?method=createDeptTree", //获取节点数据的URL地址
	...
	/*setting2 = {				
	 ...
	 setting2 = {
			    ...
			    checkType : { "Y": "s", "N": "s" },
			    async : true,
		        asyncUrl : "wx_taskreport.htm?method=createUserTree2", //获取节点数据的URL地址
				isSimpleData: true,
				rootPID : 0,
				treeNodeKey: "id",
				treeNodeParentKey: "pId",
	...
	function zTreeOnClickOK2() {
			...
			if(zTreeNodes2.length==0){
			 $("#userid").attr("value","");
			 $("#userName").attr("value", getJsLocaleMessage("ydwx","ydwx_common_qxz"));
			}
	...
	function cleanSelect_dep3()
	{
	    ...
	    zTree3.refresh();
	    $("#depNam").attr("value", getJsLocaleMessage("ydwx","ydwx_common_qxz"));	
		$("#deptid").attr("value","");	
	}
