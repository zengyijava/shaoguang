 var drag_=false
            ...
            var td=function(){
			  	D("pres").style.left=(document.documentElement.clientWidth-D("pres").clientWidth)/2-400+"px"; 
			  	D("pres").style.top=(document.body.clientHeight-D("pres").clientHeight)/2+document.documentElement.scrollTop-100+"px";     
           }
           function Move_obj(obj){
            ...
            var tuod=function(){
			  	D("pres").style.left=(document.documentElement.clientWidth-D("divBox").clientWidth)/2-200+"px"; 
			  	D("pres").style.top=(document.body.clientHeight-D("divBox").clientHeight)/2+document.documentElement.scrollTop-100+"px";     
           }
	...
	function stime(){
	 ...
	 function getpagesize(){
	    ...
	    function seeVisitPageList(busid,taskid){
			var lguserid = $("#lguserid").val();
	        window.open("wx_visitreport.htm?method=getVisitQueList&type=2&busId="+busid+"&lguserid="+lguserid+"&taskid="+taskid,"_self");
	 	}
		...
		function seeVisitInfo(obj,taskid){
	        window.open("wx_visitreport.htm?method=visittrustView&type=2&busId="+obj+"&taskid="+taskid+"","_self");
		}
	      ...
	      function findNet(){
	           var netname = document.getElementById("nname").value;
	            	var netid = document.getElementById("nid2").value;
	             	window.location.href="/wx_count.htm?method=find&netId="+netid+"&netName="+netname;
	     } 
	            
	     function netSendOut(){
	           window.location.href="/wx_count.htm?method=wxSendExport";
	     } 