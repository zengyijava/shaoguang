  ...
  <div class="link-jump">
    ...
    <el-form v-if="element.action==='5'" label-position="left">
      ...
      <el-form-item align="right">
        <el-button type="primary" size="small" @click="dialogTableVisible = true">{{ $t('buttonSetting.selectAddr') }}</el-button>
      </el-form-item>
    </el-form>
    <section v-else>
      <el-form-item v-if="element.action === '2'" :label="$t('buttonSetting.urlAddr')">
        <el-input size="small" placeholder="http://montnets.com" v-model="element.url"></el-input>
      </el-form-item>
      <el-form-item v-else-if="element.action === '4'" :label="$t('buttonSetting.appAddr')">
        <el-input size="small" placeholder="com.tencent.mobileqq" v-model="element.pkg"></el-input>
      </el-form-item>
      <div v-else-if="element.action === '7'" class="add-class">
        <el-form-item :label="$t('buttonSetting.bagName')">
          <el-input size="small" placeholder="com.tencent.mobileqq" v-model="element.pkg"></el-input>
        </el-form-item>
        <el-form-item :label="$t('buttonSetting.route')">
          <el-input size="small" placeholder="user/info" v-model="element.path"></el-input>
        </el-form-item>
        <el-form-item :label="$t('buttonSetting.params')">
          <el-input size="small" placeholder="param1=value1" v-model="element.param"></el-input>
        </el-form-item>
      </div>
    </section>
    <el-dialog class="map-dialog" :title="$t('buttonSetting.selection')" top="10vh" :visible.sync="dialogTableVisible" @open="initBaiduMap" append-to-body>
