...
(function(){
    ...
    window.onload = function(){
        ...
        initVideo();
        initUpload();
        getElementByAttr('span', 'tabSrc', 'upload').click();
    };
...
//                   if (is_music) {
                	   ...
                	   for(var key in uploadVideoList) {
                           ...
                           var width = "300px";
                           var height = "32px";
                           var ih = '<p contenteditable="false"><source><audio data-size="'+file.size+'" class="edui-faked-music" controls="controls" src="'+ url+'" style="max-width:'+width+';max-height:'+height+';"/>您的浏览器不支持该格式音频</source></p>';
                           editor.execCommand('inserthtml', ih);
