...
<div id="wrap" style="height: 100%; border: 0;overflow: hidden;display:block;width:100%;height:100%;position: absolute;z-index: 1;">
    <div style="width:100%;height:99px;position: absolute;z-index: 12;">
...
<div id="skinDiv" style="display:none;">
    <div id="themeDiv" class="ui-widget-header" style="width:100%;overflow:hidden;padding:12px 0 0;">
        ...
        <div class="classsic_change ml23 " ><span class="themeSpan" themecode="frame3.0" onclick="getThemeSkin('frame3.0')"><emp:message key="common_classic" defVal="经典" fileName="common"></emp:message></span></div>
        <div class="tradition_change selected" ><span class="themeSpan" themecode="frame2.5" onclick="getThemeSkin('frame2.5')"><emp:message key="common_tradition" defVal="传统" fileName="common"></emp:message></span></div>
    </div>
    <center>
