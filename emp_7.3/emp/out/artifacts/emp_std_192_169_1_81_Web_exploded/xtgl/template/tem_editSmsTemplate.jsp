					...
					<div>
						...
						<input type="hidden" id="cztype" name="cztype" value="1" />
							...
							<thead>
								<tr class="only_tr">
									<td colspan="2" >
										<emp:message key="xtgl_cswh_dxmbgl_rglrdtmb_only" defVal='如果录入动态模板或财务模板，参数格式为"#P_1#"（如：我们#P_1#去#P_2#。）' fileName="xtgl"/>
								...
								<tr id="tmcodetr" <%if(tem.getDsflag()-4==0){out.print("class='hidden'");}%>>
									...
									<td><font class="font_red">&nbsp;*</font><font class="yszhzmzc_font">&nbsp;&nbsp;<emp:message key="xtgl_cswh_dxmbgl_yszhzmzc" defVal="由数字或字母组成" fileName="xtgl"/></font></td>
								</tr>
								<%--
								<tr>
									<td>
								...
								<tr id="trSmsTmpType" <%if(tem.getDsflag()-3!=0){}
									...
									<div class="dsflag_div">
										...
										<div class="zmk_div"><emp:message key="xtgl_cswh_dxmbgl_zmk" defVal="子模块" fileName="xtgl"/><font color="red"><emp:message key="xtgl_cswh_dxmbgl_gmkz" defVal="(该模块只支持动态模板发送)" fileName="xtgl"/></font>：</div>
										<div class="cwcode_div">
										<select id="cwcode" name="cwcode" >
											<option value="MF0001" <%="MF0001".equals(tem.getBizCode())? "selected": "" %>><emp:message key="xtgl_cswh_dxmbgl_dzgzd" defVal="电子工资单" fileName="xtgl"/></option>
											<option value="MF0002" <%="MF0002".equals(tem.getBizCode())? "selected": "" %>><emp:message key="xtgl_cswh_dxmbgl_bxtx" defVal="报销提醒" fileName="xtgl"/></option>
											<option value="MF0003" <%="MF0003".equals(tem.getBizCode())? "selected": "" %>><emp:message key="xtgl_cswh_dxmbgl_hktz" defVal="回款通知" fileName="xtgl"/></option>
										</select>
										</div>
										</div>
								...
								<tr>
									...
									<div id="fontFmTip" class="fontFmTip" style="<%if(tem.getDsflag()-0==0 || tem.getDsflag()-2==0){out.print("display:none");} %>;"><emp:message key="xtgl_cswh_dxmbgl_csgsw" defVal='参数格式为：“{#参数1#}”(如：我和{#参数1#}去{#参数2#})' fileName="xtgl"/></div>
									</td>
								</tr>
								<tr class="mbzt_mh_tr">
									<td class="temp_style">
								...
								<tr>
									<td id="btn" colspan="2" class="btn">
										...
										<input name="" type="button" onclick="javascript:window.parent.closeEditSmsTmpdiv()" value="<emp:message key='xtgl_spgl_shlcgl_qx' defVal='取消' fileName='xtgl'/>" class="btnClass6"/>
