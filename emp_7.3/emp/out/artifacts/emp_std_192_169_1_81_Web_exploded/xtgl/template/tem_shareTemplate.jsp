...
<html>
	...
	<%@include file="/common/common.jsp" %>
		...
		<link rel="stylesheet" type="text/css" href="<%=skin %>/tem_shareTemplate.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		...
		<div id="container" class="container">
			...
			<form method="post" id="selectForm">
				...
				<table  class="mbbh_mh_table">
					<tr class="mbbh_mh_tr">
						<td class="mbbh_mh_td" align="left" colspan="2"  >
							<emp:message key="xtgl_cswh_dxmbgl_mbbh_mh" defVal="模板编号：" fileName="xtgl"/><%=tmCode %>
						</td>
						<td class="mbmc_mh_td" align="left" >
							&nbsp;&nbsp;<emp:message key="xtgl_spgl_mbsp_mbmc_mh" defVal="模板名称：" fileName="xtgl"/><span id="tmpname"></span>
						</td>
					</tr>
					<tr class="searchname_tr">
						<td class="searchname_td" align="left" colspan="2">
								<div class="div_bd searchbox">
												...
												<input id="searchname" name="searchname" type="text" maxlength="16" class="graytext" value="" 
								...
								<tr>
									<td>
										<div id="etree"  class="dept div_bd">
											<iframe id="sonFrame"  name="sonFrame" class="sonFrame" frameborder="0" src="<%=iPath %>/tem_seltree.jsp?lguserid=<%=lguserid %>&tempId=<%=tempId %>"></iframe>
										</div>
