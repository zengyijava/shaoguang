        ...
        <div id="rContent" class="rContent rContent2" >
            ...
            <form method="post" action="" name="pageForm">
                ...
                <div class="buttonDiv">
                    ...
                    <input type="button" name="button" id="buttonBack" value="<emp:message key="xtgl_qygl_fh" defVal="返回" fileName="xtgl"></emp:message>" onclick="javascript:goBack()" class="btnClass6"/>
                </div>
