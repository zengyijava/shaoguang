...
CREATE TABLE IF NOT EXISTS `LF_VERSION_HIS`
(
	ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,     /*自增ID*/
...
/*EMP产品数据库版本信息表*/
CREATE TABLE IF NOT EXISTS `LF_DB_SCRIPT`
(
ID INT PRIMARY KEY NOT NULL AUTO_INCREMENT,/*自增ID*/
...
END$
CALL LF_PVERV0('6.6.0.343','6.35','8.4.10.163','6.1.23.316',1,3)$
DROP PROCEDURE IF EXISTS `LF_PVERV0`$
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_CHANNELMAP` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_CMDQUE` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_CMDQUE_HIS` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWACCOUNT` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWDBCONF` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWLOGS` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `GWNO` INT(11) NOT NULL DEFAULT '0',
  `GWTYPE` INT(11) NOT NULL DEFAULT '200',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWPARAMCONF` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWPARAMTMPL` (
  `GWTYPE` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWPARAMVALUE` (
  `GWNO` INT(11) NOT NULL DEFAULT '0',
  `GWTYPE` INT(11) NOT NULL DEFAULT '0',
  `PARAMITEM` VARCHAR(64) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_GWSPBIND` (
  `PTACCUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_PROINFO` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_PROTOCOLTMPL` (
  `PROTOCOLCODE` INT(11) NOT NULL DEFAULT '5',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_SMSFWDCONF` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_SMSMSGIDMAP` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_SMSPUSHBIND` (
  `PROTOCOLCODE` VARCHAR(64) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `A_SMSPUSHCONF` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PROTOCOLCODE` VARCHAR(64) NOT NULL DEFAULT '',
  `PROTOCOLNAME` VARCHAR(128) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `ATTIME_TASK` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `LOGINID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `BATCH_MT_REQ` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `BATCH_MT_REQ_HIS` (
  `ID` INT(11) NOT NULL DEFAULT '0',
  `MSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `BMTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `GT_PORT_USED` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `HTTPERRCODE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `KEYWORD_BLACK` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `KF_CORPBASE` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `KF_PARAMS` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_BUFINFO` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_LOGINFO` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `LOGTYPE` INT(11) NOT NULL DEFAULT '0',
  `LOGS` VARCHAR(4000) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_MONLOG` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `LOGTYPE` INT(11) NOT NULL DEFAULT '0',
  `LOGS` VARCHAR(4000) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_MONMSG` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_PTINFO` (
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_SPGATEINFO` (
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_SYS_HIS` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_SYSINFO` (
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `CPUUSAGE` INT(11) NOT NULL DEFAULT '0',
  `MEMUSAGE` INT(11) NOT NULL DEFAULT '0',
  `VMEMUSAGE` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_THREAD_HIS` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `M_MON_BUF_HIS`
 (`ID`           BIGINT(20)         NOT NULL AUTO_INCREMENT,
  `PTCODE`       VARCHAR(32)     NOT NULL  DEFAULT '',
  `ENDCNT`       INT(11)         NOT NULL  DEFAULT 0,
  `MOTOTALRECV`  INT(11)         NOT NULL  DEFAULT 0,
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_THREADINFO` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `THRID` INT(11) NOT NULL DEFAULT '0',
  `THRNAME` VARCHAR(256) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_USER_HIS` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `M_MON_USERINFO` (
  `PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
  `USERNAME` VARCHAR(128) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_BMTREQ` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `MSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `BMTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_BMTREQHIS` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `MSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `BMTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_DATAREPORT` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_LEVEL_QUEUE` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_MO` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `UID` INT(11) NOT NULL DEFAULT '0',
  ...
  KEY `IX_MMS_MO_USERID` (`USERID`)
   ...
   CREATE TABLE IF NOT EXISTS `M_MON_LOG_HIS`
 (`ID`          BIGINT(20)      NOT NULL AUTO_INCREMENT,
  `PTCODE`      VARCHAR(32)     NOT NULL  DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_MODATAREPORT` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_RPT` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `UID` INT(11) NOT NULL DEFAULT '0',
  `ORGUID` INT(11) NOT NULL DEFAULT '0',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MMS_TEMPLATE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `TMPLID` BIGINT(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MO_DATAREPORT` (
  `IYMD` INT(11) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `IHOUR` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MO_TASK` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `ORGUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MO_TASK_HIS` (
...
CREATE TABLE IF NOT EXISTS `M_MON_SPGATE_HIS`(
	`ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
	`PTCODE` VARCHAR(32) NOT NULL DEFAULT '',
	`USERID` VARCHAR(11) NOT NULL   DEFAULT '',
	`USERUID` INT(11) NOT NULL  DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MO_WAIT_A` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
  `LOGINUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MO_WAIT_C` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `LOGINID` VARCHAR(11) NOT NULL DEFAULT '',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MR_SPGATE_WATCH` (
  `GATEID` INT(11) NOT NULL DEFAULT '0',
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `PTCODE` VARCHAR(10) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_DATAREPORT` (
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `TASKID` INT(11) NOT NULL DEFAULT '0',
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `IYMD` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_DATAREPORT_SP` (
  `IYMD` INT(11) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `SPISUNCM` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL0_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL1_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL2_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL3_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL4_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL5_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL6_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL7_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL8_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_LEVEL9_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_ROUTETABLE` (
  `ID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_TASK` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `UID` INT(11) NOT NULL DEFAULT '0',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `SPMSGID` BIGINT(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_TASK_C` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `LOGINID` VARCHAR(11) NOT NULL DEFAULT '',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_TIMER_QUEUE` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_VERIFY_TASK` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `DEALSTATUS` INT(11) NOT NULL DEFAULT '1',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_VERIFY_WAIT` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `DESTUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `MT_WAIT_A` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `LOGINUID` INT(11) NOT NULL DEFAULT '0',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `PB_LIST_BLACK` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `SPNUMBER` VARCHAR(21) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `PB_SERVICETYPE` (
  `SPISUNCM` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `PB_WEBZZCMD_LOG` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `PB_WEBZZCMD_QUEUE` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `STIME` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00',
  `CMDTYPE` INT(11) NOT NULL DEFAULT '0',
  `USERID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `RPT_WAIT_A` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `USERUID` INT(11) NOT NULL DEFAULT '0',
  `LOGINUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `RPT_WAIT_B` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `ORGUID` INT(11) NOT NULL DEFAULT '0',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `RPT_WAIT_C` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `UID` INT(11) NOT NULL DEFAULT '0',
  `LOGINID` VARCHAR(11) NOT NULL DEFAULT '',
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `VERSION_CMPP` (
...
-- ----------------------------
CREATE TABLE IF NOT EXISTS `XT_GATE_QUEUE` (
  `ID` INT(11) NOT NULL AUTO_INCREMENT,
  `SPGATE` VARCHAR(21) NOT NULL DEFAULT '',
  `SPISUNCM` INT(11) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `A_PROVINCECITY`
(
`ID` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `A_MOBILEAREA`
(
`ID` INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `A_CMD_ROUTE`(
...
CREATE TABLE IF NOT EXISTS `A_CMD_PORT`(                            
 `ID` BIGINT(20)  AUTO_INCREMENT,                     
...
CREATE DEFINER = `root` @`%` PROCEDURE schema_change() 
BEGIN
	IF NOT EXISTS ( SELECT * FROM INFORMATION_SCHEMA.STATISTICS WHERE TABLE_SCHEMA = DATABASE ( ) AND table_name = 'MMS_TASK' AND index_name = 'IX_MMSTASK_P1' AND COLUMN_NAME = 'P1' ) THEN
			ALTER TABLE MMS_TASK ADD INDEX IX_MMSTASK_P1 ( P1 );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_TASK' AND index_name = 'IX_MMSTASK_SDTM' AND COLUMN_NAME = 'SENDTIME' ) THEN
			ALTER TABLE MMS_TASK ADD INDEX IX_MMSTASK_SDTM ( SENDTIME );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_TASK' AND index_name = 'IX_MMSTASK_SVRTYPE' AND COLUMN_NAME = 'SVRTYPE') THEN
			ALTER TABLE MMS_TASK ADD INDEX IX_MMSTASK_SVRTYPE ( SVRTYPE );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_TASK' AND index_name = 'IX_MMSTASK_TASKID' AND COLUMN_NAME = 'TASKID') THEN
			ALTER TABLE MMS_TASK ADD INDEX IX_MMSTASK_TASKID ( TASKID );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_TASK' AND index_name = 'IX_MMSTASK_USRID' AND COLUMN_NAME = 'USERID') THEN
			ALTER TABLE MMS_TASK ADD INDEX IX_MMSTASK_USRID ( USERID );
	END IF;
	
	
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_MO' AND index_name = 'IX_MMS_MO_ORGUID' AND COLUMN_NAME = 'ORGUID') THEN
			ALTER TABLE MMS_MO ADD INDEX IX_MMS_MO_ORGUID ( ORGUID );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_MO' AND index_name = 'IX_MMS_MO_SDSTATUS' AND COLUMN_NAME = 'SENDSTATUS') THEN
			ALTER TABLE MMS_MO ADD INDEX IX_MMS_MO_SDSTATUS ( SENDSTATUS );
	END IF;
	IF NOT EXISTS ( SELECT * FROM information_schema.statistics WHERE table_schema = DATABASE ( ) AND table_name = 'MMS_MO' AND index_name = 'IX_MMS_MO_US' AND COLUMN_NAME in ('UID','SENDSTATUS')) THEN
...
CREATE TABLE IF NOT EXISTS `A_IPCOMINFO`(
ID	      INT(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `A_SIMINFO`(
...
CREATE TABLE IF NOT EXISTS `A_MNP`(
ID INT(11) NOT NULL AUTO_INCREMENT, 
PHONE VARCHAR(21) NOT NULL DEFAULT '',                          
UNICOM INT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `A_MNPERRCODE`(
ID	INT(11) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `A_SPE_PHONE`(
ID	INT(11) NOT NULL  AUTO_INCREMENT,
PHONE	VARCHAR(21)	NOT NULL DEFAULT '' ,
...
CREATE TABLE IF NOT EXISTS `A_AREACODE`(
ID	INT(11) NOT NULL  AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `A_GWROUTE`(
ID	INT(11)  NOT NULL AUTO_INCREMENT,
TYPE	  INT(11) NOT NULL DEFAULT 0,
GATEID	INT(11) NOT NULL DEFAULT 0,
STATUS	INT(11) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `GW_MT_TASK_BAK` (
  `ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
  `UID` INT(11) NOT NULL DEFAULT '0',
  `PTMSGID` BIGINT(20) NOT NULL DEFAULT '0',
  `SPMSGID` BIGINT(20) NOT NULL DEFAULT '0',
...
CREATE TABLE IF NOT EXISTS `GW_MT_TASK_ERR` (
...
CREATE TABLE IF NOT EXISTS `GW_MTSDOK`
 (`ID`            BIGINT(20)      NOT NULL    AUTO_INCREMENT    , 
  `PTMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  `SPMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  ...
  KEY `IX_GWMTSDOK_IN_TIME` (`IN_TIME`)
    ...
    CREATE TABLE IF NOT EXISTS `GW_MTSDOK_BAK`
 (`ID`            BIGINT(20)      NOT NULL   , 
  `PTMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  `SPMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  `SENDSTATUS`    SMALLINT      NOT NULL  DEFAULT 3            ,
  ...
  KEY `IX_GWMTSDOKBAK_IN_TIME` (`IN_TIME`)
   ...
   CREATE TABLE IF NOT EXISTS `GW_MTSDOK_ERR`
 (`ID`            BIGINT(20)      NOT NULL   , 
  `PTMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  `SPMSGID`       BIGINT(20)      NOT NULL      DEFAULT 0 ,
  `SENDSTATUS`    SMALLINT      NOT NULL  DEFAULT 3            ,
...
-- DROP TABLE  IF EXISTS `GW_RPTRVOK`$
 CREATE TABLE IF NOT EXISTS  `GW_RPTRVOK`
 (`ID`           BIGINT(20)        NOT NULL    AUTO_INCREMENT  , 
  `PTMSGID`     BIGINT(20)  NOT NULL   DEFAULT 0  ,
  `SPMSGID`     BIGINT(20)   NOT NULL   DEFAULT 0  ,
...
CREATE TABLE  IF NOT EXISTS  `GW_RPTRVOK_BAK`
 (`ID`           BIGINT(20)        NOT NULL  , 
  `PTMSGID`     BIGINT(20)  NOT NULL   DEFAULT 0  ,
  `SPMSGID`     BIGINT(20)   NOT NULL   DEFAULT 0  ,
  `SENDSTATUS`  SMALLINT     NOT NULL   DEFAULT 5  , 
...
-- DROP TABLE  IF EXISTS `GW_RPTRVOK_ERR`$ 
 CREATE TABLE  IF NOT EXISTS  `GW_RPTRVOK_ERR`
 (`ID`           BIGINT(20)        NOT NULL, 
  `PTMSGID`     BIGINT(20)  NOT NULL   DEFAULT 0  ,
  `SPMSGID`     BIGINT(20)   NOT NULL   DEFAULT 0  ,
  `SENDSTATUS`  SMALLINT     NOT NULL   DEFAULT 5  , 
...
CREATE TABLE  IF NOT EXISTS  `GW_RPTSDOK`
 (`ID`            BIGINT(20)    NOT NULL     AUTO_INCREMENT      ,
  `PTMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SPMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SENDSTATUS`    SMALLINT       NOT NULL  DEFAULT 5  ,
...
CREATE TABLE  IF NOT EXISTS  `GW_RPTSDOK_BAK`
 (`ID`            BIGINT(20)    NOT NULL     ,
  `PTMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SPMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SENDSTATUS`    SMALLINT       NOT NULL  DEFAULT 5  ,
...
CREATE TABLE  IF NOT EXISTS  `GW_RPTSDOK_ERR`
 (`ID`            BIGINT(20)    NOT NULL     ,
  `PTMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SPMSGID`       BIGINT(20)    NOT NULL     DEFAULT 0  ,
  `SENDSTATUS`    SMALLINT       NOT NULL  DEFAULT 5  ,
...
CREATE TABLE  IF NOT EXISTS  `GW_TRAN_DEL_LOG`
 (`ID`       BIGINT(20)     NOT NULL  AUTO_INCREMENT ,
...
CREATE TABLE  IF NOT EXISTS  `GW_UPD_DEL_LOG`
 (`ID`       BIGINT(20)     NOT NULL  AUTO_INCREMENT  ,
  `OPRTYPE`  TINYINT(3)   NOT NULL,
...
CREATE TABLE IF NOT EXISTS `GW_MSGTAIL`(
...
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_GW_MSGTAIL`$
...
CREATE TABLE IF NOT EXISTS `GW_TAILBIND`(
`ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_GW_TAILBIND`$
...
CREATE TABLE IF NOT EXISTS `GW_TAILCTRL`(
`ID` BIGINT(20) NOT NULL AUTO_INCREMENT,
...
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_GW_TAILCTRL`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_RTAILCTRL`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_RBINDINFO`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_LFSPECBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADALLBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADUSRBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETSPRULE`$
...
##加载网优路由绑定表
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADGWROUTE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_RPTWAITA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_RPTWAITB`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_RPTWAITA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_RPTWAITB`$
...
##写携号转网表
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_WR_MNP`$
...
##携号转网表增量加载
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADMNP`$
...
##错误码表一次性全部加载
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADMNPERRCODE`$
...
##特殊号码表增量加载
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADSPEPHNO`$
...
##加载国际区号表
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADAREACODE`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADCMD_ROUTE`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADCMD_ROUTE_P`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADCMD_ROUTE_G`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETSGIPBIND`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADMOBILEAREA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETALLUSRINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETCHANNELMAP`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETCMDQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETENDCHBINDB`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETGWACC`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_A_GETGWACCV1`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETGWCFG`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETKFPARAMS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETMSGIDMAP`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETPBSVRTYPE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETPRECHBINDA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETURLBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETUSRFEE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETUSRINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_GETUSRUID`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADFEEINFOA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADFORWARDBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADKEYWORDS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADMTROUTE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_LOADPUSHBIND`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_RD_PROINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_SYNCUSRFEEA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_SYNCUSRFEEB`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_SYNCUSRFEEBV1`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_UPDCMDQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_UPDNUMSECTION`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_WR_MSGIDMAP`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `A_WR_PROINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_MMSSTATISTICS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_STATISTICS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_DELETETASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_MMSDELTETASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_PROCESSSTATUS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_RESTATISTICS`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_TRANSFER`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_MMSTRANSFER`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_DATATRANSFER`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_MMSTRANSFERMO`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `H_MMSDATATRANSF`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `INSERTMTREPORT_SP`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `LOADPROCERRCODE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `M_WR_MONINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `MERGEPROCESSINGSTATUS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `MMS_RD_BMTREQ`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `MMS_UPD_BMTREQ`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `MMS_WR_LVLQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `PRO_INDEX_REBUILD`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_ATTMRTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MMS_QUEUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MMSSNDQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MOWAITA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MOWAITA_PUSH`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MTLVLQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MTTASKRESD`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MTTASKRPT`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MTVFYTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_MTWAITA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_RD_RPTWAITA_PUSH`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_ATTMRFLAG`$
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_BATMTREQ`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MMS_MTRPT`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MONINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MOTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MTRPT`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MTTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_UPD_MTVFYTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_MMS_MO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_MMS_TASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_MOWAITA`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_RPTWAITC`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `S_WR_VERINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP FUNCTION IF EXISTS `BUILDINSERTSQL`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP FUNCTION IF EXISTS `BUILDUPDATESQL`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP FUNCTION IF EXISTS `GETARRAYLENGTH`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP FUNCTION IF EXISTS `GETARRAYSTROFINDEX`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP FUNCTION IF EXISTS `SUBSTRINGPRIKEY`$
...
/*触发器表
ERROR 1146 (42S02): Table 'emp73linux.A_GWACCOUNT' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.A_CMDQUE' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.A_CMDQUE_HIS' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.BATCH_MT_REQ' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.BATCH_MT_REQ_HIS' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.KF_CORPBASE' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.M_MON_MONMSG' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.M_MON_SPGATEINFO' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.M_MON_THREADINFO' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.M_MON_USERINFO' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MR_SPGATE_WATCH' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MT_DATAREPORT' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MT_TASK' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MT_TASK_C' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.PB_WEBZZCMD_LOG' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.PB_WEBZZCMD_QUEUE' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.PB_WEBZZCMD_QUEUE' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.USERDATA' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.USERDATA' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_BMTREQ' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_BMTREQHIS' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_DATAREPORT' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_LEVEL_QUEUE' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_MO' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_RPT' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_TASK' doesn't exist
ERROR 1146 (42S02): Table 'emp73linux.MMS_TEMPLATE' doesn't exist*/


/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_AGWACCOUNT`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_ACMDQUE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_CMDHIS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_BATCHMTREQ`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_BATMTHIS`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_KCB`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MONMSG`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MSPGATEINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MTHREAD`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_USERINFO`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MRSPWATCH`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MT_DREPORT`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MTTASK`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_MTTASKC`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_PWL`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_PWQ`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TRIGGER_UPDATEUSERFREE`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_TIME_USERDATAEX`$
...
-- ----------------------------
/*DELIMITER ;*/
DROP TRIGGER IF EXISTS `TIG_USERDATA`$
...
-- ----------------------------
/*DELIMITER ;*/     
DROP TRIGGER IF EXISTS `TIG_TIME_MMSBMTREQ`$  
...
-- ----------------------------                                                             
/*DELIMITER ;*/  
DROP TRIGGER IF EXISTS `TIG_TIME_MMSBTHIS`$                                                                                
...
-- ----------------------------                                                             
/*DELIMITER ;*/       
DROP TRIGGER IF EXISTS `TIG_TIME_MMSDTRPT`$                                                                           
...
-- ----------------------------
/*DELIMITER ;*/       
DROP TRIGGER IF EXISTS `TIG_TIME_MMSLEVQUE`$ 
...
-- ----------------------------
/*DELIMITER ;*/   
DROP TRIGGER IF EXISTS `TIG_TIME_MMSMO`$     
...
-- ----------------------------
/*DELIMITER ;*/   
DROP TRIGGER IF EXISTS `TIG_TIME_MMSRPT`$      
...
-- ----------------------------
/*DELIMITER ;*/      
DROP TRIGGER IF EXISTS `TIG_TIME_MMSTASK`$      
...
-- ----------------------------
/*DELIMITER ;*/     
DROP TRIGGER IF EXISTS `TIG_TIME_MMSTEMPT`$    
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_WRRPTWAITCV1`$    
...
-- ----------------------------
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_H_STATISTIV1`$    
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_H_MMSSTATIV1`$   
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_H_DATATRANV1`$   
...
/*DELIMITER ;*/
DROP PROCEDURE IF EXISTS `GW_H_MMSDATATV1`$ 
...
BEGIN
  ...
  IF NOT EXISTS (SELECT PTMSGID  FROM RMSRPT_RVOK WHERE PTMSGID = PIPTMSGID ) THEN
...
/*DELIMITER ;;*/
DROP PROCEDURE IF EXISTS `GW_MTTASKSUPPV5`$
CREATE DEFINER=`root`@`%` PROCEDURE `GW_MTTASKSUPPV5`(P_OLDMSGID BIGINT,
	P_NEWMSGID BIGINT,
	P_SRCUID INT,
	P_SRCUSRID VARCHAR(11),
	P_SRCSPGATE VARCHAR(21),
...
BEGIN
  ...
  DECLARE P_CUSTID VARCHAR(64);
  DECLARE P_EXDATA VARCHAR(64);
  DECLARE P_SUID1 VARCHAR(64);
  DECLARE P_LUID1 VARCHAR(64);
  ...
  DECLARE P_SIGNATURE_V  VARCHAR(60);
   ...
   DECLARE P_RCOUNT1 INT;
	...
	DONEDATE CHAR(10),ERRORCODE CHAR(7),SENDLEVEL TINYINT UNSIGNED,SENDTYPE TINYINT UNSIGNED,UNICOM TINYINT UNSIGNED,RESENDCNT TINYINT UNSIGNED,RECVMTTIME DATETIME,RECVTIME DATETIME,USERMSGID BIGINT,
	MESSAGE VARCHAR(3000),TPUDHI TINYINT UNSIGNED,LONGMSGSEQ TINYINT UNSIGNED,MSGFMT TINYINT UNSIGNED,MOBILEAREA INT,SVRTYPE VARCHAR(64),TPPID TINYINT UNSIGNED,P1 VARCHAR(64),
	P2 VARCHAR(64),P3 VARCHAR(64),P4 VARCHAR(64),MODULEID INT,ATTIME BIGINT,VALIDTIME BIGINT,BATCHID BIGINT,AREACODE INT,CUSTID VARCHAR(64),EXDATA VARCHAR(64),SUID1 VARCHAR(64),LUID1 VARCHAR(64));
  TRUNCATE P_TMP_MTSUPPV1;
	...
	DONEDATE,ERRORCODE,SENDLEVEL,SENDTYPE,UNICOM,RESENDCNT,RECVMTTIME,RECVTIME,
	MESSAGE,TPUDHI,LONGMSGSEQ,MSGFMT,MOBILEAREA,SVRTYPE,TPPID,USERMSGID,
	P1,P2,P3,P4,MODULEID,ATTIME,VALIDTIME,BATCHID,AREACODE,CUSTID,EXDATA,SUID1,LUID1)
	SELECT UID,PTMSGID,ECID,TASKID,USERID,SPGATE,CPNO,PHONE,
	SPMSGID,RETFLAG,FEEFLAG,PKNUMBER,PKTOTAL,2,SENDFLAG,RECVFLAG,
	DONEDATE,ERRORCODE,SENDLEVEL,SENDTYPE,UNICOM,RESENDCNT,RECVMTTIME,RECVTIME,
	MESSAGE,TPUDHI,LONGMSGSEQ,MSGFMT,MOBILEAREA,SVRTYPE,TPPID,USERMSGID,
  ...
  END IF;
	...
	IF  P_RCOUNT1-P_RCOUNT2>0 THEN
		...
		SELECT PKTOTAL,PKNUMBER,ECID,PHONE,SENDLEVEL,TASKID,TPUDHI,LONGMSGSEQ,MSGFMT,UNICOM,
                          MOBILEAREA,SVRTYPE,TPPID,USERMSGID,SENDTYPE,P1,P2,P3,P4,MODULEID,ATTIME,VALIDTIME,BATCHID,AREACODE,CUSTID,EXDATA,SUID1,LUID1
                   INTO P_PKTOTAL,P_PKNUM,P_ECID,P_PHONE,P_SENDLEVEL,P_TASKID,P_TPUDHI,P_LONGMSGSEQ,P_MSGFMT,P_UNICOM,
                          P_MOBILEAREA,P_SVRTYPE,P_TPPID,P_USERMSGID,P_SENDTYPE,P_P1,P_P2,P_P3,P_P4,P_MODULEID,P_ATTIME,P_VALIDTIME,P_BATCHID,P_AREACODE,P_CUSTID,P_EXDATA,P_SUID1,P_LUID1
		  FROM P_TMP_MTSUPPV1 WHERE PTMSGID=P_OLDMSGID;
     ...
     END IF;
		 ...
		 IF (P_PKTOTAL <= 1 AND ((P_PKTOTAL <= P_SENDNUM AND P_DESTFEEFLAG=1) OR P_DESTFEEFLAG=2)) THEN ##对于非长短信补发的处理
          ...
          END IF;
					...
					##调用插入存储过程
					CALL GW_WR_MTTASKV3(P_DESTUID,P_NEWMSGID,2,1,P_PKTOTAL,1,
									P_SPLITLEN_V,P_MULTILEN1_V,P_MULTILEN2_V,P_NEWSIGNLEN_V,P_ECID,
									P_DESTUSRID,P_DESTSPGATE,P_DESTCPNO,P_RECVMTTIME,P_LONGMSG,
									P_PHONE,P_DESTFEEFLAG,P_SENDLEVEL,P_TASKID,'',P_TPUDHI,
									P_LONGMSGSEQ,P_MSGFMT,P_UNICOM,P_MOBILEAREA,P_PKNUM,P_SVRTYPE,
									P_P1,P_P2,P_P3,P_P4,P_USERMSGID,P_MODULEID,P_ATTIME,P_VALIDTIME,P_SENDTYPE,P_BATCHID,P_AREACODE,P_CUSTID,P_EXDATA,P_SUID1,P_LUID1);
				ELSE
					SET P_LONGMSG='';
				END IF;##END OF IF P_LONGMSGLEN > 0
				SET P_PKNUM=1;
 ...
 /*
		ELSEIF (P_PKTOTAL > 1 AND ((P_PKTOTAL <= P_SENDNUM AND P_DESTFEEFLAG=1) OR P_DESTFEEFLAG=2) AND P_TPUDHI=1) THEN ##对标准协议长短信的补发
			...
			IF P_LONGMSGLEN > 0 THEN
				##调用插入存储过程
				CALL GW_WR_MTTASKSRV3(P_DESTUID,P_OLDMSGID,2,1,P_PKTOTAL,1,P_ECID,
								P_DESTUSRID,P_DESTSPGATE,P_DESTCPNO,P_RECVMTTIME,P_LONGMSG,
								P_PHONE,P_DESTFEEFLAG,P_PKNUM,P_SENDLEVEL,P_TASKID,'',P_TPUDHI,
								P_LONGMSGSEQ,P_MSGFMT,P_UNICOM,P_MOBILEAREA,P_SVRTYPE,
								P_P1,P_P2,P_P3,P_P4,P_USERMSGID,P_MODULEID,P_ATTIME,P_VALIDTIME,P_SENDTYPE,P_BATCHID,P_AREACODE,P_CUSTID,P_EXDATA,P_SUID1,P_LUID1);
...
*/
	...
	P_DESTCPNO AS CPNO,P_PHONE AS PHONE,RETFLAG,P_DESTFEEFLAG AS FEEFLAG,P_PKNUM AS PKNUMBER,P_PKTOTAL AS PKTOTAL,
	SENDSTATUS,1 AS SENDLEVEL,P_RECVMTTIME AS RECVMTTIME,P_LONGMSG AS MESSAGE,TPUDHI,LONGMSGSEQ,MSGFMT,UNICOM,
	MOBILEAREA,SVRTYPE,TPPID,P1,P2,P3,P4,USERMSGID,MODULEID,ATTIME,VALIDTIME,SENDTYPE,BATCHID,AREACODE,CUSTID,EXDATA,SUID1,LUID1 FROM P_TMP_MTSUPPV1 WHERE P_LONGMSG<>'' ;
END$
/*DELIMITER ;*/
