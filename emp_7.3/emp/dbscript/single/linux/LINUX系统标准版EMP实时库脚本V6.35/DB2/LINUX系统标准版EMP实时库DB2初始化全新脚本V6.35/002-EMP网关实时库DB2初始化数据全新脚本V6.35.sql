...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'SPLITLONGMSG' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
---新增网关配置参数
IF NOT EXISTS (SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1DATAFILELPATH' AND GWTYPE=4000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('6CLU1DATAFILELPATH', '本地数据文件目录',  '定时数据文件输出的本地路径(填写绝对路径)，默认为空，取程序当前路径。',1, ' ',' ', 0, 4000);
END IF;

IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1DATAFILERPATH' AND GWTYPE=4000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE,DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('6CLU1DATAFILERPATH', '共享数据文件目录',  '集群网关数据文件共享路径(填写绝对路径)，默认为空，不进行文件共享。',1, ' ',' ', 0, 4000);
END IF;


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'MON1REMAINMTWARN' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
---------SPGATE新增配置参数
IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1MSGIDFILET' AND GWTYPE=3000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('6CLU1MSGIDFILET', '流水号文件频率',  '每隔多少秒产生一个日志文件(单位:秒)，默认5秒，取值范围：3-3600',1, '5','3-3600', 0, 3000);
END IF;

IF NOT EXISTS (SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='INTB7AUTOCTRL' AND GWTYPE=4000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('INTB7AUTOCTRL', '暂停实时转移阀值',  '实时转移模式下，平台短信滞留量超过阀值后，程序自动暂停实时转移(取值范围：1000-20000000，0表示不启用)',
1, '0','1000-20000000', 0, 4000);
END IF;

IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1MSGIDFILESIZE' AND GWTYPE=3000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('6CLU1MSGIDFILESIZE', '流水号文件大小',  '单个流水号操作日志文件大小(单位:M)，默认20M，取值范围：1-100',1, '20','1-100', 0, 3000);
END IF;

IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1CHKPOINT' AND GWTYPE=3000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE,  CONTROLTYPE, GWTYPE) 
VALUES('6CLU1CHKPOINT', '流水号CheckPoint频率',  '多长时间进行一次checkpoint(单位:小时)，默认2小时，取值范围：1-24',1, '2','1-24', 0, 3000);
END IF;


IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1DATAFILELPATH' AND GWTYPE=3000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE) 
VALUES('6CLU1DATAFILELPATH', '本地数据文件目录',  '定时数据文件输出的本地路径(填写绝对路径)，默认为空，取程序当前路径。',1, ' ',' ', 0, 3000);
END IF;

IF NOT EXISTS(SELECT * FROM A_GWPARAMCONF WHERE PARAMITEM='6CLU1DATAFILERPATH' AND GWTYPE=3000) THEN
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE) 
VALUES('6CLU1DATAFILERPATH', '共享数据文件目录',  '集群网关数据文件共享路径(填写绝对路径)，默认为空，不进行文件共享。',1, ' ',' ', 0, 3000);
END IF;
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'THREADCTRL' AS "PARAMITEM",'网关线程数控制' AS "PARAMNAME",'网关程序启动线程数控制(重启生效)' AS "PARAMMEMO",  2 AS "PARAMATTRIBUTE", 
                                       ' ' AS "VALUERANGE", '2-2-2-2-1-5-1' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB0TRANSMODE' AS "PARAMITEM",'数据转移模式' AS "PARAMNAME",'0-实时转移(实时转移)，1-整点转移(一天转移一次)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '0,1' AS "VALUERANGE", '0' AS "DEFAULTVALUE",  1 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB1INTERVAL' AS "PARAMITEM",'实时转移时间间隔' AS "PARAMNAME",'实时从热表转移数据到实时表的时间间隔(单位:秒，默认300秒)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '10-7200' AS "VALUERANGE", '300' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB1INTERVAL', '实时转移时间间隔',  '实时从热表转移数据到实时表的时间间隔(单位:秒，默认300秒)',1, '10-7200','180', 0, 4000)
ELSE IGNORE;
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB2PRETIME' AS "PARAMITEM",'热表数据时长' AS "PARAMNAME",'热表中保存多长时间的数据(单位:分钟)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '1-1440' AS "VALUERANGE", '10' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB3INCRESLOAD' AS "PARAMITEM",'分批次转移数据量' AS "PARAMNAME",'分批从热表转移到备份表，批次转移数据量。' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '1000-1000000' AS "VALUERANGE", '500000' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB5TRANSTIME' AS "PARAMITEM",'整点转移时间' AS "PARAMNAME",'整点数据转移模式，下一次整点数据转移时间(例如: 00:30:00)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '00:00:00-23:59:59' AS "VALUERANGE", '00:30:00' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB6STATSTRANS' AS "PARAMITEM",'调度汇总时间' AS "PARAMNAME",'网关汇总数据报表及历史数据调度时间(例如: 03:00:00)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '00:00:00-23:59:59' AS "VALUERANGE", '03:00:00' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE08STOPINSERTDB' AS "PARAMITEM",3000 AS "GWTYPE" FROM   SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE08STOPINSERTDB', '暂停数据文件入库',  '暂停数据文件入库(1:暂停文件入库; 0:开启文件入库, 默认为0)属性：高级参数',1, '0,1','0',1,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE08STOPINSERTDB' AS "PARAMITEM",4000 AS "GWTYPE" FROM   SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
-----2017.01.03 添加文件参数
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE01USEORDB' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE01USEORDB', '启用写文件模式',  '文件模式下行先写入文件，后再读取入数据库表(1:文件方式; 0:直接入库, 默认为1)',1, '0,1','1',1,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE01USEORDB' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE01USEORDB', '启用写文件模式',  '文件模式下行先写入文件，后再读取入数据库表(1:文件方式; 0:直接入库, 默认为1)',1, '0,1','1',1,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE02DISKFREE' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE02DISKFREE', '写数据文件的最小磁盘空间大小',  '写数据文件的最小磁盘空间大小,单位G(5~200，默认为10G)',1, '5~200','10',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE02DISKFREE' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE02DISKFREE', '写数据文件的最小磁盘空间大小',  '写数据文件的最小磁盘空间大小,单位G(5~200，默认为10G)',1, '5~200','10',0,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE03MSGFILESIZE' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE03MSGFILESIZE', '单个数据文件大小',  '单个数据文件大小,单位M(20~100，默认为20M)',1, '20~100','20',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE03MSGFILESIZE' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE04MSGFILETM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE04MSGFILETM', '数据文件生成频次',  '数据文件生成的频次,单位秒(5~300，默认为20秒)',1, '5~300','20',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE04MSGFILETM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE04MSGFILETM', '数据文件生成频次',  '数据文件生成的频次,单位秒(5~300，默认为20秒)',1, '5~300','20',0,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE05COMPRESSDIRTM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE05COMPRESSDIRTM', '压缩多少天前的数据文件',  '压缩多少天前的数据文件(1~30，默认为3天)',1, '1~30','3',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE05COMPRESSDIRTM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE05COMPRESSDIRTM', '压缩多少天前的数据文件',  '压缩多少天前的数据文件(1~30，默认为3天)',1, '1~30','3',0,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE06DELETEFILETM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE06DELETEFILETM', '删除多少天前的数据压缩文件',  '删除多少天前的数据压缩文件(30~120，默认为90天)',1, '30~120','90',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE06DELETEFILETM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE06DELETEFILETM', '删除多少天前的数据压缩文件',  '删除多少天前的数据压缩文件(30~120，默认为90天)',1, '30~120','90',0,3000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE07SHAREDIR' AS "PARAMITEM",4000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE07SHAREDIR', '保存数据文件的共享目录',  '保存数据文件的共享目录',1, ' ',' ',0,4000)
ELSE IGNORE;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE07SHAREDIR' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
INSERT INTO A_GWPARAMCONF (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('ASYNWINSIZEMON', '滑动窗口大小(1-256)', 2, '滑动窗口大小(异步提交MO)(1-32)', '128', '1-256', 0, 3000);
...
INSERT  INTO  A_GWPARAMCONF(PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  
VALUES('MAPSIZE', 'MAP流水号队列大小',  'MAP流水号队列大小(20000000~80000000，默认为50000000)',1, '20000000~80000000','50000000',0,3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'SENDERRORRPT' AS "PARAMITEM",3000 AS "GWTYPE" FROM  SYSIBM.DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  
