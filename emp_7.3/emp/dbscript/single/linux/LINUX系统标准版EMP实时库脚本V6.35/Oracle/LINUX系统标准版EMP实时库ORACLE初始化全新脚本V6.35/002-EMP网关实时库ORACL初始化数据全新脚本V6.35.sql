...
--INSERT INTO A_GWPARAMCONF (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
--VALUES ('STARTSVRPROTOCOL', '运营商协议配置', 0, '运营商协议，CMPP-移动,SGIP-联通,SMGP-电信', '1-1-1', 'CMPP,SMGP,SGIP', 2, 4000);

INSERT INTO A_GWPARAMCONF (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('SMPPPORT', 'SMPP协议端口', 2, '国际协议SMPP协议端口', '8891', ' ', 0, 4000);
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB0TRANSMODE' AS "PARAMITEM",'数据转移模式' AS "PARAMNAME",'0-实时转移(实时转移)，1-整点转移(一天转移一次)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '0,1' AS "VALUERANGE", '0' AS "DEFAULTVALUE",  1 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB0TRANSMODE', '数据转移模式',  '0-实时转移(实时转移)，1-整点转移(一天转移一次)',1, '0,1','0', 1, 4000)
;
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB1INTERVAL' AS "PARAMITEM",'实时转移时间间隔' AS "PARAMNAME",'实时从热表转移数据到实时表的时间间隔(单位:秒，默认180秒)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '10-7200' AS "VALUERANGE", '180' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB1INTERVAL', '实时转移时间间隔',  '实时从热表转移数据到实时表的时间间隔(单位:秒，默认180秒)',1, '10-7200','180', 0, 4000)
;
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB2PRETIME' AS "PARAMITEM",'热表数据时长' AS "PARAMNAME",'热表中保存多长时间的数据(单位:分钟)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '1-1440' AS "VALUERANGE", '5' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB2PRETIME', '热表数据时长',  '热表中保存多长时间的数据(单位:分钟)',1, '1-1440','5', 0, 4000)
;
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB3INCRESLOAD' AS "PARAMITEM",'分批次转移数据量' AS "PARAMNAME",'分批从热表转移到备份表，批次转移数据量。' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '1000-1000000' AS "VALUERANGE", '100000' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB3INCRESLOAD', '分批次转移数据量',  '分批从热表转移到备份表，批次转移数据量。',1, '1000-1000000','500000', 0, 4000)
;
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB4INCRES' AS "PARAMITEM",'分批次更新数据量' AS "PARAMNAME",'下行数据的发送状态分批更新，批次更新数量。' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '1000-1000000' AS "VALUERANGE", '100000' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB4INCRES', '分批次更新数据量',  '下行数据的发送状态分批更新，批次更新数量。',1, '1000-1000000','500000', 0, 4000)
;
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB5TRANSTIME' AS "PARAMITEM",'整点转移时间' AS "PARAMNAME",'整点数据转移模式，下一次整点数据转移时间(例如: 00:30:00)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '00:00:00-23:59:59' AS "VALUERANGE", '00:30:00' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB5TRANSTIME', '整点转移时间',  '整点数据转移模式，下一次整点数据转移时间(例如: 00:30:00)',1, '00:00:00-23:59:59','00:30:00', 0, 4000)
;

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB6STATSTRANS' AS "PARAMITEM",'调度汇总时间' AS "PARAMNAME",'网关汇总数据报表及历史数据调度时间(例如: 03:00:00)' AS "PARAMMEMO",  1 AS "PARAMATTRIBUTE", 
                                       '00:00:00-23:59:59' AS "VALUERANGE", '03:00:00' AS "DEFAULTVALUE",  0 AS "CONTROLTYPE",4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)  VALUES('INTB6STATSTRANS', '调度汇总时间',  '网关汇总数据报表及历史数据调度时间(例如: 03:00:00)',1, '00:00:00-23:59:59','03:00:00', 0, 4000)
;

MERGE INTO  A_GWPARAMCONF A USING (SELECT '6CLU1DATAFILELPATH' AS "PARAMITEM",'本地数据文件目录' AS "PARAMNAME",  1 AS "PARAMATTRIBUTE",
'定时数据文件输出的本地路径(填写绝对路径)，默认为空，取程序当前路径' AS "PARAMMEMO",  ' ' AS "DEFAULTVALUE",' ' AS "VALUERANGE",  
0 AS "CONTROLTYPE", 4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT '6CLU1DATAFILERPATH' AS "PARAMITEM",'共享数据文件目录' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'集群网关数据文件共享路径(填写绝对路径)，默认为空，不进行文件共享' AS "PARAMMEMO", ' ' AS "DEFAULTVALUE",' ' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('6CLU1DATAFILERPATH', '共享数据文件目录', 1, '集群网关数据文件共享路径(填写绝对路径)，默认为空，不进行文件共享', ' ', ' ', 0, 4000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'INTB7AUTOCTRL' AS "PARAMITEM",'暂停实时转移阀值' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'实时转移模式下，平台短信滞留量超过阀值后，程序自动暂停实时转移(取值范围：1000-20000000，0表示不启用)' AS "PARAMMEMO", 
'0' AS "DEFAULTVALUE",'1000-20000000' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
...
--------------2017.01.03
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE01USEORDB' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE01USEORDB' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE01USEORDB', '启用写文件模式',  '文件模式下行先写入文件，后再读取入数据库表(1:文件方式; 0:直接入库, 默认为1)',1, '0,1','1',1,3000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE02DISKFREE' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE02DISKFREE', '写数据文件的最小磁盘空间大小',  '写数据文件的最小磁盘空间大小,单位G(5~200，默认为10G)',1, '5~200','10',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE02DISKFREE' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE03MSGFILESIZE' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE03MSGFILESIZE', '单个数据文件大小',  '单个数据文件大小,单位M(20~100，默认为20M)',1, '20~100','20',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE03MSGFILESIZE' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE04MSGFILETM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE04MSGFILETM', '数据文件生成频次',  '数据文件生成的频次,单位秒(5~300，默认为20秒)',1, '5~300','20',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE04MSGFILETM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE05COMPRESSDIRTM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE05COMPRESSDIRTM', '压缩多少天前的数据文件',  '压缩多少天前的数据文件(1~30，默认为3天)',1, '1~30','3',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE05COMPRESSDIRTM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE06DELETEFILETM' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE06DELETEFILETM', '删除多少天前的数据压缩文件',  '删除多少天前的数据压缩文件(30~120，默认为90天)',1, '30~120','90',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE06DELETEFILETM' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE07SHAREDIR' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE07SHAREDIR', '保存数据文件的共享目录',  '保存数据文件的共享目录',1, ' ',' ',0,4000);


MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE07SHAREDIR' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE07SHAREDIR', '保存数据文件的共享目录',  '保存数据文件的共享目录',1, ' ',' ',0,3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT  'MON1REMAINMTWARN' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'SPLITLONGMSG' AS "PARAMITEM", 4000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)
...
INSERT INTO A_GWPARAMCONF (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('MTBUFSIZEN', 'MT发送缓冲', 1, 'MT缓冲大小(10-10000)', '5000', '10-10000', 0, 3000);
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT '6CLU1MSGIDFILET' AS "PARAMITEM",'流水号文件频率' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'每隔多少秒产生一个日志文件(单位:秒)' AS "PARAMMEMO", '5' AS "DEFAULTVALUE", '3-3600' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 3000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('6CLU1MSGIDFILET', '流水号文件频率', 1, '每隔多少秒产生一个日志文件(单位:秒)', '5', '3-3600', 0, 3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT '6CLU1MSGIDFILESIZE' AS "PARAMITEM",'流水号文件大小' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'单个流水号操作日志文件大小(单位:M)' AS "PARAMMEMO", '20' AS "DEFAULTVALUE", '1-100' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 3000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('6CLU1MSGIDFILESIZE', '流水号文件大小', 1, '单个流水号操作日志文件大小(单位:M)', '20', '1-100', 0, 3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT '6CLU1CHKPOINT' AS "PARAMITEM",'流水号CheckPoint频率' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'多长时间进行一次checkpoint(单位:小时)' AS "PARAMMEMO", '2' AS "DEFAULTVALUE", '1-24' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 3000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
...
MERGE INTO  A_GWPARAMCONF A USING (SELECT 'MAPSIZE' AS "PARAMITEM",'MAP流水号队列大小' AS "PARAMNAME", 1 AS "PARAMATTRIBUTE",
'MAP流水号队列大小(20000000~80000000，默认为50000000)' AS "PARAMMEMO", '50000000' AS "DEFAULTVALUE", '20000000~80000000' AS "VALUERANGE", 
0 AS "CONTROLTYPE", 3000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, GWTYPE)
VALUES ('MAPSIZE', 'MAP流水号队列大小', 1, 'MAP流水号队列大小(20000000~80000000，默认为50000000)', '50000000', '20000000~80000000', 0, 3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'SENDERRORRPT' AS "PARAMITEM", 3000 AS "GWTYPE" FROM   DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE)
VALUES ('SENDERRORRPT', '是否推送错误rpt给网关',  '是否推送错误rpt给网关 0:不推送，1:推送',1, '0~1','1',0,3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE08STOPINSERTDB' AS "PARAMITEM",3000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
VALUES('FILE08STOPINSERTDB', '暂停数据文件入库',  '暂停数据文件入库(1:暂停文件入库; 0:开启文件入库, 默认为0)属性：高级参数',1, '0,1','0',1,3000);

MERGE INTO  A_GWPARAMCONF A USING (SELECT 'FILE08STOPINSERTDB' AS "PARAMITEM",4000 AS "GWTYPE" FROM  DUAL) B ON (A.PARAMITEM=B.PARAMITEM AND A.GWTYPE=B.GWTYPE)
WHEN NOT MATCHED THEN 
INSERT (PARAMITEM, PARAMNAME,  PARAMMEMO,PARAMATTRIBUTE, VALUERANGE,DEFAULTVALUE,  CONTROLTYPE, GWTYPE) 
...
BEGIN
  ...
  PICURNUM:=0;
    ...
    WHILE PICURNUM<PINUM LOOP--表个数
        ...
        ELSE
          PITABLENAME:='MTDRPT'||CAST(PIYM AS CHAR);
        END IF;
