...
END$
CALL LF_PVERV0('7.3.9.664.SP9','73.09','8.6.5.220','6.1.53.345',1,3) $
DROP PROCEDURE IF EXISTS `LF_PVERV0`$
...
CREATE TABLE IF NOT EXISTS `MT_DATAREPORT` (
  ...
  KEY  `IX_MT_DATAREPORT_UNION` (`USERID`,`TASKID`,`SPGATE`,`IYMD`,`IHOUR`,`SPISUNCM`,`SPID`,`SVRTYPE`,`P1`,`P2`,`P3`,`P4`,`MOBILEAREA`,`SENDTYPE`,`BATCHID`,`AREACODE`),
  KEY `IX_MT_DATAREPORT_TASKID` (`TASKID`),
  KEY `IX_MT_DATAREPORT_TMPLID` (`TMPLID`),
  KEY `IX_MT_DATAREPORT_CHGRADE` (`CHGRADE`),
  KEY `IX_MT_DATAREPORT_MSGTYPE` (`MSGTYPE`),
  KEY `ID` (`ID`),
  KEY `ID_2` (`ID`)
) ENGINE=INNODB DEFAULT CHARSET=GBK$
...
CREATE TABLE IF NOT EXISTS `MT_TASK_C` (
  ...
  `VALIDTM` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0',
  `TMPLID` BIGINT(20) NOT NULL DEFAULT '0',
  `PROTOCOLVER`	TINYINT NOT NULL DEFAULT 0,
  `TITLE`	VARCHAR(40)  NOT NULL DEFAULT '',
  `SHOWAY`	VARCHAR(16)  NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `RPT_WAIT_B` (
  ...
  `EXDATA`	VARCHAR(64)  NOT NULL DEFAULT '',
  `RESENDCNT` TINYINT(3) UNSIGNED NOT NULL DEFAULT '0',
  `RPTTYPE` TINYINT(3) NOT NULL DEFAULT 0,
  PRIMARY KEY  (`ID`),
...
CREATE TABLE IF NOT EXISTS `GW_MT_TASK_BAK` (
  ...
  `DOWNTM`	DATETIME  NOT NULL DEFAULT '0000-00-00 00:00:00',
...
DROP PROCEDURE IF EXISTS `GW_WR_MTTASKBAKV2`$
/*DELIMITER ;;*/
CREATE DEFINER=`root`@`%` PROCEDURE `GW_WR_MTTASKBAKV2`
 (
    PIUID         INT(11),
    PIPTMSGID     BIGINT(20),
    PIECID        INT(11),
