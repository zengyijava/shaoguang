...
insert into LF_CORP_CONF (CC_ID, CORP_CODE, PARAM_KEY, PARAM_VALUE)
values (1, '100001', 'dep.maxlevel', '10');
insert into LF_CORP_CONF (CC_ID, CORP_CODE, PARAM_KEY, PARAM_VALUE)
values (2, '100001', 'dep.maxchild', '100');
insert into LF_CORP_CONF (CC_ID, CORP_CODE, PARAM_KEY, PARAM_VALUE)
values (3, '100001', 'dep.maxdep', '10000');
insert into LF_CORP_CONF (CC_ID, CORP_CODE, PARAM_KEY, PARAM_VALUE)
values (4, '100001', 'dep.maxchargelevel', '5');
commit;
...
insert into OT_LBS_PUSHSET (PUSH_ID, PUSHTYPE, IMGURL, NOTE, RADIUS, AUTORADIUS, PUSHCOUNT, AUTOMORE, CORP_CODE, CREATETIME, MODITYTIME)
values (1, 1, null, null, '2', 2, 3, 2, '100001', to_timestamp('29-09-2015 10:40:01.00000000', 'dd-mm-yyyy hh24:mi:ss.ff'), null);
commit;

insert into OT_SIT_INFO (S_ID, TYPE_ID, NAME, URL, IS_SYSTEM, CORP_CODE, CREATETIME, MODITYTIME)
...
insert into OT_SIT_PAGE (PAGE_ID, S_ID, PAGE_TYPE, NAME, URL, SEQ_NUM, CORP_CODE, CREATETIME, MODITYTIME)
...
insert into OT_SIT_PLANT (PLANT_ID, PLANT_TYPE, PAGE_ID, NAME, FEILD_NAMES, FEILD_VALUES, CORP_CODE, CREATETIME, MODITYTIME, S_ID)
...
insert into OT_SIT_TYPE (TYPE_ID, NAME, IS_DEFAULT, PATTERN, IMG_URL, IMG_URL0, IMG_URL1, IMG_URL2, IMG_URL3, IS_SYSTEM, SEQ_NUM, CORP_CODE, CREATETIME, MODITYTIME)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=44 AND GLOBALKEY='HTTP_REQUEST_TIMEOUT';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE) VALUES (44, 'HTTP_REQUEST_TIMEOUT', 120000, NULL);
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=45 AND GLOBALKEY='HTTP_RESPONSE_TIMEOUT';
  IF COUNTNUM=0 THEN
   INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE) VALUES (45, 'HTTP_RESPONSE_TIMEOUT', 120000, NULL);
   COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=46 AND GLOBALKEY='MBOSS_KEY';
  IF COUNTNUM=0 THEN
   INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE) VALUES (46, 'MBOSS_KEY', NULL, '775047B2F2925858');
   COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=47 AND GLOBALKEY='BALANCE_REQ_INTERVAL';
  IF COUNTNUM=0 THEN
   INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE) VALUES (47, 'BALANCE_REQ_INTERVAL', 300000, NULL);
   COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=48 AND GLOBALKEY='BALANCE_MSG_ENCRYFLAG';
  IF COUNTNUM=0 THEN
   INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE) VALUES (48, 'BALANCE_MSG_ENCRYFLAG', 1, NULL);
   COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=49 AND GLOBALKEY='LOG_PRINT_INTERVAL';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=50 AND GLOBALKEY='BLACK_MAXCOUNT';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_SPFEE' AND COLUMN_NAME='QUERY_TIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_SPFEE ADD QUERY_TIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
WHERE FEEURL IS NOT NULL AND TRIM(FEEURL) IS NOT NULL; 
UPDATE LF_SPFEE SET SPFEE_URL='http://61.145.229.29:8015/mboss/WebService/SubToUnionInterface.asmx?WSDL'
WHERE SPFEE_URL IS NOT NULL AND TRIM(SPFEE_URL) IS NOT NULL;
COMMIT;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=590;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=595;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2800;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2810;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=590 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=590 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=590 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=595 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=595 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=595 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2800 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2800 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2800 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2810 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2810 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2810 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_GLOBAL_VARIABLE' AND CONSTRAINT_NAME='UQ_GKEY';
  IF COUNTNUM=0 THEN
...
ALTER TABLE LF_MTTASK MODIFY MS_TYPE NUMBER(2);
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_GLOBAL_VARIABLE' AND COLUMN_NAME='MEMO';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_GLOBAL_VARIABLE ADD MEMO VARCHAR2(32) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=51 AND GLOBALKEY='TMPEDITORFLAG';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE,MEMO) VALUES (51, 'TMPEDITORFLAG', 0, NULL,'模板可编辑标识'); 
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2160;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2160 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2160 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2160 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2161;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2161 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2161 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2161 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SPROCE' AND COLUMN_NAME='ISDBCONNECT';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SPROCE ADD ISDBCONNECT NUMBER(2) DEFAULT 1 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='DBCONNECTSTATE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD DBCONNECTSTATE NUMBER(2) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_FLOWRECORD' AND COLUMN_NAME='ISREMIND';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_FLOWRECORD ADD ISREMIND NUMBER(2) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_FLOWRECORD' AND COLUMN_NAME='REMINDTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_FLOWRECORD ADD REMINDTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=52 AND GLOBALKEY='CONSECUTIVETIMES';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE,MEMO) VALUES (52, 'CONSECUTIVETIMES', 9, NULL,'连续达到告警阀值次数');
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=53 AND GLOBALKEY='ISCLIENTMONFILE';
  IF COUNTNUM=0 THEN
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_SYS_GLOBAL_VARIABLE';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'DROP TABLE OT_SYS_GLOBAL_VARIABLE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_LBS_PIOS';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_LBS_PIOS RENAME TO LF_LBS_PIOS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_LBS_PIOS';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_LBS_PIOS  TO S_LF_LBS_PIOS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_LBS_PIOS_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_LBS_PIOS_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_LBS_PUSHSET';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_LBS_PUSHSET RENAME TO LF_LBS_PUSHSET'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_LBS_PUSHSET';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_LBS_PUSHSET  TO S_LF_LBS_PUSHSET'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_LBS_PUSHSET_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_LBS_PUSHSET_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_LBS_USERPIOS';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_LBS_USERPIOS RENAME TO LF_LBS_USERPIOS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_LBS_USERPIOS';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_LBS_USERPIOS  TO S_LF_LBS_USERPIOS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_LBS_USERPIOS_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_LBS_USERPIOS_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_GPMEM';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_GPMEM RENAME TO LF_ONL_GPMEM'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_GPMSGID';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_GPMSGID RENAME TO LF_ONL_GPMSGID'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_GROUP';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_GROUP RENAME TO LF_ONL_GROUP'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_MSG';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_MSG RENAME TO LF_ONL_MSG'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_MSG_HIS';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_MSG_HIS RENAME TO LF_ONL_MSG_HIS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_ONL_MSG_HIS';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_ONL_MSG_HIS  TO S_LF_ONL_MSG_HIS'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_ONL_MSG_HIS_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_ONL_MSG_HIS_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_REMARK';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_REMARK RENAME TO LF_ONL_REMARK'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_ONL_SERVER';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_ONL_SERVER RENAME TO LF_ONL_SERVER'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_ONL_SERVER';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_ONL_SERVER  TO S_LF_ONL_SERVER'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_ONL_SERVER_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_ONL_SERVER_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_SIT_INFO';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_SIT_INFO RENAME TO LF_SIT_INFO'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_SIT_PAGE';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_SIT_PAGE RENAME TO LF_SIT_PAGE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_SIT_PLANT';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_SIT_PLANT RENAME TO LF_SIT_PLANT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_SIT_PLANT';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_SIT_PLANT  TO S_LF_SIT_PLANT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_SIT_PLANT_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_SIT_PLANT_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_SIT_TYPE';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_SIT_TYPE RENAME TO LF_SIT_TYPE'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_SIT_TYPE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_SIT_TYPE  TO S_LF_SIT_TYPE'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_SIT_TYPE_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_SIT_TYPE_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_ACCOUNT';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_ACCOUNT RENAME TO LF_WEI_ACCOUNT'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_COUNT';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_COUNT RENAME TO LF_WEI_COUNT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_WEI_COUNT';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_WEI_COUNT  TO S_LF_WEI_COUNT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_WEI_COUNT_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_WEI_COUNT_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_GROUP';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_GROUP RENAME TO LF_WEI_GROUP'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_KEYWORD';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_KEYWORD RENAME TO LF_WEI_KEYWORD'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_MENU';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_MENU RENAME TO LF_WEI_MENU'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_MSG';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_MSG RENAME TO LF_WEI_MSG'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_REVENT';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_REVENT RENAME TO LF_WEI_REVENT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_WEI_REVENT';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_WEI_REVENT  TO S_LF_WEI_REVENT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_WEI_REVENT_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_WEI_REVENT_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_RIMG';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_RIMG RENAME TO LF_WEI_RIMG'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_RTEXT';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_RTEXT RENAME TO LF_WEI_RTEXT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_WEI_RTEXT';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_WEI_RTEXT  TO S_LF_WEI_RTEXT'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_WEI_RTEXT_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_WEI_RTEXT_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_SENDLOG';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_SENDLOG RENAME TO LF_WEI_SENDLOG'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_SEQUENCES WHERE SEQUENCE_NAME='S_OT_WEI_SENDLOG';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'RENAME S_OT_WEI_SENDLOG  TO S_LF_WEI_SENDLOG'; 
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM USER_TRIGGERS WHERE TRIGGER_NAME='TIG_OT_WEI_SENDLOG_QUEUE';
  IF VERSION = 1 THEN
  EXECUTE IMMEDIATE 'DROP TRIGGER TIG_OT_WEI_SENDLOG_QUEUE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_TEMPLATE';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_TEMPLATE RENAME TO LF_WEI_TEMPLATE'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_TLINK';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_TLINK RENAME TO LF_WEI_TLINK'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_ULINK';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_ULINK RENAME TO LF_WEI_ULINK'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_USER2ACC';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_USER2ACC RENAME TO LF_WEI_USER2ACC'; 
  END IF;
END;
/
...
DECLARE
  COUNTSTR INT;
BEGIN
  SELECT COUNT(*) INTO COUNTSTR FROM USER_TABLES WHERE TABLE_NAME='OT_WEI_USERINFO';
  IF COUNTSTR = 1 THEN
  EXECUTE IMMEDIATE 'ALTER TABLE OT_WEI_USERINFO RENAME TO LF_WEI_USERINFO'; 
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=720;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=720 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=720 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=720 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_DEP_USER_BALANCE' AND COLUMN_NAME='MMSALARMEDCOUNT';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_DEP_USER_BALANCE ADD MMSALARMEDCOUNT NUMBER(20) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_CORP_CONF' AND CONSTRAINT_NAME='UQ_PARAMCORP';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_CORP_CONF ADD CONSTRAINT UQ_PARAMCORP UNIQUE(PARAM_KEY,CORP_CODE)';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_SYS_PARAM WHERE PARAM_ITEM='ENDHOUR';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_SYS_PARAM(PARAM_ITEM,PARAM_VALUE,MEMO) VALUES ('ENDHOUR', '6:00', 'EMP汇总结束扫描网关执行状态时间点');
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=763;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=763 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=763 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=763 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=764;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=764 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=764 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=764 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=765;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=765 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=765 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=765 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=767;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=767 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=767 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=767 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=766;
  IF COUNTNUM=0 THEN
   INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=766 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=766 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=766 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_FLOWBINDOBJ' AND COLUMN_NAME='CTSUBDEP';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_DRAFTS' AND CONSTRAINT_NAME='UQ_DRAFTS_MU';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SSPACINFO' AND COLUMN_NAME='LOGIN_TYPE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SSPACINFO ADD LOGIN_TYPE NUMBER(1) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SSPACINFO' AND COLUMN_NAME='OFFLINETHRESHD';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SSPACINFO ADD OFFLINETHRESHD NUMBER(8) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_CORP' AND COLUMN_NAME='CORP_STATE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_CORP ADD CORP_STATE NUMBER(2) DEFAULT 1 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.count';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.combtype';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.upcycle';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.pastalarm';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.errlimit';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_CORP_CONF WHERE PARAM_KEY='pwd.dynpwd';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=54 AND GLOBALKEY='ACTSYNCFLAG';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE,MEMO) VALUES (54, 'ACTSYNCFLAG', 0, NULL, '账户信息同步标识0关闭1开启');
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=55 AND GLOBALKEY='ACTSYNCDBFLAG';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE,MEMO) VALUES (55, 'ACTSYNCDBFLAG', 1, NULL, '账户同步更新数据库标识0关1开');
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=56 AND GLOBALKEY='ACTSYNCURL';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERR' AND COLUMN_NAME='SPOFFLINEPRD';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERR ADD SPOFFLINEPRD VARCHAR2(32) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERRHIS' AND COLUMN_NAME='SPOFFLINEPRD';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERRHIS ADD SPOFFLINEPRD VARCHAR2(32) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='HOSTNAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD HOSTNAME VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='ADAPTER1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD ADAPTER1 VARCHAR2(72) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SERVERNUM VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG1 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG2 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG3 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG4 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG5 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='THRESHOLDFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD THRESHOLDFLAG6 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='HOSTNAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD HOSTNAME VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='PROCENAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD PROCENAME VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='HOSTID';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD HOSTID NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='VERSION';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD VERSION VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SERVERNUM VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='PROCETYPE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD PROCETYPE NUMBER(20) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG1 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG2 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG3 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG4 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG5 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='THRESHOLDFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD THRESHOLDFLAG6 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='HOSTID';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD HOSTID NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SPACCOUNTTYPE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SPACCOUNTTYPE NUMBER(3) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='ACCOUNTNAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD ACCOUNTNAME VARCHAR2(56) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='RPTHAVESND';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD RPTHAVESND NUMBER(20) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SERVERNUM VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='OFFLINEDURATION';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD OFFLINEDURATION NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='NOMTHAVESND';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD NOMTHAVESND NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='LOGINTYPE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD LOGINTYPE NUMBER(2) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='ONLINESTATUSSTR';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD ONLINESTATUSSTR VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SUBMITSTATUSSTR';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SUBMITSTATUSSTR VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG1 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG2 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG3 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG4 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG5 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG6 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG7';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG7 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG8';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG8 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG9';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG9 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG10';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG10 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG11';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG11 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG12';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG12 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='THRESHOLDFLAG13';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD THRESHOLDFLAG13 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='HOSTID';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD HOSTID NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='GATENAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD GATENAME VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SERVERNUM VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG1 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG2 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG3 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG4 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG5 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG6 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG7';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG7 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG8';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG8 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG9';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG9 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG10';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG10 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG11';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG11 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG12';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG12 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='THRESHOLDFLAG13';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD THRESHOLDFLAG13 NUMBER(16) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SPROCE' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SPROCE ADD SERVERNUM VARCHAR2(8) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLCFG' AND COLUMN_NAME='THRESHOLDFLAG';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLCFG ADD THRESHOLDFLAG VARCHAR2(64) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLUSER' AND COLUMN_NAME='DEP_NAME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLUSER ADD DEP_NAME VARCHAR2(64) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLUSER' AND COLUMN_NAME='SESSEION_ID';
  IF COUNTNUM=1 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLUSER MODIFY (SESSEION_ID VARCHAR2(128))';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DHOST' AND CONSTRAINT_NAME='HOSTIDUNIQUE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DPROCE' AND CONSTRAINT_NAME='PROCEIDUNIQUE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DSPACINFO' AND CONSTRAINT_NAME='SPACCIDNIQUE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DGTACINFO' AND CONSTRAINT_NAME='GATEACCUNIQUE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_BUSAREASEND' AND CONSTRAINT_NAME='BUSSENDUNIQUE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_TIMESERCTRL;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_SUMCTRL WHERE NODEID='1001' AND SUMTYPE=0;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_SUMCTRL WHERE NODEID='1001' AND ISMAIN=1 AND SUMTYPE=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLCFG' AND COLUMN_NAME='SERVERNUM';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLCFG ADD SERVERNUM VARCHAR2(8) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2820;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2820 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2820 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2820 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2821;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2821 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2821 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2821 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2822;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2822 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2822 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2822 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SGTACINFO' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SGTACINFO ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SSPACINFO' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SSPACINFO ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SPROCE' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SPROCE ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_BUSBASE' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_BUSBASE ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLCFG' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLCFG ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_SHOST' AND COLUMN_NAME='MONEMAIL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_SHOST ADD MONEMAIL VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG1 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG2 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG3 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG4 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG5 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='SENDMAILFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD SENDMAILFLAG6 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG1 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG2 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG3 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG4 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG5 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='SENDMAILFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD SENDMAILFLAG6 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG1 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG2 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG3 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG4 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG5 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG6 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG7';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG7 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG8';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG8 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG9';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG9 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG10';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG10 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG11';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG11 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG12';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG12 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='SENDMAILFLAG13';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD SENDMAILFLAG13 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG1';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG1 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG2';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG2 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG3';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG3 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG4';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG4 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG5';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG5 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG6';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG6 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG7';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG7 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG8';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG8 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG9';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG9 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG10';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG10 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG11';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG11 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG12';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG12 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='SENDMAILFLAG13';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD SENDMAILFLAG13 NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ONLCFG' AND COLUMN_NAME='SENDMAILFLAG';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ONLCFG ADD SENDMAILFLAG VARCHAR2(64) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_SPOFFCTRL' AND COLUMN_NAME='ALARMEMAILFLAG';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_SPOFFCTRL ADD ALARMEMAILFLAG VARCHAR2(32) DEFAULT ''0'' NOT NULL';
  END IF;
END;
/

--更改配置表长度
ALTER TABLE LF_CORP_CONF MODIFY PARAM_VALUE VARCHAR2(256);
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_THIR_MENUCONTROL WHERE MENU_NUM=16 AND TITLE='系统监控' AND PRI_MENU=80 AND PRI_ORDER=1115;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2162;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2162 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2162 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2162 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2163;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2163 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2163 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2163 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
BEGIN
  ...
  IF VERSION = 0 THEN
  EXECUTE IMMEDIATE '--约束：PROCENODE+PROCETYPE
--（数据库与程序监控信息表）
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DBSTATE' AND CONSTRAINT_NAME='UQ_PNODEPTYPE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERR' AND COLUMN_NAME='PROCENODE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERR ADD PROCENODE NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERR' AND COLUMN_NAME='WEBNODE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERR ADD WEBNODE NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERRHIS' AND COLUMN_NAME='PROCENODE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERRHIS ADD PROCENODE NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_ERRHIS' AND COLUMN_NAME='WEBNODE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_ERRHIS ADD WEBNODE NUMBER(38) DEFAULT 0 NOT NULL';
  END IF;
END;
/
...
DECLARE
  VERSION INT;
BEGIN
  SELECT COUNT(*) INTO VERSION FROM LF_MON_DBOPR;
  IF VERSION <10 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='GATEWAYID';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD GATEWAYID NUMBER(38) DEFAULT 0 NOT NULL';
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_BUSAREASEND' AND COLUMN_NAME='GATEWAYID';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_BUSAREASEND ADD GATEWAYID NUMBER(38) DEFAULT 0 NOT NULL';
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DGTACINFO' AND CONSTRAINT_NAME='FK_LF_DGTACINFO_LF_SGTACINFO';
  IF COUNTNUM=1 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO DROP CONSTRAINT FK_LF_DGTACINFO_LF_SGTACINFO';
  END IF;
END;
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DSPACINFO' AND CONSTRAINT_NAME='FK_LF_DSPACINFO_LF_SSPACINFO';
  IF COUNTNUM=1 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO DROP CONSTRAINT FK_LF_DSPACINFO_LF_SSPACINFO';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='GWNO';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD GWNO NUMBER(38) DEFAULT 0 NOT NULL';
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_HOSTNET' AND CONSTRAINT_NAME='UQ_WNODEPNODE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='IPADDR';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD IPADDR VARCHAR2(256) DEFAULT '' '' NOT NULL';
  END IF;
  COMMIT;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MTTASK' AND COLUMN_NAME='FILEURI';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MTTASK ADD FILEURI VARCHAR2(128) DEFAULT '' '' NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_FILEDATA' AND CONSTRAINT_NAME='UQ_FILEURL';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_FILEDATA ADD CONSTRAINT UQ_FILEURL UNIQUE(FILEURL)';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_CONSTRAINTS WHERE TABLE_NAME = 'LF_MON_DGATEBUF' AND CONSTRAINT_NAME='UQ_ACCGATE';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DBSTATE' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DBSTATE ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_HOSTNET' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_HOSTNET ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DSPACINFO' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DSPACINFO ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DPROCE' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DPROCE ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DHOST' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DHOST ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGTACINFO' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGTACINFO ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MON_DGATEBUF' AND COLUMN_NAME='DBSERVTIME';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MON_DGATEBUF ADD DBSERVTIME TIMESTAMP(8) DEFAULT SYSDATE NOT NULL';
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM USER_TAB_COLS WHERE TABLE_NAME='LF_MTTASK' AND COLUMN_NAME='MSGEDCODETYPE';
  IF COUNTNUM=0 THEN
    EXECUTE IMMEDIATE 'ALTER TABLE LF_MTTASK ADD MSGEDCODETYPE NUMBER(2) DEFAULT 15 NOT NULL';
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=57 AND GLOBALKEY='ADDBLABYMOORDERFLAG';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=58 AND GLOBALKEY='ADDBLAMOMAXID';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=59 AND GLOBALKEY='ADDBLAMOORDER';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=60 AND GLOBALKEY='DELBLAMOORDER';
  IF COUNTNUM=0 THEN
     INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=61 AND GLOBALKEY='BLACKCORPCODE';
  IF COUNTNUM=0 THEN
     INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=62 AND GLOBALKEY='SPTYPEFLAG';
  IF COUNTNUM=0 THEN
     INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_SYS_PARAM WHERE PARAM_ITEM='SPUSER_ISLWR';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_SYS_PARAM(PARAM_ITEM,PARAM_VALUE,MEMO) VALUES ('SPUSER_ISLWR', '0', 'ORACLE DB2 是否支持小写账号 0 不支持  1支持');
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2823;
  IF COUNTNUM=0 THEN
    INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2823 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2823 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2823 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2824;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2824 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2824 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2824 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2825;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2825 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2825 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2825 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2826;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2826 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2826 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2826 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
--通信管理－网关前端配置－SP账号充值/回收-批量充值权限
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_PRIVILEGE WHERE PRIVILEGE_ID=2827;
  IF COUNTNUM=0 THEN
  INSERT INTO LF_PRIVILEGE (PRIVILEGE_ID, RESOURCE_ID, OPERATE_ID, COMMENTS, PRIV_CODE, MENUNAME, MODNAME, MENUCODE, MENUSITE)
  VALUES (2827, 13, null, '批量充值', '1900-1425-4', 'SP账号充值/回收', '网关前端配置', '1900-1425', null);
    COMMIT;
  END IF;
END;
/
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2827 AND ROLE_ID=1;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2827 AND ROLE_ID=2;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_IMPOWER WHERE PRIVILEGE_ID=2827 AND ROLE_ID=4;
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=63 AND GLOBALKEY='EXCEEDMEMORYTIME';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=64 AND GLOBALKEY='MEMORYPERCENTAGE';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=65 AND GLOBALKEY='BALANCEBAKURL';
  IF COUNTNUM=0 THEN
    INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=66 AND GLOBALKEY='READDATASAVETIME';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=67 AND GLOBALKEY='USEHISTORYDBTIME';
  IF COUNTNUM=0 THEN
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=68 AND GLOBALKEY='MOTDCOUNT';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=69 AND GLOBALKEY='USESERVERURLFLAG';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=70 AND GLOBALKEY='SERVERURL';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO) 
...
DECLARE COUNTNUM INT;
BEGIN
  SELECT COUNT(*) INTO COUNTNUM FROM LF_GLOBAL_VARIABLE WHERE GLOBALID=71 AND GLOBALKEY='TEMP_CODE';
  IF COUNTNUM=0 THEN
      INSERT INTO LF_GLOBAL_VARIABLE (GLOBALID, GLOBALKEY, GLOBALVALUE, GLOBALSTRVALUE, MEMO)
...
BEGIN
    ...
    ELSE
      UPDATE LF_VERSION SET UPDATETIME=SYSDATE,VERSION=VERSIONSTR WHERE VERSION=VERSIONSTR AND PRODUCT_ID=1000 AND PROCESS_ID=1000;
    END IF;
    COMMIT;
    ...
    ELSE
      UPDATE LF_VERSION SET UPDATETIME=SYSDATE,VERSION=WBSVERSIONSTR WHERE VERSION=WBSVERSIONSTR AND PRODUCT_ID=1000 AND PROCESS_ID=2000;
    END IF;
    COMMIT;
    ...
    ELSE
      UPDATE LF_VERSION SET UPDATETIME=SYSDATE,VERSION=SPGATEVERSIONSTR WHERE VERSION=SPGATEVERSIONSTR AND PRODUCT_ID=1000 AND PROCESS_ID=3000;
    END IF;
    COMMIT;
    --EMP产品版本历史记录
    ...
    IF COUNTNUM=0 THEN
      ...
      VALUES(1000,1000,VERSIONSTR,SYSDATE,SYSDATE,'EMP-WEB',1,'1、EMP多语言支持<br />');
    ELSE
      UPDATE LF_VERSION_HIS SET UPDATETIME=SYSDATE,ISRELEASE=1,VERSIONINFO='1、EMP多语言支持<br />' WHERE VERSION=VERSIONSTR AND PRODUCT_ID=1000 AND PROCESS_ID=1000;
    END IF;
    COMMIT;
