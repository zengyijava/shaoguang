...
BEGIN ATOMIC 
IF EXISTS (SELECT TABNAME FROM SYSCAT.TABLES WHERE TABNAME='LF_VERSION') THEN
...
CREATE PROCEDURE "DROPTABLE"
BEGIN ATOMIC 
IF EXISTS (SELECT TABNAME FROM SYSCAT.TABLES WHERE TABNAME='LF_VERSION_HIS') THEN
  DROP TABLE LF_VERSION_HIS;
END IF;
END ;
CALL DROPTABLE;
DROP PROCEDURE DROPTABLE;
...
CREATE PROCEDURE "DROPTABLE"
BEGIN ATOMIC 
IF EXISTS (SELECT TABNAME FROM SYSCAT.TABLES WHERE TABNAME='LF_DB_SCRIPT') THEN
  DROP TABLE LF_DB_SCRIPT;
END IF;
END ;
CALL DROPTABLE;
DROP PROCEDURE DROPTABLE;
...
CREATE TABLE "AGENTACCOUNT"
 ("LOGINID"        CHARACTER(11)   NOT NULL  DEFAULT '',
...
CREATE TABLE "A_PROTOCOLTMPL"
 ("PROTOCOLCODE"  INTEGER         NOT NULL  DEFAULT 40,
...
ALTER TABLE "KEYWORD_BLACK"
ADD CONSTRAINT "PK_KEYWORD_BLACK" PRIMARY KEY
   ("KEYWORD"
   );
...
COMMENT ON TABLE "PB_SERVICETYPE"
  IS '运营商号段表';
...
CREATE TABLE "PROCESSINGSTATUS"
 ("USEID"           INTEGER  NOT NULL  DEFAULT 0,
...
ALTER TABLE  "MMS_TEMPLATE"  ADD CONSTRAINT  "MMS_TEMPLATE_PK"  PRIMARY KEY
( "ID" 
);

CREATE INDEX "IX_MTEMP_TMPLID"
  ON "MMS_TEMPLATE"
 ("TMPLID" ASC
 )
  PCTFREE 10
...
ALTER TABLE "MMS_BMTREQ" ADD CONSTRAINT "MMS_BMTREQ_PRIMARY" PRIMARY KEY 
(
	"ID"
);
CREATE INDEX "IX_MBMT_MSGID" ON "MMS_BMTREQ" 
(
	"MSGID" ASC
);
CREATE   INDEX "IX_MBMT_BMTMSGID" ON "MMS_BMTREQ" 
(
	"BMTMSGID" ASC
);
CREATE  INDEX "IX_MBMT_USERID" ON "MMS_BMTREQ" 
(
	"USERID" ASC
);
...
ALTER TABLE "MMS_BMTREQHIS" ADD CONSTRAINT "MMS_BMTREQHIS_PK" PRIMARY KEY
(
	"ID"
);
CREATE  INDEX "IX_MBMTH_MSGID" ON "MMS_BMTREQHIS" 
(
	"MSGID" ASC
);
CREATE INDEX "IX_MBMTH_BMTMSGID" ON "MMS_BMTREQHIS" 
(
	"BMTMSGID" ASC
);
CREATE  INDEX "IX_MBMTH_USERID" ON "MMS_BMTREQHIS"
(
	"USERID" ASC
);
...
DATA CAPTURE NONE
 ...
 ALTER TABLE "MMS_LEVEL_QUEUE"
  ...
  NOT VOLATILE
  LOG INDEX BUILD NULL;
ALTER TABLE "MMS_LEVEL_QUEUE" ADD CONSTRAINT "MMS_LEVEL_QUEUE_PK" PRIMARY KEY 
(
	"ID" 
);
CREATE INDEX "IX_MLEV_PTMSGID" ON "MMS_LEVEL_QUEUE" 
(
	"PTMSGID" ASC
);
CREATE INDEX "IX_MLEV_SPGATE" ON "MMS_LEVEL_QUEUE" 
(
	"SPGATE" ASC
);
CREATE INDEX "IX_MLEV_USERID" ON "MMS_LEVEL_QUEUE" 
(
	"USERID" ASC  
);
CREATE INDEX "IX_MLEV_SENDTIME" ON "MMS_LEVEL_QUEUE" 
(
	"SENDTIME" ASC
);
...
ALTER TABLE "MMS_TASK" ADD CONSTRAINT "MMS_TASK_PRIMARY" PRIMARY KEY 
(
	"ID"
);
CREATE INDEX "IX_MT_PTMSGID" ON "MMS_TASK" 
(
	"PTMSGID" ASC
);
...
ALTER TABLE "MMS_RPT" ADD CONSTRAINT "MMS_RPT_PRIMARY" PRIMARY KEY
(
	"ID"
);
CREATE INDEX "IX_MMS_RPT_UID" ON "MMS_RPT"
(
	"UID" ASC
);
CREATE INDEX "IX_MMS_RPT_PTMSGID" ON "MMS_RPT" 
(
	"PTMSGID" ASC
);
CREATE INDEX "IX_MMS_RPT_USERID" ON "MMS_RPT" 
(
	"USERID" ASC
);
CREATE INDEX "IX_MMS_RPT_SPMSGID" ON "MMS_RPT" 
(
	"SPMSGID" ASC
);
CREATE INDEX "IX_MRPT_SPMSGID2" ON "MMS_RPT" 
(
	"SPMSGID2" ASC
);
...
ALTER TABLE "MMS_MO" ADD CONSTRAINT "MMS_MO_PRIMARY" PRIMARY KEY
(
	"ID"
);

CREATE  INDEX "IX_MMS_MO_UID" ON "MMS_MO" 
(
	"UID" ASC
);
CREATE INDEX "IX_MMS_MO_PTMSGID" ON "MMS_MO" 
(
	"PTMSGID" ASC
);
CREATE INDEX "IX_MMS_MO_USERID" ON "MMS_MO" 
(
	"USERID" ASC
);
...
ALTER TABLE "MMS_DATAREPORT" ADD CONSTRAINT "MMS_DATAREPORT_PK" PRIMARY KEY
(
	"USERID",	
    "TASKID",
    "SPGATE",	
...
ALTER TABLE "MMS_MODATAREPORT" ADD  CONSTRAINT "MMS_MODT_PK" PRIMARY KEY
(
	"USERID",
	"SPGATE",
	"SPISUNCM",
...
ALTER TABLE "AGENTACCOUNT"
  ADD CONSTRAINT "PK_AGENTACCOUNT" PRIMARY KEY
   ("LOGINID"
   );

ALTER TABLE "ATTIME_TASK"
  ADD CONSTRAINT "PK_ATTIMETASK" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "A_CHANNELMAP"
  ADD CONSTRAINT "IX_A_CHMAP_CPNO" UNIQUE
   ("CPNO"
   );
...
ALTER TABLE "A_CMDQUE"
  ADD CONSTRAINT "PK_A_CMDQUE" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE "A_GWLOGS"
  ADD CONSTRAINT "PK_A_GWLOGS" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE "A_PROINFO"
  ADD CONSTRAINT "PK_A_PROINFO" PRIMARY KEY
   ("SERIALNUM"
   );
...
ALTER TABLE "BATCH_MT_REQ"
  ADD CONSTRAINT "PK_BAT_MT_REQ" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE "KF_CORPBASE"
  ADD CONSTRAINT "PK_KF_CORPBASE" PRIMARY KEY
   ("ECID"
   );

ALTER TABLE "KF_PARAMS"
  ADD CONSTRAINT "PK_KF_PARAMS" PRIMARY KEY
   ("PARACODE"
   );

ALTER TABLE "MMS_PTMSGID_SEQ"
  ADD CONSTRAINT "PK_MMS_PTMSGID" PRIMARY KEY
   ("PTMSGID"
   );

ALTER TABLE "MMS_SEND_HISTORY"
  ADD CONSTRAINT "PK_MMS_SND_HIS" PRIMARY KEY
   ("PTMSGID"
   );

ALTER TABLE "MMS_SEND_TASK"
  ADD CONSTRAINT "PK_MT_TASK_PTMSGID" PRIMARY KEY
   ("PTMSGID"
   );
...
ALTER TABLE "MO_TASK"
  ADD CONSTRAINT "PK_MO_TASK" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MO_TASK_HIS"
  ADD CONSTRAINT "PK_MOTASK_HIS" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MO_WAIT_A"
  ADD CONSTRAINT "PK_MO_WAIT_A" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MO_WAIT_C"
  ADD CONSTRAINT "PK_MO_WAIT_C" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_DATAREPORT"
  ADD CONSTRAINT "PK_MT_DATAREPORT" PRIMARY KEY
   ("USERID",
    "TASKID",
    "SPGATE",
    "IYMD",
...
ALTER TABLE "MT_LEVEL0_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL0_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL1_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL1_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL2_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL2_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL3_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL3_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL4_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL4_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL5_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL5_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL6_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL6_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL7_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL7_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL8_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL8_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_LEVEL9_QUEUE"
  ADD CONSTRAINT "PK_MT_LVL9_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_ROUTETABLE"
  ADD CONSTRAINT "PK_MT_ROUTE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_TASK"
  ADD CONSTRAINT "PK_MTTASK" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_TASK_C"
  ADD CONSTRAINT "PK_MT_TASK_C" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_TIMER_QUEUE"
  ADD CONSTRAINT "PK_MT_TMR_QUE" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_VERIFY_TASK"
  ADD CONSTRAINT "PK_MT_VFY_TASK" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_VERIFY_WAIT"
  ADD CONSTRAINT "PK_MT_VFY_WAIT" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "MT_WAIT_A"
  ADD CONSTRAINT "PK_MT_WAIT_A" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "M_MON_BUFINFO"
  ADD CONSTRAINT "PK_M_MON_BUFINFO" PRIMARY KEY
   ("PTCODE"
   );

ALTER TABLE "M_MON_LOGINFO"
  ADD CONSTRAINT "PK_M_MON_LOGINFO" PRIMARY KEY
   ("PTCODE"
   );

ALTER TABLE "M_MON_MONLOG"
  ADD CONSTRAINT "PK_M_MON_MONLOG" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "M_MON_MONMSG"
  ADD CONSTRAINT "PK_M_MON_MONMSG" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "M_MON_PTINFO"
  ADD CONSTRAINT "PK_M_MON_PTINFO" PRIMARY KEY
   ("PTCODE"
   );

ALTER TABLE "M_MON_SPGATEINFO"
  ADD CONSTRAINT "PK_MON_SPGATEINFO" PRIMARY KEY
   ("PTCODE",
    "USERID"
   );

ALTER TABLE "M_MON_THREADINFO"
  ADD CONSTRAINT "PK_MON_THREADINFO" PRIMARY KEY
   ("THRID"
   );
...
ALTER TABLE "PB_LIST_BLACK"
  ADD CONSTRAINT "PK_PB_LIST_BLACK" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "PB_SERVICETYPE"
  ADD CONSTRAINT "PK_PBSVRTYPE" PRIMARY KEY
   ("SPISUNCM"
   );
...
ALTER TABLE "PROCESSINGSTATUS"
  ADD CONSTRAINT "PK_PROCESSSTS" PRIMARY KEY
   ("USEID"
   );

ALTER TABLE "RPT_WAIT_A"
  ADD CONSTRAINT "PK_RPT_WAIT_A" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "RPT_WAIT_B"
  ADD CONSTRAINT "PK_RPT_WAIT_B" PRIMARY KEY
   ("ID"
   );

ALTER TABLE "RPT_WAIT_C"
  ADD CONSTRAINT "PK_RPT_WAIT_C" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE "USERFEE"
  ADD CONSTRAINT "PK_USERFEE" PRIMARY KEY
   ("UID"
   );

ALTER TABLE "XT_GATE_QUEUE"
  ADD CONSTRAINT "PK_XT_GATE_QUE" PRIMARY KEY
   ("ID"
   );
...
--  JUN-24-2012 AT 17:27:38

CREATE INDEX "IX_ATTMTASK"
  ON "ATTIME_TASK"
 ("LOGINID" ASC,
  "TASKID"  ASC,
  "BMTMSGID" ASC
...
CREATE UNIQUE INDEX "IX_A_CHMAP_CPNO"
  ON "A_CHANNELMAP"
 ("CPNO" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_A_CHMAP_SPNO"
  ON "A_CHANNELMAP"
 ("SPNUMBER" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_BATMTREQ_BMTMSGID"
  ON "BATCH_MT_REQ"
 ("BMTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATMTREQ_LGNID"
  ON "BATCH_MT_REQ"
 ("LOGINID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATMTREQ_MSGID"
  ON "BATCH_MT_REQ"
 ("MSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATMTREQ_SDSTS"
  ON "BATCH_MT_REQ"
 ("SENDSTATUS" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATMTREQ_TASKID"
  ON "BATCH_MT_REQ"
 ("TASKID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATMTREQ_USRID"
  ON "BATCH_MT_REQ"
 ("USERID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MOTASK_PTID"
  ON "MO_TASK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MOWAITC_PTID"
  ON "MO_WAIT_C"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MOWAITC_SPGATE"
  ON "MO_WAIT_C"
 ("SPGATE" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL0_DESTUID"
  ON "MT_LEVEL0_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL0_PTID"
  ON "MT_LEVEL0_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL1_DESTUID"
  ON "MT_LEVEL1_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL1_PTID"
  ON "MT_LEVEL1_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL2_DESTUID"
  ON "MT_LEVEL2_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL2_PTID"
  ON "MT_LEVEL2_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL3_DESTUID"
  ON "MT_LEVEL3_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL3_PTID"
  ON "MT_LEVEL3_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL4_DESTUID"
  ON "MT_LEVEL4_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL4_PTID"
  ON "MT_LEVEL4_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL5_DESTUID"
  ON "MT_LEVEL5_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL5_PTID"
  ON "MT_LEVEL5_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL6_DESTUID"
  ON "MT_LEVEL6_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL6_PTID"
  ON "MT_LEVEL6_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL7_DESTUID"
  ON "MT_LEVEL7_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL7_PTID"
  ON "MT_LEVEL7_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL8_DESTUID"
  ON "MT_LEVEL8_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL8_PTID"
  ON "MT_LEVEL8_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTLVL9_DESTUID"
  ON "MT_LEVEL9_QUEUE"
 ("DESTUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTLVL9_PTID"
  ON "MT_LEVEL9_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTTASKC_PTID"
  ON "MT_TASK_C"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTTASK_PTID"
  ON "MT_TASK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTTMR_PTID"
  ON "MT_TIMER_QUEUE"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTVFY_PTID"
  ON "MT_VERIFY_WAIT"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTWAITA_LGNUID"
  ON "MT_WAIT_A"
 ("LOGINUID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "IX_MTWAITA_PTID"
  ON "MT_WAIT_A"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_MTWAITA_UIDSTS"
  ON "MT_WAIT_A"
 ("USERUID"    ASC,
  "SENDSTATUS" ASC
 )
...
CREATE INDEX "IX_RPTWAITB_ORGUID"
  ON "RPT_WAIT_B"
 ("ORGUID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_RPTWAITC_LGNID"
  ON "RPT_WAIT_C"
 ("LOGINID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_AGENTACCOUNT"
  ON "AGENTACCOUNT"
 ("LOGINID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_ATTIMETASK"
  ON "ATTIME_TASK"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_A_CMDQUE"
  ON "A_CMDQUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_A_GWACCOUNT"
  ON "A_GWACCOUNT"
 ("GWNO"     ASC,
  "PTACCUID" ASC
 )
...
CREATE UNIQUE INDEX "PK_A_GWLOGS"
  ON "A_GWLOGS"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_A_GWPARAMCONF"
  ON "A_GWPARAMCONF"
 ("GWTYPE"    ASC,
  "PARAMITEM" ASC
 )
...
CREATE UNIQUE INDEX "PK_A_GWPARAMVALUE"
  ON "A_GWPARAMVALUE"
 ("GWNO"      ASC,
  "GWTYPE"    ASC,
  "PARAMITEM" ASC
...
CREATE UNIQUE INDEX "PK_A_PROINFO"
  ON "A_PROINFO"
 ("SERIALNUM" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_A_PROTOCOLTMPL"
  ON "A_PROTOCOLTMPL"
 ("PROTOCOLCODE" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_BAT_MT_REQ"
  ON "BATCH_MT_REQ"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE INDEX "IX_BATHIS_BATCHID" 
  ON "BATCH_MT_REQ_HIS"              
 ("BATCHID" ASC                  
 )                          
  PCTFREE 10                
...
CREATE INDEX "IX_BATHIS_RECVTIME" 
  ON "BATCH_MT_REQ_HIS"              
 ("RECVTIME" ASC                  
 )                          
  PCTFREE 10                
...
CREATE UNIQUE INDEX "PK_CZ_QUEUE_KEY"
...
CREATE UNIQUE INDEX "PK_GT_PORT_USED"
  ON "GT_PORT_USED"
 ("SPGATE" ASC,
	"CPNO" ASC,
	"SPISUNCM" ASC,
...
CREATE UNIQUE INDEX "PK_KEYWORD_BLACK"
  ON "KEYWORD_BLACK"
 ("KEYWORD" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_KF_CORPBASE"
  ON "KF_CORPBASE"
 ("ECID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_KF_PARAMS"
  ON "KF_PARAMS"
 ("PARACODE" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MMS_PTMSGID"
  ON "MMS_PTMSGID_SEQ"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MMS_SND_HIS"
  ON "MMS_SEND_HISTORY"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MON_SPGATEINFO"
  ON "M_MON_SPGATEINFO"
 ("PTCODE" ASC,
  "USERID" ASC
 )
...
CREATE UNIQUE INDEX "PK_MON_THREADINFO"
  ON "M_MON_THREADINFO"
 ("THRID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MON_USERINFO"
  ON "M_MON_USERINFO"
 ("PTCODE" ASC,
  "USERID" ASC
 )
...
CREATE UNIQUE INDEX "PK_MOTASK_HIS"
  ON "MO_TASK_HIS"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MO_DATAREPORT"
  ON "MO_DATAREPORT"
 ("USERID"   ASC,
  "SPGATE"   ASC,
  "SPISUNCM" ASC,
...
CREATE UNIQUE INDEX "PK_MO_TASK"
  ON "MO_TASK"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MO_WAIT_A"
  ON "MO_WAIT_A"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MO_WAIT_C"
  ON "MO_WAIT_C"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MTDATAREPORT_SP"
  ON "MT_DATAREPORT_SP"
 ("IYMD"     ASC,
  "USERID"   ASC,
  "SPGATE"   ASC,
...
CREATE UNIQUE INDEX "PK_MT_DATAREPORT"
  ON "MT_DATAREPORT"
 ("USERID",
    "TASKID",
    "SPGATE",
...
CREATE UNIQUE INDEX "PK_MT_LVL2_QUE"
  ON "MT_LEVEL2_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL3_QUE"
  ON "MT_LEVEL3_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL4_QUE"
  ON "MT_LEVEL4_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL5_QUE"
  ON "MT_LEVEL5_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL6_QUE"
  ON "MT_LEVEL6_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL7_QUE"
  ON "MT_LEVEL7_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL8_QUE"
  ON "MT_LEVEL8_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_LVL9_QUE"
  ON "MT_LEVEL9_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_ROUTE"
  ON "MT_ROUTETABLE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_TASK_C"
  ON "MT_TASK_C"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_TASK_PTMSGID"
  ON "MMS_SEND_TASK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_TMR_QUE"
  ON "MT_TIMER_QUEUE"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_VFY_TASK"
  ON "MT_VERIFY_TASK"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_VFY_WAIT"
  ON "MT_VERIFY_WAIT"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_MT_WAIT_A"
  ON "MT_WAIT_A"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_M_MON_BUFINFO"
  ON "M_MON_BUFINFO"
 ("PTCODE" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_M_MON_LOGINFO"
  ON "M_MON_LOGINFO"
 ("PTCODE" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_M_MON_MONLOG"
  ON "M_MON_MONLOG"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_M_MON_MONMSG"
  ON "M_MON_MONMSG"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_M_MON_PTINFO"
  ON "M_MON_PTINFO"
 ("PTCODE" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_PBSVRTYPE"
  ON "PB_SERVICETYPE"
 ("SPISUNCM" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_PROCESSSTS"
  ON "PROCESSINGSTATUS"
 ("USEID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_RPT_WAIT_A"
  ON "RPT_WAIT_A"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_RPT_WAIT_B"
  ON "RPT_WAIT_B"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_RPT_WAIT_C"
  ON "RPT_WAIT_C"
 ("ID" ASC
 )
  PCTFREE 10
...
CREATE UNIQUE INDEX "PK_USERDATA"
  ON "USERDATA"
 ("ACCOUNTTYPE" ASC,
	"USERID" ASC
 )
  PCTFREE 10
  ALLOW REVERSE SCANS;
CREATE  INDEX "IX_USERDATA_USERID"
  ON "USERDATA"
 (
	"USERID" ASC
 )
...
CREATE UNIQUE INDEX "PK_USERFEE"
  ON "USERFEE"
 ("UID" ASC
 )
  PCTFREE 10
...
CREATE  INDEX "IX_USERFEE_USERID"
  ON "USERFEE"
 ("USERID" ASC
 )
  PCTFREE 10
...
ALTER TABLE "A_CMD_ROUTE" ADD CONSTRAINT "PK_A_CMD_ROUTE" PRIMARY KEY 
(
  "ID"
);

CREATE INDEX "IX_STRUCTCODE" ON "A_CMD_ROUTE" 
(
	"STRUCTCODE" ASC
);
...
ALTER TABLE "A_CMD_PORT" ADD CONSTRAINT "PK_A_CMD_PORT" PRIMARY KEY 
(
  "ID"
);

CREATE UNIQUE INDEX "IX_A_CMD_PORT" ON "A_CMD_PORT" 
(
	"GATEID" ASC,
	"CMDID" ASC,
	"CPNO" ASC
...
ALTER TABLE  "A_SMSFWDCONF"  ADD CONSTRAINT  "A_SMSFWDCONF_PK"  PRIMARY KEY
( "PROTOCOLCODE" 
);
...
ALTER TABLE  "GW_MT_TASK_BAK"
 ...
 ALTER TABLE  "GW_MT_TASK_BAK"
  ADD CONSTRAINT "GW_MTTASKBAK_PK" PRIMARY KEY
   ("ID"
   );
   
CREATE UNIQUE INDEX  "IX_PTMSGID_TASK"
  ON  "GW_MT_TASK_BAK"
 ("PTMSGID" ASC
 )
  CLUSTER
...
CREATE INDEX  "IX_GW_MT_TASK_P1"
 ...
 CREATE INDEX  "IX_GW_MT_TASK_SENDTIME"
  ON  "GW_MT_TASK_BAK"
 ("SENDTIME" ASC
 )
  PCTFREE 10
  ...
  CREATE INDEX  "IX_GW_MT_TASK_SVRTYPE"
  ON  "GW_MT_TASK_BAK"
 ("SVRTYPE" ASC
 )
  PCTFREE 10
  ...
  CREATE INDEX  "IX_GW_MT_TASK_TASKID"
  ON  "GW_MT_TASK_BAK"
 ("TASKID" ASC
 )
  PCTFREE 10
  DISALLOW REVERSE SCANS;
     ...
     CREATE INDEX  "IX_GW_MT_TASK_USERID"
  ON  "GW_MT_TASK_BAK"
 ("USERID" ASC
 )
  PCTFREE 10
...
CREATE  INDEX  "IX_PTMSGID_TASKERR"
  ON  "GW_MT_TASK_ERR"
 ("PTMSGID" ASC
 )
  CLUSTER
 ...
 CREATE INDEX  "IX_TASKERR_SENDTIM"
  ON  "GW_MT_TASK_ERR"
 ("SENDTIME" ASC
 )
  PCTFREE 10
...
CREATE TABLE "GW_MTSDOK"
 ...
 ALTER TABLE  "GW_MTSDOK"
  ADD CONSTRAINT "GW_MTSDOK_PK" PRIMARY KEY
   ("ID"
   );
CREATE INDEX  "IX_GWMTSDOK_PTMSGID"
  ON  "GW_MTSDOK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
 ...
 CREATE INDEX  "IDX_GWMTSDOK_SPGATESE"
  ON  "GW_MTSDOK"
 ("SPGATESEND" ASC
 )
  PCTFREE 10
 ...
 CREATE INDEX  "IDX_GWMTSDOK_SENDRES"
  ON  "GW_MTSDOK"
 ("SENDRESULT" ASC
 )
  PCTFREE 10
 ...
 CREATE INDEX  "IDX_GWMTSDOK_INTIME"
  ON  "GW_MTSDOK"
 ("IN_TIME" DESC
 )
  PCTFREE 10
...
ALTER TABLE  "GW_MTSDOK_ERR"
 ...
 ALTER TABLE  "GW_MTSDOK_ERR"
  ADD CONSTRAINT "GW_MTSDOKERR_PK" PRIMARY KEY
   ("ID"
   );
CREATE INDEX  "IX_PTMSGID_MTSDOKERR"
  ON  "GW_MTSDOK_ERR"
 ("PTMSGID" ASC
 )
  CLUSTER
  PCTFREE 10
  DISALLOW REVERSE SCANS;
CREATE INDEX  "IDX_GWMTSDOKERR_INTIME"
  ON  "GW_MTSDOK_ERR"
 ("IN_TIME" DESC
 )
  PCTFREE 10
...
ALTER TABLE  "GW_RPTRVOK"
  ...
  CREATE INDEX  "IX_PTMSGID_GWRPTRVOK"
  ON  "GW_RPTRVOK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
 ...
 ALTER TABLE  "GW_RPTRVOK"
  ADD CONSTRAINT "GW_RPTRVOK_PK" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE  "GW_RPTRVOK_ERR"
  ...
  LOG INDEX BUILD NULL;
 ALTER TABLE  "GW_RPTRVOK_ERR"
  ADD CONSTRAINT "GW_RPTRVOKERR_PK" PRIMARY KEY
   ("ID"
   );
CREATE INDEX  "IX_PTMSGID_RPTRVOKERR"
  ON  "GW_RPTRVOK_ERR"
 ("PTMSGID" ASC
 )
  CLUSTER
...
ALTER TABLE  "GW_RPTSDOK"
 ...
 CREATE INDEX  "IX_PTMSGID_GWRPTSDOK"
  ON  "GW_RPTSDOK"
 ("PTMSGID" ASC
 )
  PCTFREE 10
 ...
 ALTER TABLE  "GW_RPTSDOK"
  ADD CONSTRAINT "GW_RPTSDOK_PK" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE  "GW_RPTSDOK_ERR"
  ...
  LOG INDEX BUILD NULL; 
   ...
   ALTER TABLE  "GW_RPTSDOK_ERR"
  ADD CONSTRAINT "GW_RPTSDOKERR_PK" PRIMARY KEY
   ("ID"
   );
   
  CREATE INDEX  "IX_PTMSGID_RPTSDOKERR"
  ON  "GW_RPTSDOK_ERR"
 ("PTMSGID" ASC
 )
  CLUSTER
...
ALTER TABLE  "GW_TRAN_DEL_LOG"
 ...
 CREATE UNIQUE INDEX  "IX_ID_TRAN"
  ON  "GW_TRAN_DEL_LOG"
 ("ID" ASC
 )
  CLUSTER
...
ALTER TABLE "A_MOBILEAREA" ADD CONSTRAINT  "A_MOBILEAREA_PK"  PRIMARY KEY("ID");

CREATE UNIQUE INDEX "IX_A_MOBILEAREA" ON "A_MOBILEAREA"
 ("MOBILE" ASC
 )
  PCTFREE 10
  ALLOW REVERSE SCANS;
...
ALTER TABLE A_IPCOMINFO ADD CONSTRAINT PK_IPCOM PRIMARY KEY (GATEID);
...
ALTER TABLE A_SIMINFO ADD CONSTRAINT PK_ASIM PRIMARY KEY (ID);
...
ALTER TABLE A_MNP ADD CONSTRAINT PK_AMNP PRIMARY KEY (ID);
...
ALTER TABLE A_MNPERRCODE ADD  CONSTRAINT PK_MNPERRCODE PRIMARY KEY(ERRORCODE);
...
ALTER TABLE A_SPE_PHONE ADD CONSTRAINT PK_SPE_PHONE PRIMARY KEY (ID); 
...
CREATE INDEX IX_GWRUT_GATEID ON A_GWROUTE(GATEID);
 ...
 CREATE TABLE  "GW_CLUSPBIND"
 ("ID"       INTEGER     NOT NULL  GENERATED BY DEFAULT
    AS IDENTITY (START WITH 1, INCREMENT BY 1, CACHE 20, MINVALUE 1, NO CYCLE, NO ORDER),
  "PTACCUID"  INTEGER   NOT NULL DEFAULT 0,
...
ALTER TABLE  "GW_CLUSPBIND"
  ADD CONSTRAINT "GW_CLUSPBIND_PK" PRIMARY KEY
   ("ID"
   );
  CREATE TABLE  "GW_CLUSTATUS"
 ("ID"       INTEGER     NOT NULL  GENERATED BY DEFAULT
    AS IDENTITY (START WITH 1, INCREMENT BY 1, CACHE 20, MINVALUE 1,  NO CYCLE, NO ORDER),
 ...
 IN "TBSPMTTASKDATA"
 INDEX IN "TBSPMTTASKINDEX";
ALTER TABLE  "GW_CLUSTATUS"
  ADD CONSTRAINT "GW_CLUSTATUS_PK" PRIMARY KEY
   ("ID"
   );

CREATE  INDEX "IX_GWCLUS_TYPENO" ON "GW_CLUSTATUS"
 (GWTYPE ASC,GWNO ASC
 )
  PCTFREE 10
  ALLOW REVERSE SCANS;
...
CREATE TABLE  "GW_CLUDECISION"
 ...
 IN "TBSPMTTASKDATA"
 INDEX IN "TBSPMTTASKINDEX";
ALTER TABLE  "GW_CLUDECISION"
  ADD CONSTRAINT "GW_CLUDECISION_PK" PRIMARY KEY
   ("ID"
   );
CREATE  INDEX "IX_GWDECI_TYPENO" ON "GW_CLUDECISION"
 (GWTYPE ASC,GWNO ASC
 )
  PCTFREE 10
  ALLOW REVERSE SCANS;
...
ALTER TABLE  "GW_DBMONITOR"
ADD CONSTRAINT "GW_DBMONITOR_PK" PRIMARY KEY
("ID" );


CREATE PROCEDURE "DELPROC"
 (IN "PROCNAME1" VARCHAR(20)
 ) 
BEGIN
...
CREATE PROCEDURE GW_CPROTOMTCH()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_CUSERPROPERTY()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_CPUSHPROTOMTCH()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_CMULTI_ENTERP()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_CBASEPROTOCOL()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_CPUSHRSPROTOCOL()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE GW_GATECONNINFO()
BEGIN
DECLARE PISQL VARCHAR(6000);
DECLARE PISQL_1 VARCHAR(256);
...
CREATE PROCEDURE "A_LOADUSRBIND"
	(
...
CREATE PROCEDURE "A_LOADALLBIND" ( 
IN PISPTYPE INT--=1
) 
...
CREATE PROCEDURE A_LOADGWROUTE(IN PISPTYPE INT)
...
CREATE PROCEDURE "S_RD_RPTWAITA"
...
CREATE PROCEDURE "S_RD_RPTWAITB"
 (IN "PIUID" INTEGER, 
  IN "PIMAXREADCNT" INTEGER
 ) 
...
CREATE PROCEDURE "S_WR_RPTWAITA"
 (IN "PIECID" INTEGER, 
  IN "PIUSERUID" INTEGER, 
  IN "PILOGINUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
...
CREATE PROCEDURE "S_WR_RPTWAITB"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIECID" INTEGER, 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "A_LOADFORWARDBIND" () 
...
CREATE FUNCTION "REBIND_PACKAGE" ()
...
CREATE FUNCTION "BUILDINSERTSQL"
...
CREATE FUNCTION "BUILDUPDATESQL"
 ("STRTABLE" VARCHAR(128),
  "FEILDS" VARCHAR(2048),
  "STRVALUES" VARCHAR(4096),
...
CREATE FUNCTION "GETARRAYLENGTH"
 ("STR" VARCHAR(8000),
  "SPLIT" VARCHAR(10)
 ) 
  RETURNS BIGINT
...
CREATE FUNCTION "GETARRAYSTROFINDEX"
 ("STR" VARCHAR(8000),
  "STRSPLIT" VARCHAR(10),
  "INDEXNO" INTEGER
 ) 
...
--SET CURRENT PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM","DB2JHB";
  ...
  CREATE FUNCTION "SUBSTRINGPRIKEY"
 ("INPSTR" VARCHAR(2048),
  "INDEXNO" INTEGER
 ) 
...
---取十进制转换二进制后右边第二位的值
CREATE FUNCTION "NUMBER_TO_BIT"("V_NUM" INTEGER)
RETURNS VARCHAR(8)
SPECIFIC "NUMBER_TO_BIT"
BEGIN ATOMIC
DECLARE V_RTN VARCHAR(8);--注意返回列长度
...
CREATE PROCEDURE "A_GETALLUSRINFO" ( 
IN PISPTYPE INTEGER --=1
) 
...
CREATE PROCEDURE "A_GETCHANNELMAP" ( ) 
...
CREATE PROCEDURE "A_GETENDCHBINDB"
 (IN "PIUSERID" VARCHAR(11),
  IN PISPTYPE INTEGER --=1
 ) 
...
CREATE PROCEDURE "GW_A_GETGWACCV1"
 (IN "PIGWNO" INTEGER,
  IN "PISPTYPE"  INTEGER --=1
 ) 
...
CREATE PROCEDURE "A_GETKFPARAMS" ( ) 
...
CREATE PROCEDURE "A_GETPBSVRTYPE" ( ) 
...
CREATE PROCEDURE "A_GETPRECHBINDA"
 (IN "PIUSERID" VARCHAR(11),
  IN PISPTYPE INTEGER --=1
 ) 
...
CREATE PROCEDURE "A_LOADFEEINFOA" ( ) 
...
CREATE PROCEDURE  A_LOADKEYWORDS
 (IN PIID INTEGER
 ) 
...
--SET CURRENT PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM","DB2JHB";
CREATE PROCEDURE "A_LOADMTROUTE" (
IN PISPTYPE INTEGER --=1
 ) 
...
CREATE PROCEDURE "A_SYNCUSRFEEA"
 (IN "PIUID" INTEGER
 ) 
...
CREATE PROCEDURE "A_SYNCUSRFEEB"
 (IN "PIUID" INTEGER, 
...
CREATE PROCEDURE "GW_SYNCUSRFEEBV1"
 (IN "PIUID" INTEGER, 
  IN "PILASTDBREMAINED" INTEGER, 
  IN "PIREMAINED" INTEGER, 
  IN "PIPREPAYUSED" INTEGER, 
...
CREATE PROCEDURE "A_UPDNUMSECTION"
...
CREATE PROCEDURE H_PROCESSINGSTATUS
 (IN "CUSEID" INTEGER, 
  IN "CUR" BIGINT, 
  IN "MAXI" BIGINT, 
  IN "COUNTS" INTEGER, 
...
CREATE PROCEDURE "INSERTMTREPORT_SP"
...
CREATE PROCEDURE "MMS_ADD_MT_HISTORY"
...
CREATE PROCEDURE "S_RD_ATTMRTASK"
...
CREATE PROCEDURE S_RD_MTTASKRPT
 (IN "PIPTMSGID" BIGINT, 
  IN "PIUID" INTEGER
 ) 
...
CREATE PROCEDURE "S_RD_MTLVLQUE"
...
CREATE PROCEDURE "S_RD_MTTASKRESD"
...
CREATE PROCEDURE "S_RD_MTTMRQUE"
 (IN "PIUID" INTEGER, 
  IN "PIDESTUID" INTEGER, 
  IN "PISENDLEVEL" INTEGER, 
  IN "PIMAXREADCNT" INTEGER, 
...
CREATE PROCEDURE "S_RD_MTVFYTASK" ( ) 
...
CREATE PROCEDURE "S_UPD_ATTMRFLAG"
 (IN "PITASKID" INTEGER, 
  IN "PIID" INTEGER, 
  IN "PILOGINID" VARCHAR(11), 
...
CREATE PROCEDURE S_RD_BATMTREQ
 (IN "PILOGINID" VARCHAR(11), 
...
CREATE PROCEDURE S_UPD_BATMTREQ
...
CREATE PROCEDURE "S_UPD_MONINFO"
 (IN "PIGATEID" INTEGER, 
...
CREATE PROCEDURE "S_UPD_MTVFYTASK"
 (IN "PIUID" BIGINT
 ) 
...
CREATE PROCEDURE "S_WR_BATMTREQ"
 (IN "PIUSERID" VARCHAR(11), 
  IN "PILOGINID" VARCHAR(11), 
  IN "PIUSERUID" INTEGER, 
...
--SET CURRENT PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM","DB2JHB";
CREATE PROCEDURE "S_WR_MTLVLQUE"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIRETFLAG" SMALLINT, 
  IN "PIPKTOTAL" SMALLINT, 
...
CREATE PROCEDURE "GW_WR_MTLVLQUEV1"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIRETFLAG" SMALLINT, 
  IN "PIPKTOTAL" SMALLINT, 
...
CREATE PROCEDURE "S_WR_MTTMRQUE"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIRETFLAG" SMALLINT, 
  IN "PIPKTOTAL" SMALLINT, 
...
CREATE PROCEDURE "S_WR_MTVRFYWAIT"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIRETFLAG" SMALLINT, 
  IN "PIPKTOTAL" SMALLINT, 
...
CREATE PROCEDURE "S_WR_RPTWAITC"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISPGATE" VARCHAR(21), 
  IN "PISPNUMBER" VARCHAR(21), 
...
--SET CURRENT PATH = "SYSIBM","SYSFUN","SYSPROC","SYSIBMADM","DB2JHB";
CREATE PROCEDURE "S_WR_MTTASKSR"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PIRETFLAG" SMALLINT, 
...
CREATE PROCEDURE  S_RD_MTTASKSUPP
...
--------------------监控函数
CREATE FUNCTION "INSERT_BUFINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION "INSERT_LOGINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION "INSERT_SPGATEINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION "INSERT_SYSINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "INSERT_THREADINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "INSERT_USERINFO"
 ("STRVALUES" VARCHAR(4096)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_BUFINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_LOGINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_SPGATEINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_SYSINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_THREADINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE FUNCTION  "UPDATE_USERINFO"
 ("STRVALUES" VARCHAR(4096),
  "STRWHERE" VARCHAR(1024)
 ) 
  RETURNS VARCHAR(6000)
...
CREATE TABLE "A_SMSMSGIDMAP"
 ...
 CREATE UNIQUE INDEX "IX_A_SMSMSGIDMAP"
  ON "A_SMSMSGIDMAP"
 (ID ASC,
 PTMSGID ASC,
 USERMSGID ASC,
...
CREATE PROCEDURE "A_GETMSGIDMAP"
...
CREATE PROCEDURE "A_LOADPUSHBIND"(
IN PISPTYPE INTEGER --=1
) 
...
CREATE PROCEDURE S_RD_MOWAITA_PUSH
 (IN "PIUSERUID" INTEGER, 
  IN "PIMAXREADCNT" INTEGER,
  IN PISPTYPE INTEGER --=1
 ) 
...
CREATE PROCEDURE S_RD_RPTWAITA_PUSH
 (IN "PIUSERUID" INTEGER, 
  IN "PIMAXREADCNT" INTEGER
 ) 
...
CREATE PROCEDURE "A_WR_MSGIDMAP"(
IN PIPTMSGID  BIGINT,
...
CREATE TABLE "HTTPERRCODE"
 ("ID"         INTEGER         NOT NULL  GENERATED BY DEFAULT
    AS IDENTITY (START WITH 1, INCREMENT BY 1, NO CACHE, MINVALUE 1, MAXVALUE 2147483647, NO CYCLE),
 ...
 ADD CONSTRAINT "PK_HTTPERRCODE" PRIMARY KEY
   ("ID"
   );
...
ALTER TABLE "A_PROVINCECITY" ADD CONSTRAINT  "A_PROVINCECITY_PK"  PRIMARY KEY("ID");

CREATE INDEX "IX_A_PRCECITY_PRVC" ON "A_PROVINCECITY" 
("PROVINCE"   ASC
)
  PCTFREE 10
  ALLOW REVERSE SCANS;
  
CREATE INDEX "IX_A_PRCECITY_CITY" ON "A_PROVINCECITY" 
("CITY"   ASC
)
  PCTFREE 10
  ALLOW REVERSE SCANS;
  
CREATE INDEX "IX_A_PRCE_AREACODE" ON "A_PROVINCECITY"
 ("AREACODE" ASC
 )
  PCTFREE 10
  ALLOW REVERSE SCANS;
...
--错误码表一次性全部加载
CREATE PROCEDURE A_LOADMNPERRCODE
...
--特殊号码表增量加载
CREATE PROCEDURE A_LOADSPEPHNO(
IN PIID INTEGER,
IN PIMAXCNTID INTEGER
)
...
--加载国际区号表
CREATE PROCEDURE A_LOADAREACODE
...
CREATE PROCEDURE "A_LOADMOBILEAREA" (
IN PIID BIGINT ,
IN PIMAXCOL INTEGER
) 
...
CREATE PROCEDURE LOADPROCERRCODE
(
...
CREATE PROCEDURE "MMS_RD_BMTREQ" 
...
CREATE PROCEDURE "MMS_UPD_BMTREQ"
(
  IN "PIID" INTEGER,
	IN "PISENDSTATUS" SMALLINT,
	IN "PITASKID" INTEGER,
...
CREATE PROCEDURE "MMS_WR_LVLQUE"
(
	IN PIPTMSGID         BIGINT,
	IN PIUID             INTEGER,
	IN PILOGINID        VARCHAR(11),
...
CREATE PROCEDURE "S_RD_MMS_QUEUE" 
(
IN PISPGATE VARCHAR(21),
IN PIUNICOM SMALLINT
)
...
CREATE PROCEDURE "S_WR_MMS_TASK"
(
IN PIPTMSGID BIGINT,
IN PISPMSGID BIGINT,
IN PIUSERMSGID BIGINT,
...
CREATE PROCEDURE "S_UPD_MMS_MTRPT" 
...
CREATE PROCEDURE H_RESTATISTICS
 (
 IN "PIYEAR" INTEGER,
 IN "PIMONTH" INTEGER,
 IN "PIDAY" INTEGER
...
CREATE PROCEDURE "A_LOADCMD_ROUTE"()
...
CREATE PROCEDURE "A_LOADCMD_ROUTE_P"()
--通道指令
BEGIN 
DECLARE RS1 CURSOR WITH RETURN FOR 
...
CREATE PROCEDURE "A_LOADCMD_ROUTE_G"()
--全局指令
BEGIN 
DECLARE RS1 CURSOR WITH RETURN FOR 
SELECT R.ID,R.NAME,UPPER(R.STRUCTCODE)AS STRUCTCODE,R.TRUCTTYPE,R.BUSSYSNAME,U.USERID,R.STATUS,R.MATCHMODE,R.CREATER,
...
CREATE PROCEDURE A_GETSGIPBIND
 (IN "PIUID" INTEGER,
  IN "PITYPE" INTEGER 
 ) 
...
CREATE PROCEDURE H_MMSDELTETASK 
	(
...
CREATE PROCEDURE H_MMSSTATISTICS
 (IN "PIPROCESSFLAG" INTEGER
 ) 
...
CREATE PROCEDURE H_MMSTRANSFER
 (IN "PIMININDEX" BIGINT, 
  IN "PIMAXINDEX" BIGINT
 ) 
...
CREATE INDEX  "IX_MSGTAIL_TI"
  ON  "GW_MSGTAIL"
 (
  "TAIL_ID"
 );
  
CREATE INDEX  "IX_MSGTAIL_CC"
  ON  "GW_MSGTAIL"
 (
  "CORP_CODE"
 );
...
CREATE INDEX  "IX_TAILBIND_CC"
  ON  "GW_TAILBIND"
 (
  "CORP_CODE"
 );

CREATE INDEX  "IX_TAILBIND_TI"
  ON  "GW_TAILBIND"
 ("TAIL_ID"
 );
...
CREATE PROCEDURE "GW_LFSPECBIND" ( ) 
...
CREATE PROCEDURE H_DATATRANSFER ( ) 
...
CREATE PROCEDURE H_MMSTRANSFERMO ( ) 
...
CREATE PROCEDURE H_MMSDATATRANSF
 (IN "PIPROCESSFLAG" INTEGER
 ) 
...
CREATE TRIGGER INSERT_QUEUE_TRIG
  AFTER
  INSERT
  ON USERDATA
  REFERENCING
...
CREATE TRIGGER "INSERT_USEFEE_TRIG"
  AFTER
  INSERT
  ON "PB_WEBZZCMD_QUEUE"
  REFERENCING
...
CREATE PROCEDURE "GW_WRRPTWAITCV1"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISPGATE" VARCHAR(21), 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE GW_H_STATISTIV1
...
CREATE PROCEDURE GW_H_MMSSTATIV1
 (IN "PIPROCESSFLAG" INTEGER,IN "ISP1" INTEGER,IN "ISP2" INTEGER,IN "ISP3" INTEGER,IN "ISP4" INTEGER
 ) 
...
CREATE PROCEDURE GW_H_DATATRANV1 ( IN "ISP1" INTEGER,IN "ISP2" INTEGER,IN "ISP3" INTEGER,IN "ISP4" INTEGER) 
...
END;
CREATE PROCEDURE "GW_UPPRPTRVOK"
 (IN "PRETIME" INTEGER,IN "INCRES" BIGINT,IN "STARTTIME" VARCHAR(30)
 ) 
...
CREATE PROCEDURE "GW_UPPRPTSDOK"
 (IN "PRETIME" INTEGER,IN "INCRES" BIGINT,IN "STARTTIME" VARCHAR(30)
 ) 
...
CREATE PROCEDURE "GW_UPPDATA_ALL"
...
CREATE PROCEDURE "GW_WR_RPTRVOK"
 (IN "PIPTMSGID" BIGINT, 
  IN "PISPMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PIRECVTIME" TIMESTAMP, 
...
CREATE PROCEDURE "GW_WR_RPTSDOK"
 (IN "PIPTMSGID" BIGINT, 
  IN "PISPMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PISENDFLAG" SMALLINT, 
...
CREATE PROCEDURE "GW_H_DELTASKV1"
 (IN "MININDEX" BIGINT, 
  IN "MAXINDEX" BIGINT
 ) 
...
CREATE PROCEDURE "GW_H_TRANSFERV1"
 (IN "PIMININDEX" BIGINT, 
  ...
  IF CAST(SUBSTR(CAST(CURYM AS CHAR(6)),5,2) AS INT)<>12 THEN
      ...
      SET PISTR= 'INSERT INTO '||PITABLENAME||' (ID,MDAY,USERID,SPGATE,CPNO,PHONE,SPMSGID,RETFLAG,FEEFLAG,PKNUMBER,PKTOTAL,SENDSTATUS,SENDFLAG,RECVFLAG,DONEDATE,ERRORCODE,SENDLEVEL,SENDTYPE,UNICOM,SENDTIME,RECVTIME,MESSAGE,TASKID,ECID,PTMSGID,MOBILEAREA,SPID,SVRTYPE,P1,P2,P3,P4,USERMSGID,MODULEID,ATTIME,VALIDTIME,BATCHID,AREACODE,CUSTID,EXDATA)
                SELECT ID,INT(DAY(M.SENDTIME)),USERID,SPGATE,CPNO,PHONE,SPMSGID,RETFLAG,FEEFLAG,PKNUMBER,PKTOTAL,SENDSTATUS,SENDFLAG,RECVFLAG,DONEDATE,ERRORCODE,SENDLEVEL,SENDTYPE,UNICOM,SENDTIME,RECVTIME,MESSAGE,TASKID,ECID,PTMSGID,MOBILEAREA,SPID,SVRTYPE,P1,P2,P3,P4,USERMSGID,MODULEID,ATTIME,VALIDTIME,BATCHID,AREACODE,CUSTID,EXDATA   
...
CREATE PROCEDURE "GW_RDMTTASKRSV1"
 (IN "PIMAXRESNDCNT" INTEGER, 
  IN "PISTRMSGID" VARCHAR(4000)
 ) 
...
CREATE PROCEDURE "GW_RDMTTASKRPV1"
 (IN "PIPTMSGID" BIGINT, 
  IN "PIUID" INTEGER
 ) 
...
CREATE PROCEDURE  GW_MTTASKSUPPV1
 (IN "PIOLDMSGID" BIGINT, 
  IN "PINEWMSGID" BIGINT, 
  IN "PISRCUID" INTEGER, 
  IN "PISRCUSRID" VARCHAR(11), 
...
CREATE PROCEDURE  GW_MTTASKSUPPV2                                                                                                                                                                                                                                  
 (IN "PIOLDMSGID" BIGINT,                                                                                                                                                                                                                                          
  IN "PINEWMSGID" BIGINT,                                                                                                                                                                                                                                          
  IN "PISRCUID" INTEGER,                                                                                                                                                                                                                                           
  IN "PISRCUSRID" VARCHAR(11),                                                                                                                                                                                                                                     
...
CREATE PROCEDURE "GW_WRRPTWAITBV1"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIECID" INTEGER, 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "GW_WRRPTWAITCV2"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISPGATE" VARCHAR(21), 
  IN "PISPNUMBER" VARCHAR(21), 
...
END;
  ...
  CREATE PROCEDURE "GW_WRMTTASKCV1"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" INTEGER, 
  IN "PIRETFLAG" SMALLINT, 
...
CREATE PROCEDURE "GW_WRMTTASKCV2"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" INTEGER, 
  IN "PIRETFLAG" SMALLINT, 
...
CREATE PROCEDURE "GW_LOADSVRTYPE"() 
...
CREATE PROCEDURE "GW_H_DATATRANV2"
 (IN "ISP1" INTEGER, 
  IN "ISP2" INTEGER, 
  IN "ISP3" INTEGER, 
  IN "ISP4" INTEGER
...
CREATE PROCEDURE GW_H_MMSDATATV1
 (IN "PIPROCESSFLAG" INTEGER,IN "ISP1" INTEGER,IN "ISP2" INTEGER,IN "ISP3" INTEGER,IN "ISP4" INTEGER
 ) 
...
CREATE PROCEDURE GW_CMTDATARPT(PIYM INTEGER)
BEGIN
...
CREATE PROCEDURE "GW_H_STATISTIV3"
 (
  ...
  BEGIN
	...
	DECLARE MINTMIYMD INTEGER;
	DECLARE MAXTMIYMD INTEGER;
	DECLARE MINTMIYM INTEGER;
	DECLARE MAXTMIYM INTEGER;
	DECLARE CURTMIYM INTEGER;
	DECLARE	PITABLENAME VARCHAR(20);
	DECLARE ISEXIST INTEGER;
	...
	SET STR= 'INSERT INTO SESSION.TEMP_STATISTICS(USERID,TASKID,SPGATE,SPISUNCM,SPID,SVRTYPE,P1,P2,P3,P4,IYMD,IYEAR,IMONTH,IHOUR,ICOUNT,SUCC,FAIL,NRET,MOBILEAREA,SENDTYPE,BATCHID,AREACODE)
               ...
               COUNT(ID),
			         ...
			         BATCHID,AREACODE
               FROM GW_MT_TASK_BAK
               WHERE SENDTIME <  '''||ENDTIME||''' GROUP BY 
               USERID,TASKID,SPGATE,UNICOM,SPID,SVRTYPE';
	         IF ISP1 =1 THEN
			    SET STR=STR||' ,P1';
             END IF;
	 ...
	 SET STR=STR||',MOBILEAREA,SENDTYPE,BATCHID,AREACODE,
	  ...
	  SELECT CAST(SUBSTR(CHAR(COALESCE(MIN(IYMD),0)),1,6) AS INT) , CAST(SUBSTR(CHAR(COALESCE(MAX(IYMD),0)),1,6) AS INT) INTO MINTMIYM,MAXTMIYM FROM SESSION.TEMP_STATISTICS;
	  SET CURTMIYM=MINTMIYM;
	  WHILE CURTMIYM<=MAXTMIYM DO

	    SET PITABLENAME = 'GW_MTDRPT'||CAST(CURTMIYM AS CHAR(6));
      SELECT COALESCE(COUNT(1),0) INTO ISEXIST FROM SYSCAT.TABLES WHERE TABNAME=PITABLENAME;
      IF ISEXIST<1 THEN
        SET STR='CALL GW_CMTDATARPT ('||CAST(CURTMIYM AS CHAR(6))||')';
        EXECUTE IMMEDIATE STR;
      END IF;
      SELECT  COALESCE(MIN(IYMD),0),COALESCE(MAX(IYMD),0) INTO MINTMIYMD,MAXTMIYMD FROM SESSION.TEMP_STATISTICS WHERE INT(SUBSTR(CHAR(IYMD),1,6))=CURTMIYM;
     SET STR = 'DELETE FROM '||PITABLENAME||' WHERE IYMD BETWEEN  '||CHAR(MINTMIYMD)||' AND '||CHAR(MAXTMIYMD); 
     EXECUTE IMMEDIATE STR;
	   
     
	      SET STR= 'INSERT INTO '||PITABLENAME||' (USERID,TASKID,SPGATE,SPISUNCM,SPID,SVRTYPE,P1,P2,P3,P4,IYMD,IHOUR,IMONTH,Y,ICOUNT,RSUCC,RFAIL1,RFAIL2,RNRET, SENDTYPE, MOBILEAREA,BATCHID,AREACODE)
                SELECT T.USERID,T.TASKID,T.SPGATE,T.SPISUNCM,T.SPID,T.SVRTYPE,T.P1,T.P2,T.P3,T.P4,T.IYMD,T.IHOUR,T.IMONTH,T.IYEAR,T.ICOUNT,T.SUCC,T.FAIL,(T.ICOUNT-T.SUCC-T.FAIL-T.NRET),T.NRET, T.SENDTYPE, T.MOBILEAREA,T.BATCHID ,T.AREACODE
      FROM SESSION.TEMP_STATISTICS  T
                WHERE IYMD BETWEEN  '||CHAR(MINTMIYMD)||' AND '||CHAR(MAXTMIYMD) ;
      EXECUTE IMMEDIATE STR;
      
	  	
	  IF INT(SUBSTR(CAST(CURTMIYM AS CHAR(6)),5,2))=12 THEN
          SET CURTMIYM = CAST(CAST(CAST(SUBSTR(CAST(CURTMIYM AS CHAR(6)),1,4)AS INT)+1 AS CHAR(4))||'01' AS INT); 
      ELSE
          SET CURTMIYM = CURTMIYM+1;
      END IF;  
...
--初始化
  ...
  SET PIALLEXCEPTION          = 10;
      ...
      --先汇总
      SELECT VALUE(MIN(ID),0),VALUE(MAX(ID),0)INTO PICURRINDEX,PIMAXINDEX  FROM GW_MT_TASK_BAK  
      WHERE SENDTIME>= TIMESTAMP (TRIM(CAST((CURRENT DATE - PIPROCESSFLAG DAYS) AS CHAR(32)))||' 00:00:00.000000') AND SENDTIME < TIMESTAMP (TRIM(CAST((CURRENT DATE) AS CHAR(32)))||' 00:00:00.000000');
     ...
     --转移符合当前时间的数据
     SELECT VALUE(MAX(ID),0) INTO PIMAXINDEX FROM GW_MT_TASK_BAK  WHERE  SENDTIME<TIMESTAMP (TRIM(CAST((CURRENT DATE - PIPROCESSFLAG DAYS) AS CHAR(32)))||' 00:00:00.000000');
     IF(PICURRINDEX<PIMAXINDEX)THEN
     SELECT MIN(SENDTIME),MAX(SENDTIME) INTO MINTIME,MAXTIME FROM GW_MT_TASK_BAK  WHERE ID<=PIMAXINDEX;
	    SET MINYM=CAST((SUBSTR(CHAR(MINTIME),1,4)||SUBSTR(CHAR(MINTIME),6,2))AS INT);
        SET MAXYM=CAST((SUBSTR(CHAR(MAXTIME),1,4)||SUBSTR(CHAR(MAXTIME),6,2))AS INT);
...
CREATE PROCEDURE "GW_LOADCLUBIND"(IN "P_GWNO" INT)
...
CREATE PROCEDURE "GW_UPDCLUSTATS"(IN P_GWTYPE INTEGER,IN P_GWNO INTEGER,IN P_PRIGWNO INTEGER,IN P_OLDPRIGWNO INTEGER,IN P_RUNSTATUS INTEGER,IN P_WEIGHT INTEGER,IN P_RUNWEIGHT INTEGER,IN P_UPDTYPE INTEGER)
...
CREATE PROCEDURE GW_RD_BATREQV1
 (IN "PILOGINID" VARCHAR(11), 
  IN "PIDOWNLOADFLAG" SMALLINT,
...
CREATE PROCEDURE GW_UPDBATREQV1
 (IN "PIUSERID" VARCHAR(6), 
  IN "PIUSERUID" INTEGER, 
  IN "PILOGINID" VARCHAR(11), 
  IN "PISENDSTATUS" SMALLINT, 
...
CREATE PROCEDURE GW_WR_MTTASKBAK
 (
    IN PIUID         INTEGER,
    IN PIPTMSGID     BIGINT,
    IN PIECID        INTEGER,
...
CREATE PROCEDURE "GW_RDRPTWAITBV1"
 (IN "PIUID" INTEGER, 
  IN "PIMAXREADCNT" INTEGER
 ) 
...
CREATE PROCEDURE "GW_WRRPTWAITBV2"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIECID" INTEGER, 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "GW_WRRPTWAITBV3"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIECID" INTEGER, 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "GW_WRRPTWAITCV3"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISPGATE" VARCHAR(21), 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "GW_WRRPTWAITCV4"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISPGATE" VARCHAR(21), 
  IN "PISPNUMBER" VARCHAR(21), 
...
CREATE PROCEDURE "GW_LOADDATAV1"
 (IN "FLAG" BIGINT, 
  IN "INCRES" BIGINT,
  IN "PRETIME" INTEGER) 
...
CREATE PROCEDURE "GW_UPPDATAMODE2"
...
CREATE PROCEDURE "GW_WR_MTTASKV2"
 (IN "PIUID" INTEGER,    
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PIRETFLAG" SMALLINT,
...
CREATE PROCEDURE "GW_WR_MTTASKSRV1"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PIRETFLAG" SMALLINT, 
...
CREATE PROCEDURE "GW_WR_MTTASKSRV2"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" SMALLINT, 
  IN "PIRETFLAG" SMALLINT, 
...
CREATE PROCEDURE  GW_MTTASKSUPPV3                                                                                                                                                                                                                                  
 (IN "PIOLDMSGID" BIGINT,                                                                                                                                                                                                                                          
  IN "PINEWMSGID" BIGINT,                                                                                                                                                                                                                                          
  IN "PISRCUID" INTEGER,                                                                                                                                                                                                                                           
  IN "PISRCUSRID" VARCHAR(11),                                                                                                                                                                                                                                     
...
CREATE PROCEDURE   GW_LOADBASEPARA()
...
CREATE PROCEDURE   GW_LOADPROTOMTCH()
...
CREATE PROCEDURE "GW_GETALLUSRINFOV1" ( 
IN PISPTYPE INTEGER --=1
) 
...
CREATE PROCEDURE GW_LOADPUSHPROMH()
...
CREATE PROCEDURE  GW_LOADPUSHPROCOL()
...
SPECIFIC "GW_LOADLFTEMPLATE"
  ...
  BEGIN
        DECLARE PISQLSTR VARCHAR(1000);
   	DECLARE RS1 CURSOR WITH RETURN FOR S1; 
	SET PISQLSTR = 'SELECT TM_ID,USER_ID,TM_NAME,TM_MSG,DSFLAG,TM_STATE,ADDTIME,ISPASS,TMP_TYPE,BIZ_CODE,CORP_CODE,PARAMCNT,TM_CODE  FROM LF_TEMPLATE';
	PREPARE S1 FROM PISQLSTR;
	OPEN RS1;
...
CREATE PROCEDURE GW_LOADGTCONNINFO(IN P_PIPTACCID VARCHAR(11))
...
CREATE PROCEDURE GW_LOADUSRFEE(IN PISPTYPE INTEGER)
...
CREATE PROCEDURE GW_WR_MTTASKBAKV1
 (
    IN PIUID         INTEGER,
    IN PIPTMSGID     BIGINT,
    IN PIECID        INTEGER,
...
BEGIN
  ...
  IF PICNT=0 THEN
    ...
    VALUES(PIUID,PIPTMSGID,PIECID,PISENDSTATUS,PIRETFLAG,PIPKNUMBER,PIPKTOTAL,PIFEEFLAG,PISENDLEVEL,PIRECVMTTIME,
    PIUSERID,PISPGATE,PICPNO,PIPHONE,PIMESSAGE,PITASKID,PIERRORCODE,PITPUDHI,PILONGMSGSEQ,PIMSGFMT,PIUNICOM,
    PIMOBILEAREA,PISVRTYPE,PIP1,PIP2,PIP3,PIP4,PIUSERMSGID,PIMODULEID,PIATTIME,PIVALIDTIME,PISENDTYPE,PIBATCHID,PIAREACODE,PICUSTID,PIEXDATA);
  END IF;
END;


CREATE PROCEDURE "GW_UPD_MOTASKV1"
 (IN "PIPTMSGID" BIGINT, 
  IN "PISENDSTATUS" INTEGER, 
  IN "PIUID" INTEGER, 
  IN "PIECID" INTEGER, 
...
CREATE PROCEDURE "GW_WRRPTWAITBV4"
 (IN "PIUID" INTEGER, 
  IN "PIPTMSGID" BIGINT, 
  IN "PIECID" INTEGER, 
  IN "PISPNUMBER" VARCHAR(21), 
