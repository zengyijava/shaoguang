...
BEGIN
	...
	ELSE
			UPDATE LF_VERSION_HIS SET UPDATETIME=NOW(),ISRELEASE=1,VERSIONINFO='1、RCOS平台企业侧模板同步线程中模板的json 数据解析异常容错处理' WHERE VERSION=VERSIONSTR AND PRODUCT_ID=1000 AND PROCESS_ID=1000;
	END IF;
    /*删除web旧版本历史*/
	...
	END IF;
END     $
CALL LF_PVERV0('7.3.6.595.SP6','73.06','8.6.4.219','6.1.52.344','7.3.7.607.SP7',1,1)$
DROP PROCEDURE IF EXISTS `LF_PVERV0`$
/*****V73.06-V73.07 END*/