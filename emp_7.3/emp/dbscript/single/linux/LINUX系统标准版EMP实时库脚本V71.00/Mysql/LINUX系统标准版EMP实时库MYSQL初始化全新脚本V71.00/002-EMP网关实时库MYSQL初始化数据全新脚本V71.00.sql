...
INSERT INTO a_gwparamconf (GWTYPE, PARAMITEM, PARAMNAME, PARAMATTRIBUTE, PARAMMEMO, DEFAULTVALUE, VALUERANGE, CONTROLTYPE, HKPARAMNAME, HKPARAMMEMO, ENPARAMNAME, ENPARAMMEMO) VALUES (4000, 'RESENDCTRL', '启用重发控制', 1, '是否开启相同短信内容重复提交控制(0/1)', '0', '0,1', 1, '啟用重發控制', '是否開啟相同短信內容重複提交控制(0/1)', 'Enable resend control', 'Whether to open the control of same content message repeat sending (0/1)');
