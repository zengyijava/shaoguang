...
public class ReportQueryOracleSql extends ReportQuerySql{
	public String getllOrderDetailConditionSql(LlOrderReportVo llOrderReport,
		...
		if("1".equals(llOrderReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE PRODUCTID='").append(llOrderReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) x ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND PRODUCTID='").append(llOrderReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) y ON x.REPORTDATE=y.REPORTDATE2 ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND PRODUCTID='").append(llOrderReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) z ON x.REPORTDATE = z.REPORTDATE3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID ='").append(llOrderReport.getProductId()).append("' WHERE  pro.status =1 AND pro.ECID =").append(llOrderReport.getEcid());
		}
	...
	public String getllOrderConditionSql(LlOrderReportVo llOrderReport,
		...
		if("1".equals(llOrderReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID WHERE pro.status =1 AND pro.ECID =").append(llOrderReport.getEcid());
		}else{
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID WHERE pro.status =1 AND pro.ECID =").append(llOrderReport.getEcid());
		}
		if(!"".equals(llOrderReport.getProductName()) && llOrderReport.getProductName() != null){
			conditionSql = conditionSql.append(" AND PRODUCTNAME LIKE '%").append(llOrderReport.getProductName()).append("%'");
	...
	public String getllOperatorConditionSql(
		...
		if("1".equals(llOperatorReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,max(USER_ID) USER_ID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID LEFT JOIN LF_SYSUSER SYSUSER ON SYSUSER.USER_ID = x.USER_ID LEFT JOIN LF_DEP DEP ON SYSUSER.DEP_ID = DEP.DEP_ID WHERE pro.status =1 AND pro.ECID =").append(llOperatorReport.getEcid());
		}else{
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,max(USER_ID) USER_ID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID LEFT JOIN LF_SYSUSER SYSUSER ON SYSUSER.USER_ID = x.USER_ID LEFT JOIN LF_DEP DEP ON SYSUSER.DEP_ID = DEP.DEP_ID WHERE pro.status =1 AND pro.ECID =").append(llOperatorReport.getEcid());
		}
	...
	public String getllOperatorDetailConditionSql(
		...
		if("1".equals(llOperatorReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE,count(1) SUNMITNUM,max(USER_ID) USER_ID FROM ").append(tableName).append(" WHERE PRODUCTID='").append(llOperatorReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) x ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND PRODUCTID='").append(llOperatorReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) y ON x.REPORTDATE=y.REPORTDATE2 ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND PRODUCTID='").append(llOperatorReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) z ON x.REPORTDATE = z.REPORTDATE3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID ='").append(llOperatorReport.getProductId()).append("' LEFT JOIN LF_SYSUSER SYSUSER ON SYSUSER.USER_ID = x.USER_ID LEFT JOIN LF_DEP DEP ON SYSUSER.DEP_ID = DEP.DEP_ID WHERE  pro.status =1 AND pro.ECID =").append(llOperatorReport.getEcid());
		}
		if(!"".equals(llOperatorReport.getProductName()) && llOperatorReport.getProductName() != null){
			conditionSql = conditionSql.append(" AND PRODUCTNAME LIKE '%").append(llOperatorReport.getProductName()).append("%'");
	...
	public String getllMechanismDetailConditionSql(
		...
		if("1".equals(llMechanismReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE,count(1) SUNMITNUM,max(ORG_ID) ORG_ID FROM ").append(tableName).append(" WHERE PRODUCTID='").append(llMechanismReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) x ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND PRODUCTID='").append(llMechanismReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) y ON x.REPORTDATE=y.REPORTDATE2 ")
					.append("LEFT JOIN (SELECT SUBSTR(REPORTDATE, 1, 6) REPORTDATE3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND PRODUCTID='").append(llMechanismReport.getProductId()).append("' AND SUBSTR(REPORTDATE, 1, 6) >= '").append(statisticsTime).append("01' AND SUBSTR(REPORTDATE, 1, 6) <= '").append(statisticsTime).append("12' GROUP BY SUBSTR(REPORTDATE, 1, 6)) z ON x.REPORTDATE = z.REPORTDATE3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID ='").append(llMechanismReport.getProductId()).append("' LEFT JOIN LF_DEP DEP ON DEP.DEP_ID = x.ORG_ID WHERE  pro.status =1 AND pro.ECID =").append(llMechanismReport.getEcid());
		}
	...
	public String getllMechanismConditionSql(
		...
		if("1".equals(llMechanismReport.getReportType())){
			...
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,max(ORG_ID) ORG_ID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 6)= '").append(statisticsTime).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID  LEFT JOIN LF_DEP DEP ON DEP.DEP_ID = x.ORG_ID WHERE  pro.status =1 AND pro.ECID =").append(llMechanismReport.getEcid());
		}else{
			conditionSql = new StringBuilder(" FROM ").append("(SELECT max(REPORTDATE) REPORTDATE, max(PRODUCTID) PRODUCTID,max(ORG_ID) ORG_ID,count(1) SUNMITNUM FROM ").append(tableName).append(" WHERE 1=1 AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) x ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID2,count(1) SUCCNUM FROM ").append(tableName).append(" WHERE LLRPT = '1' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) y ON x.PRODUCTID=y.PRODUCTID2 ")
					.append("LEFT JOIN (SELECT max(PRODUCTID) PRODUCTID3,count(1) FAILDNUM FROM ").append(tableName).append(" WHERE LLRPT = '2' AND SUBSTR(REPORTDATE, 1, 4)= '").append(statisticsTime.substring(0,4)).append("' GROUP BY PRODUCTID) z ON x.PRODUCTID = z.PRODUCTID3 ")
					.append("LEFT JOIN LL_PRODUCT pro ON  pro.PRODUCTID = x.PRODUCTID  LEFT JOIN LF_DEP DEP ON DEP.DEP_ID = x.ORG_ID WHERE  pro.status =1 AND pro.ECID =").append(llMechanismReport.getEcid());
		}
	...
	public String getLlCompInfoInsertSql() {
		return "INSERT INTO LL_COMP_INFO (ID,PASSWORD,ECID,ECNAME,IP,PORT,REMARK,PUSHADDR,UPDATETM,CREATETM) VALUES(1,?,?,?,?,?,?,?,SYSDATE,SYSDATE)";
	}
	
	public String getLlCompInfoUpdateSql() {
		return "UPDATE LL_COMP_INFO SET PASSWORD=?,ECID=?,ECNAME=?,IP=?,PORT=?,REMARK=?,PUSHADDR=?,UPDATETM=SYSDATE";
	}
	
	public String getLlProductInsertSql() {
		return "INSERT INTO LL_PRODUCT (ID,ECID,PRODUCTID,PRODUCTNAME,ISP,VOLUME,PRICE,DISCPRICE,AREA,PTYPE,PMOLD,RTYPE,STATUS,UPDATETM,CREATETM,OPERATORID) VALUES(seq_ll_product.nextval,?,?,?,?,?,?,?,?,?,?,?,1,sysdate,sysdate,?)";
	}
	
	public String getLlProductUpdateSql(LlProduct llProduct) {
		StringBuilder sql = new StringBuilder().append("UPDATE LL_PRODUCT SET STATUS=0,OPERATORID=?,UPDATETM=SYSDATE WHERE PRODUCTID=? AND ECID =").append(llProduct.getEcid());
		return sql.toString();
	}
	
	public String getLlProductUpdateInSql(LlProduct llProduct, String pros) {
		StringBuilder sql = new StringBuilder().append("UPDATE LL_PRODUCT SET STATUS=0,OPERATORID=?,UPDATETM=SYSDATE WHERE PRODUCTID in(").append(pros).append(") AND ECID =").append(llProduct.getEcid());
		return sql.toString();
	}
}
