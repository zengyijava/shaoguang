package com.montnets.emp.pasgroup.entity;

import java.sql.Timestamp;

 
/**
 * TableUserdata对应的实体类(用于代理账号管理)
 * @project emp
...
public class Userdata implements java.io.Serializable{
	...
	public Userdata(){
		...
		this.pushversion=16;
		this.useraccount ="200001";
		this.mobile="13800138000";
		this.userprivilege=11;
		this.speedlimit=0;
		this.forbidtmspan="00:00:00-00:00:00";
		this.maxdaynum=100000;
	}
	...
	public void setMaxdaynum(Integer maxdaynum) {
		this.maxdaynum = maxdaynum;
	}

	public String getForbidtmspan() {
		return forbidtmspan;
	}

	public void setForbidtmspan(String forbidtmspan) {
		this.forbidtmspan = forbidtmspan;
	}
