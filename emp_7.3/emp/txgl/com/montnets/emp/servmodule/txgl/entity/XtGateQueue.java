...
public class XtGateQueue implements java.io.Serializable {
	...
	//后拆分中文最大字数
	private Integer esplitmaxwd;
	//后拆分英文最大字数
	private Integer esplitenmaxwd;
	//构建函数
	public XtGateQueue() {
		//初始化变量
		this.spgate=" ";
...
/*	public String getGateArea() {
	...
	public Integer getEsplitmaxwd()
	{
		return esplitmaxwd;
	}

	public void setEsplitmaxwd(Integer esplitmaxwd)
	{
		this.esplitmaxwd = esplitmaxwd;
	}

	public Integer getEsplitenmaxwd()
	{
		return esplitenmaxwd;
	}

	public void setEsplitenmaxwd(Integer esplitenmaxwd)
	{
		this.esplitenmaxwd = esplitenmaxwd;
	}
