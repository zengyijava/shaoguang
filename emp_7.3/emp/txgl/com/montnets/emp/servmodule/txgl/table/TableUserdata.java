...
public class TableUserdata
{
	...
	private static final String TABLE_ID = StaticValue.DBTYPE == StaticValue.MYSQL_DBTYPE?"UID":"\"UID\"";
	...
	public static final String ACCABILITY = "ACCABILITY";
	...
	static
	{
		...
		columns.put("accability", ACCABILITY);
	};
