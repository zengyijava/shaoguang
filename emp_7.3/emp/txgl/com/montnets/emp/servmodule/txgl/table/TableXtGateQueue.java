...
public class TableXtGateQueue
{
	...
	//后拆分中文最大字数
	public static final String ESPLITMAXWD = "ESPLITMAXWD";
	//后拆分英文最大字数
	public static final String ESPLITENMAXWD = "ESPLITENMAXWD";
	...
	static
	{
		...
		columns.put("esplitmaxwd", ESPLITMAXWD);
		columns.put("esplitenmaxwd", ESPLITENMAXWD);
	};
