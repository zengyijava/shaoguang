		        ...
		        <form name="pageForm" action="<%=path%>/wx_visitreport.htm?method=visittrustView&type=<%=request.getParameter("type") %>&busId=<%=busId %>&taskid=<%=taskid!=null?taskid:"" %>" method="post" id="pageForm">
					...
					<table>
						<tr>
							...
							<td>
								<span><emp:message key='ydwx_wxcxtj_fwtj_ymmchs' defVal='页面名称：' fileName='ydwx'></emp:message></span>
							</td>
							<td>
		         ...
		         <table id="content" >
						      ...
						      <tr>
								<th>
									<emp:message key="ydwx_common_time_fangwenshijian" defVal="访问时间" fileName="ydwx"></emp:message>
								</th>
								<th>
									<emp:message key='ydwx_wxcxtj_hftj_shoujihaoma' defVal='手机号码' fileName='ydwx'></emp:message>
								</th>
								<th>
									<emp:message key='ydwx_wxcxtj_hftj_xingming' defVal='姓名' fileName='ydwx'></emp:message>
								</th>
								<th>
								...
								<th>
									<emp:message key='ydwx_wxcxtj_fwtj_ymmch' defVal='页面名称' fileName='ydwx'></emp:message>
								</th>
