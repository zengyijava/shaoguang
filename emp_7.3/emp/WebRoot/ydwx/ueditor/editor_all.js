...
(function (){
    ...
    var utils = baidu.editor.utils = /**@lends baidu.editor.utils.prototype*/{
         ...
         */
        loadCssFile : function(doc,path,fun,id){
            if (id != null && doc.getElementById(id)) {
                return;
            }
         ...
         * @param {Function}   fun  回调函数
         */
        loadJsFile : function(doc,path,fun){
...
(function (){
    ...
    var sourceEditors = {
        ...
        codemirror: function (editor, holder){
            var options = editor.options.codemirrorOptions || {};
    ...
    baidu.editor.plugins['source'] = function (){
        ...
        editor.commands['source'] = {
            execCommand: function (){
                ...
                if (sourceMode) {
                    ...
                    editor.setContent(sourceEditor.getContent() || '<p><br/></p>');
        ...
        editor.addListener("ready",function(){
            if(editor.options.sourceEditor == "codemirror"){
                utils.loadJsFile(document,editor.options.UEDITOR_HOME_URL+"third-party/codemirror2.15/codemirror.js");
                utils.loadCssFile(document,editor.options.UEDITOR_HOME_URL+"third-party/codemirror2.15/codemirror.css");
            }
        });
    };
...
baidu.editor.plugins['serialize'] = function () {
    ...
    function transNode(node){
        if(node.type == 'element' && !node.children.length && (dtd.$removeEmpty[node.tag]||dtd.$removeEmptyBlock[node.tag]) && node.tag != 'a'){// 锚点保留
...
//        layer.style.display = 'block';
    ...
    function bindFixedLayer(adjOffset){
        ...
        domUtils.on(window, 'resize', updateFixedOffset);
    }
})();
...
(function (){
    ...
    TablePicker.prototype = {
                 ...
                 '<div class="edui-tablepicker-body">' +
                  '<div class="edui-infoarea">' +
                   '<span id="##_label" class="edui-label"></span>' +
                    /*更多*/
                   '<span class="edui-clickable" onclick="$$._onMore();">'+getJsLocaleMessage("common","common_more")+'</span>' +
                  '</div>' +
        ...
        render: function (holder){
            ...
            /*行 列*/
            this.getDom('label').innerHTML = '0'+getJsLocaleMessage("ydwx","ydwx_ueditor_row")+' x 0'+getJsLocaleMessage("ydwx","ydwx_ueditor_col");
        },
        _track: function (numCols, numRows){
            ...
            /*列 行*/
            label.innerHTML = numCols + getJsLocaleMessage("ydwx","ydwx_ueditor_col")+' x ' + numRows + getJsLocaleMessage("ydwx","ydwx_ueditor_row");
        ...
        initColorButton: function (){
            ...
            this.popup = new Popup({
                content: new ColorPicker({
                    /*清除颜色*/
                    noColorText: getJsLocaleMessage("ydwx","ydwx_ueditor_6"),
    ...
    Dialog.prototype = {
        ...
        initDialog: function (){
            ...
            this.closeButton = new Button({
                ...
                /*关闭对话框*/
                title: getJsLocaleMessage("ydwx","ydwx_ueditor_5"),
                onclick: function (){
                    me.close(false);
                }
            });
...
//        'Imageleft', 'ImageRight', 'ImageChar',
    ...
    editorui.ClearDoc = function(editor, title){
        ...
        var ui = new editorui.Button({
            ...
            onclick: function (){
                /*确定清空文档吗？*/
                if(confirm(getJsLocaleMessage("ydwx","ydwx_ueditor_4"))){
    ...
    editorui.InsertUnorderedList = function (editor, title){
        ...
        var ui = new editorui.MenuButton({
            ...
            items:
                [{
                    /*小圆圈*/
                    label: '○ '+getJsLocaleMessage("ydwx","ydwx_ueditor_circle"),
                    value: 'circle',
                    onclick : _onMenuClick
                },{
                    /*小圆点*/
                    label: '● '+getJsLocaleMessage("ydwx","ydwx_ueditor_disc"),
                    value: 'disc',
                    onclick : _onMenuClick
                },{
                    /*小方块*/
                    label: '■ '+getJsLocaleMessage("ydwx","ydwx_ueditor_square"),
                    value: 'square',
                    onclick : _onMenuClick
                }],
            onbuttonclick: function (){
