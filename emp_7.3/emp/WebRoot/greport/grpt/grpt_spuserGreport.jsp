				...
				<dl>
			      ...
			      <dd><select name="mstype" id="mstype" style="width: 100px;">
					...
					<select name="orderby" id="orderby"  style="width: 120px;">
						<option value="1" <% if("1".equals(request.getAttribute("orderby"))){ %> selected="selected" <%} %>><emp:message key="cxtj_sjfx_ztfsqs_fslcdds" defVal="发送量从多到少" fileName="cxtj"></emp:message></option>
						<option value="2" <% if("2".equals(request.getAttribute("orderby"))){ %> selected="selected" <%} %>><emp:message key="cxtj_sjfx_ztfsqs_fslcsdd" defVal="发送量从少到多" fileName="cxtj"></emp:message></option>
						<option value="3" <% if("3".equals(request.getAttribute("orderby"))){ %> selected="selected" <%} %>><emp:message key="cxtj_sjfx_ztfsqs_zhpyzmsx" defVal="账号拼音字母顺序" fileName="cxtj"></emp:message></option>
					</select>
					</dd>
