...
<html>
	...
	<div id="container" class="container" >
			<%-- header开始 --%>
			<%=com.montnets.emp.common.constant.ViewParams.getPosition(langName,menuCode,"新建默认回复") %>
				...
				<div id="moreSelect">
					<table width="" style="">
							<tr style="">
								...
								<label id="busname" class="hidden"></label>
									<select class="input_bd div_bd" id=AId name="AId" class="input_bd" style="width:120px">
										<option selected="selected" value="0"><emp:message key="wexi_qywx_mrhf_text_12" defVal="所有公众帐号"
									...
									<font color="red">&nbsp;&nbsp;&nbsp;*</font><span style="color:gray"><emp:message key="wexi_qywx_mrhf_text_13" defVal="选择公众平台微信号"
							...
							<tr>
								...
								<td>
								  <div style="position:relative;height:24px;padding:5px 0 0;width:404px;">
									<span><input type="radio" value="0" id="radio1" checked name="radioTemp" onclick="selectTemp(0)">
									<emp:message key="wexi_qywx_mrhf_text_16" defVal="手工编辑"
											fileName="weix"></emp:message></span>
									<span><input type="radio" value="1" id="radio2" name="radioTemp" onclick="selectTemp(1)">
									<emp:message key="wexi_qywx_mrhf_text_17" defVal="引用模板"
											fileName="weix"></emp:message></span>
									<div id="chooseTemp" style="display:none;position:absolute;left:130px;*left:150px;top:2px;"><input type="button" value="
										<emp:message key="wexi_qywx_mrhf_text_18" defVal="选择模板"
						  ...
						  <tr align="right">
                         	<td></td>
                         	<td id="btn">
                         		<input id="btsend" class="btnClass5 mr10" type="button" value="<emp:message key="common_btn_8" defVal="保存"
											fileName="common"></emp:message>" onclick="save()"/>
						    	<input id="btcancel" class="btnClass6 mr10" type="reset" value="<emp:message key="common_btn_9" defVal="重置"
		...
		<script type="text/javascript" src="<%=iPath%>/js/addDefault.js"></script>
	</body>
</html>