...
<html>
	<head>
		...
		<%}%>
 		<link rel="stylesheet" type="text/css" href="<%=iPath %>/css/grp_cliShare.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/ydkf_TongXunLuGuanLi.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		
	</head>
	<body onload="loadFn()" id="grp_cliShare">
	<input type="hidden" id="pathUrl" value="<%=path %>">
		<div id="container" class="container">
			...
			<form method="post" id="selectForm">
				...
				<table border="0" width="523px;" cellspacing="0" cellpadding="0">
					<tr>
					...
					<tr>
						<td class="group_td2"  align="left" colspan="3">
								...
								<tr>
									<td class="group_td3">
										<div id="etree"  class="dept div_bd">
											<iframe id="sonFrame" name="sonFrame" style="height:240px;width:240px;" frameborder="0" src="<%=iPath %>/grp_cliSysDepTree.jsp?lguserid=<%=lguserid %>"></iframe>
										</div>
										<div id="egroup"  class="hidden"></div>
										...
										<div class="dept div_bd group_div2">
											<select  multiple name="left" id="left" size="15" 
												ondblclick="">
											</select>
										</div>
									</td>
    ...
    <script language="javascript" src="<%=commonPath %>/common/js/myjquery-a.js?V=<%=StaticValue.getJspImpVersion() %>" type="text/javascript"></script>
		...
		<script language="javascript" type="text/javascript" src="<%=iPath %>/js/cliShare.js?V=<%=StaticValue.getJspImpVersion() %>"></script>
		<script>
