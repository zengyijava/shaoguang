...
<html>
	<head>
        ...
        <link rel="stylesheet" type="text/css" href="<%=iPath %>/css/grp_cliManage.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		...
		<div id="container" class="container">
			...
			<div id="rContent" class="rContent">
			 ...
			 <input type="hidden" name="pathUrl" id="pathUrl" value="<%=path %>"/>
				<form name="pageForm" action="<%=path %>/grp_cliGroupManage.htm?method=find" method="post">
					<div class="buttons">
						<div id="toggleDiv">
						</div>
					...
					<div class="group_display_none" id="getloginUser"></div>
						...
						<input type="hidden" name="path" id="path" value="<%=path %>"/>
				 		...
				 		<table id="content">
							...
							<tr>
								...
								<td class="textalign"><%=null == groupInfoVo.getUdgName()?" ": groupInfoVo.getUdgName().replace("<","&lt;").replace(">","&gt;") %></td>
			...
			<div id="infoDiv" title="<emp:message key="group_ydbg_xzqz_text_addgroup" defVal="新增群组" fileName="group"/>"  class="group_display_none">
				<iframe id="flowFrame" name="flowFrame" src="" 
					 ...
					 <table style="border:0px"><tr style="border:0px"><td class="group_td1" align="center">
			...
			<form id="groupShareForm" name="groupShareForm"
							action="grp_cliGroupManage.htm?method=groupShare" method="post">
...
<%--					</div>--%>
			...
			<input type="hidden" value="<%=iPath %>" id="ipath" name="ipath"/>
				<iframe id="shareflowFrame" name="shareflowFrame" src="<%=iPath %>/grp_cliShare.jsp?lguserid=<%=lguserid%>" marginwidth="0" marginheight="-20px" scrolling="no" frameborder="no"></iframe>
				<table style="border:0px"><tr style="border:0px"><td class="group_td1" align="center">
     ...
     <script language="javascript" src="<%=commonPath %>/common/js/myjquery-a.js?V=<%=StaticValue.getJspImpVersion() %>" ></script>
		...
		<script type="text/javascript" src="<%=commonPath%>/common/i18n/<%=empLangName%>/group_<%=empLangName%>.js"></script>
 		<script language="javascript" type="text/javascript" src="<%=iPath %>/js/groupManageCqa.js?V=<%=StaticValue.getJspImpVersion() %>"></script>
