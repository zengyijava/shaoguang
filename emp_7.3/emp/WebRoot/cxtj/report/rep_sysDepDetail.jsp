		...
		<div id="container" class="container">
			...
			<div id="rContent" class="rContent">
				...
				<form name="pageForm" action="rep_sysDepReport.htm?method=findInfoById&lguserid=<%=request.getParameter("lguserid") %>&lgcorpcode=<%=request.getParameter("lgcorpcode") %>" method="post"
					...
					<input type="hidden" id="depNam" name="depNam" value="<%=session.getAttribute(RptStaticValue.PREFIX_RPT_DEP + "depNam") == null ? "请选择" : session.getAttribute(RptStaticValue.PREFIX_RPT_DEP + "depNam").toString().replace("<", "&lt;").replace(">", "&gt;")%>" />
					...
					<table id="content">
						<thead>
							<tr>
								...
								<th>
									<emp:message key="cxtj_sjcx_report_yys" defVal="运营商" fileName="cxtj"></emp:message>
								</th>
								<%
						...
						<tbody>
							...
							<tr>
								...
								if(reportType == 2){
										//out.print((dynrptvo.get("y")!=null?dynrptvo.get("y").toString():"2015")+"年"+(dynrptvo.get("imonth")!=null?dynrptvo.get("imonth").toString():"01")+"月");
