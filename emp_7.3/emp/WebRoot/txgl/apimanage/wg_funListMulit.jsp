...
<html>
	<head><%@include file="/common/common.jsp"%>
		...
		<link rel="stylesheet" type="text/css" href="<%=iPath%>/css/wg_funListMulit.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/wg_funListMulit.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		
	</head>
	<body id="wg_funListMulit">
