...
<html>
	<head><%@include file="/common/common.jsp" %>
		...
		<link rel="stylesheet" type="text/css" href="<%=iPath%>/css/wg_apiPara.css?V=<%=StaticValue.getJspImpVersion() %>"/>
		<link rel="stylesheet" type="text/css" href="<%=skin %>/wg_apiPara.css?V=<%=StaticValue.getJspImpVersion() %>"/>
