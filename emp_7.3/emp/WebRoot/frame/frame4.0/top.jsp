...
<body onload="findinfo()">
            ...
            <div class="top"  style="_width:800px;min-width:800px;width:auto !important; ">
                <div class="top_left">                    
                   <div class="top_logo">
                        ...
                        <%--  <%
                         	int corpType = StaticValue.CORPTYPE;
                    ...
                    <a  href="javascript:clickSkin()" ><emp:message key="common_skinChange" defVal="换肤" fileName="common"></emp:message></a>
		                    ...
		                    <span></span>
							<%}%>
                  			 <a href="javascript:complain()" id="feedback"><i class="top-info-icons feedback-icon"></i><emp:message key="common_feedback" defVal="反馈" fileName="common"></emp:message></a>
		                	 <span id="feedback-span"></span> 
		                	 <a href="javascript:about()" id="aboutPlatform"><i class="top-info-icons about-icon"></i><emp:message key="common_about" defVal="关于" fileName="common"></emp:message></a>
	                        <span id="aboutPlatform-span"></span>
		                	 <a href="javascript:upLoad()" id="helpManual"><i class="top-info-icons about-icon"></i>帮助手册</a>
	                        <span id="helpManual-span"></span>
	                         <% if (corp != null && !"100000".equals(corp.getCorpCode())) { %>
                        	<a href="javascript:checkFee()"><i class="top-info-icons balance-icon"></i><emp:message key="common_balance" defVal="余额" fileName="common"></emp:message></a>
                        	<span></span>
		                	<%  }  %> 
	                        <a href="javascript:doUpdatePass()"><i class="top-info-icons user-icon"></i><xmp style="font-weight:800"><%=((LfSysuser) session.getAttribute("loginSysuser")).getName()%></xmp></a>
	                        <span></span>
	                        <a id="quit" onclick="javascript:logout();" href="#"><i class="top-info-icons logout-icon"></i><emp:message key="common_logout" defVal="退出" fileName="common"></emp:message></a>
    ...
    <%}%>
    <div id="topLink" style="width:<%=perTopMenu*84+2 %>px;display:none;">
