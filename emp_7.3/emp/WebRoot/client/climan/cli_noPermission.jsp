		...
		<div id="container" class="container">
			...
			<div id="rContent" class="rContent">
				<br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/><br/>
			           <h1><emp:message key="client_common_text_permissiondenied" defVal="您没有客户机构权限，不能操作该模块，如有疑问请联系管理员！" fileName="client"></emp:message></h1> 
			</div>
			<%-- 内容结束 --%>
			<%-- foot开始 --%>
			<div class="bottom">
