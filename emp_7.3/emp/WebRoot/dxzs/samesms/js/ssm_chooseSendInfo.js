		...
		function aaa(){
			...
			if(types == 2)
			{
				var tempVal="";
				var name ="";
				var groupStr= $(window.parent.document).find("#groupIds").val();
				...
				$("#groupList option:selected").each(function() 
					{
					 	tempVal = $(this).val();
					 	name = $(this).text();
					 	if(ListContainObject(groupStr, tempVal)) {
							//alert(name + "群组已添加！");
							alert(getJsLocaleMessage('dxzs','dxzs_ssend_alert_105'));
						}else {
							if($(this).attr("mcount")=="0")
					    	{
								alert(getJsLocaleMessage('dxzs','dxzs_ssend_alert_106'));
								return;
						    }
						    
							name = name +"  ["+ $(this).attr("mcount")+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]";
							groupStr = groupStr+tempVal+",";
							$("#right").append("<option value='"+tempVal+"' et='4' mobile='' mcount='"+$(this).attr("mcount")+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_112')+"] "+name+"</option>");
							$("#getChooseMan").append("<li dataval='"+tempVal+"' et='4' mobile='' mcount='"+$(this).attr("mcount")+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_112')+"] "+name+"</li>");
							manCount +=parseInt($(this).attr("mcount"));
						}
					}
				);
				$("#manCount").html(manCount);
				$(window.parent.document).find("#groupIds").val(groupStr);
				return;
			}
			var depId;
			var depName;
			...
			if(rops.length>0)
			{
				for(var i = 0;i<rops.length;i=i+1)
				{
					...
					{
						alert(rops[i].text + getJsLocaleMessage('dxzs','dxzs_ssend_alert_108'));
						return;
					}
				}
			}
				...
				success: function(result2)
			    	{
				    	...
				    	if(ismut==0)
	    				{
				    		if(result2=="0")
					    	{
								alert(getJsLocaleMessage('dxzs','dxzs_ssend_alert_111'));
								return;
						    }
						    
	    					$(window.parent.document).find("#depIdStr").val(depIdsExist+depId+",");
	    					$("#right").append("<option value=\'"+depId+"\' isdep='1'  et='2' mobile='' mcount='"+result2+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+" ["+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</option>");
	    					$("#getChooseMan").append("<li dataval=\'"+depId+"\' isdep='1'  et='2' mobile='' mcount='"+result2+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+" ["+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</li>");
	    	    		...
	    	    		}else if(result2.indexOf("notContains")==0)
						{
							...
							//$("#right").append("<option value='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+result2.substr(12)+"'>[ "+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+result2.substr(12)+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</option>");
							//$("#getChooseMan").append("<li dataval='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+result2.substr(12)+"'>[ "+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+result2.substr(12)+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</li>");
							$("#right").append("<option value='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+result2.substr(12)+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+result2.substr(12)+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</option>");
							$("#getChooseMan").append("<li dataval='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+result2.substr(12)+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+result2.substr(12)+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</li>");
							...
							$(window.parent.document).find("#depIdStr").val(depIdsExist+"e"+depId+",");
							//$("#right").append("<option value='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+strArr[0]+"'>[ "+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+strArr[0]+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</option>");
							//$("#getChooseMan").append("<li dataval='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+strArr[0]+"'>[ "+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+strArr[0]+result2+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</li>");
							$("#right").append("<option value='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+strArr[0]+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+strArr[0]+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</option>");
							$("#getChooseMan").append("<li dataval='"+depId+"' isdep='1'  et='3' mobile='' mcount='"+strArr[0]+"'>[ "+getJsLocaleMessage('dxzs','dxzs_ssend_alert_113')+"] "+depName+"("+getJsLocaleMessage('dxzs','dxzs_ssend_alert_115')+")["+strArr[0]+getJsLocaleMessage('dxzs','dxzs_ssend_alert_114')+"]</li>");
		...
		function changeChooseType()
		{
			...
			if(i == 1)
			{
				...
				$("#showUserName").html(getJsLocaleMessage('dxzs','dxzs_ssend_alert_116'));
				$("#selectDep").val(getJsLocaleMessage('dxzs','dxzs_ssend_alert_117'));
			...
			}else if(i == 2)
			{
				...
				$("#showUserName").html(getJsLocaleMessage('dxzs','dxzs_ssend_alert_118'));
				$("#selectDep").val(getJsLocaleMessage('dxzs','dxzs_ssend_alert_119'));
			}
			$("#etree").toggle();
			$("#egroup").toggle();
		}
		...
		function grouponChange()
		 {
				...
				$("#showUserName").html(getJsLocaleMessage('dxzs','dxzs_ssend_alert_118')+name);
		 }
		 ...
		 function inputTipText(){
			...
			function goLastPage1()
			{
				...
				{
					alert(getJsLocaleMessage('dxzs','dxzs_ssend_alert_121'));
					return;
				}
