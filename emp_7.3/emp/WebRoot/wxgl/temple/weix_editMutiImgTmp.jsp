...
<html>
	<head>
		<title><emp:message key="wxgl_gzhgl_title_382" defVal="修改图文" fileName="wxgl"/></title>
		    ...
		    <div class="msg-meta title_bg">
		     ...
		     <div class="msg-editer">
			   ...
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wxgl_gzhgl_title_125" defVal="标题：" fileName="wxgl"/></div>
	            <div class="inp">
	              <input type="text" maxlength="32" onkeyup="showTitle(this);" id="item-title" name="item-title" class="w_input inputSpec reply_name" value="" >
	            </div>
	           </div>
			   <div class="info_list cf">
	            <div class="tit"><emp:message key="wxgl_gzhgl_title_367" defVal="封面：" fileName="wxgl"/></div>
