...
<div id="container" class="container" style="width:70%;">
    ...
    <div id="rContent" class="rContent">
        ...
        <form action="<%=path %>/surl_manage.htm" name="form1" onsubmit="return checkform()" method="post" id="form1">
            ...
            <div id="condition">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input maxlength="30" type="text" id="adddomain" style="width: 260px;"  name="adddomain" value=""   class="input_bd" /></label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input maxlength="256" type="text" id="addlenExten" name="addlenExten" style="width: 260px;"  value=""  class="input_bd" /></label>
                    ...
                    <tr>
                        ...
                        <td>
                            <input maxlength="3" type="text" id="addvalidDays" name="addvalidDays" style="width: 260px;"  value="30"  class="input_bd" /></label>
                            &nbsp;天
                        </td>
                    </tr>
                    <tr>
