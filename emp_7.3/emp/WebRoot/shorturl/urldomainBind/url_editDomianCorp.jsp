...
<html>
	...
	<body>
		<div id="container" class="container">
            ...
            <form action="<%=path %>/surl_bind.htm" name="form5" method="post" id="form5">
            		<div id="loginUser" class="hidden"></div>
            		<input type="hidden" value="<%=path %>" id="path1"/>
            		<input type="hidden" name="corpid" id="corpid" type="text" value="<%=corpid%>"  />
                    <input type="hidden" name="bindedIdStr" id="bindedIdStr" value="<%=request.getAttribute("bindedIdStr")%>" />
            		<div id="domainbindcb" style="display: none;"></div>
   					...
   					<table id="content" class="domainclass" >
						...
						<tbody>
								...
								<tr>
									...
									<td>
										<label><input type="checkbox" name="domainbind" value="<%=lfdomain.getId() %>" /></label>
									</td>
    ...
    <div class="clear"></div>
		...
		<script type="text/javascript" src="<%=commonPath%>/shorturl/urldomainBind/js/pageInfoEdit.js"></script>
	<script>
		...
		$(document).ready(function(){
            ...
            // var str="";
            // for( var i = 0; i < id.length; i++){
    			// str+="<input type=\"checkbox\" checked=\"checked\" name=\"domainbind\" value=\""+id[i]+"\" />";
			// }
			// $("#domainbindcb").html(str);
