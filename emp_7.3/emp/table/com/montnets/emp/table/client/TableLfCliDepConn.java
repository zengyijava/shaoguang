...
public class TableLfCliDepConn implements java.io.Serializable
{
	//表名  (操作员与客户机构权限表)
	public static final String TABLE_NAME = "LF_CLIDEP_CONN";
	//标识列ID
	public static final String CONN_ID = "CONN_ID";
	//操作员ID
	public static final String USER_ID = "USER_ID";
	//序列名
	public static final String SEQUENCE = "S_LF_CLIDEP_CONN";
	//机构ID
	...
	static
	{
		columns.put("LfCliDepConn", TABLE_NAME);
