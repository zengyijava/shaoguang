 ...
 * @datetime 2011-4-23 下午03:39:54
 * @description
 */

public class TableLfTimer {
	
	//表名：定时任务
	public static final String TABLE_NAME = "LF_TIMER";
	...
	//序列
	public static final String SEQUENCE = "S_LF_TIMER";
