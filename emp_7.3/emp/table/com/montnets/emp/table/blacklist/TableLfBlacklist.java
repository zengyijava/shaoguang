 ...
 * @description
 */
public class TableLfBlacklist {

	//黑名单表
	public static final String TABLE_NAME = "LF_BLACKLIST";
	//主键
	...
	//序列
    public static final String SEQUENCE = "S_LF_BLACKLIST";

    protected static final Map<String, String> columns = new HashMap<String, String>();

	static {
		columns.put("LfBlacklist", TableLfBlacklist.TABLE_NAME);
