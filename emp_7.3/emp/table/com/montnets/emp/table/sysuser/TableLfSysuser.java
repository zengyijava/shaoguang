...
{
	//表名：操作员的基本信息
	public static final String TABLE_NAME = "LF_SYSUSER";
	...
	//密码输入错误次数
	public static final String PASSERRORTIMES = "PWDERRORTIMES";
	//最后一次修改密码时间
	public static final String PASSUPDATETIME = "PWDUPDATETIME";
	
	//工号
	public static final String WORKNUMBER = "WORKNUMBER";
	//找回密码的次数
	public static final String FINDPASSTIMES="FINDPWDTIMES";  
	//发送找回密码的日期
	public static final String FINDPASSDATE="FINDPWDDATE"; 
	
	public static final String IS_CUSTOME="IS_CUSTOME";
	//语言设置
	...
	static
	{
		...
		columns.put("controlFlag", CONTROLFLAG);
		columns.put("pwderrortimes", PASSERRORTIMES);
		columns.put("pwdupdatetime", PASSUPDATETIME);
		columns.put("worknumber", WORKNUMBER);	
		columns.put("findPwdtimes", FINDPASSTIMES);
		columns.put("findPwddate", FINDPASSDATE);
		columns.put("isCustome", IS_CUSTOME);
		columns.put("languageCode", LANGUAGE_CODE);
		columns.put("showNum", SHOWNUM);
