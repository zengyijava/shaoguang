...
public class ycw_backFundsNoticeSvt extends YdcwBaseServlet {
	//业务类型
	private static final String BUSCODE = "MF0003";
	private static final String _PAYROLL = "回款通知";
	...
	public void find(HttpServletRequest request, HttpServletResponse response) {
		...
		try {
			...
			// 跳转至回款通知页
			request.getRequestDispatcher(PATH + "/ycw_backFundsNotice.jsp").forward(request, response);

		} catch (Exception e) {
			EmpExecutionContext.debug("Error code:E-CW-V104");
			EmpExecutionContext.error(e, "跳转至回款通知异常!");
		}
	}
