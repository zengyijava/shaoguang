 ...
 * @author zhangmin
 * @datetime 2013-12-30 下午02:20:34
 */
public class TableLfMonErrhis
{

	public static final String				TABLE_NAME	= "LF_MON_ERRHIS";
	...
	public static final String			SEQUENCE	= "S_LF_MON_ERRHIS";

	protected static final Map<String, String>	columns		= new HashMap<String, String>();

	static
	{
		columns.put("LfMonErrhis", TABLE_NAME);
