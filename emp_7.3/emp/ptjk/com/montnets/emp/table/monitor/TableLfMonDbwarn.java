...
public class TableLfMonDbwarn
{

	public static final String TABLE_NAME	= "LF_MON_DBWARN";
	...
	public static final String SEQUENCE	= "S_LF_M_DBWARN";
	protected static final Map<String , String> columns = new HashMap<String, String>();

	static
	{

		columns.put("LfMonDbwarn", TABLE_NAME);
